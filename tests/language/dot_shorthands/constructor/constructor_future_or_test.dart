...
class ConstructorClassFutureOrContext {
  ...
  ConstructorClassFutureOrContext.named({
    this.ctor = const .constRegular(1),
    this.nullableCtor,
  });
  ConstructorClassFutureOrContext.optional([
    this.ctor = const .constNamed(x: 1),
    this.nullableCtor,
  ]);
}
...
class ConstructorExtFutureOrContext {
  ...
  ConstructorExtFutureOrContext.named({
    this.ctorExt = const .constRegular(1),
    this.nullableCtorExt,
  });
  ConstructorExtFutureOrContext.optional([
    this.ctorExt = const .constRegular(1),
    this.nullableCtorExt,
  ]);
}
...
void main() {
  ...
  const FutureOr<ConstructorClass?> constNullableCtorOptional = .constOptional(
    1,
  );
  ...
  var ctorList = <FutureOr<ConstructorClass>>[
    .new(1),
    .regular(1),
    .optional(1),
    .named(x: 1),
  ];
  var nullableCtorList = <FutureOr<ConstructorClass?>>[
    .new(1),
    .regular(1),
    .optional(1),
    .named(x: 1),
  ...
  var ctorContextPositional = ConstructorClassFutureOrContext(
    .new(1),
    .regular(1),
  );
  var ctorContextPositional2 = ConstructorClassFutureOrContext(
    .optional(1),
    .named(x: 1),
  );
  var ctorContextNamed = ConstructorClassFutureOrContext.named(
    ctor: .new(1),
    nullableCtor: .regular(1),
  );
  var ctorContextNamed2 = ConstructorClassFutureOrContext.named(
    ctor: .optional(1),
    nullableCtor: .named(x: 1),
  );
  var ctorContextOptional = ConstructorClassFutureOrContext.optional(
    .new(1),
    .regular(1),
  );
  var ctorContextOptional2 = ConstructorClassFutureOrContext.optional(
    .optional(1),
    .named(x: 1),
  );
  ...
  const FutureOr<ConstructorExt?> constNullableCtorExtOptional = .constOptional(
    1,
  );
  FutureOr<FutureOr<ConstructorExt>> ctorExtNested = .new(1);
  const FutureOr<FutureOr<ConstructorExt>> constCtorExtNested = .constRegular(
    1,
  );

  var ctorExtList = <FutureOr<ConstructorExt>>[
    .new(1),
    .regular(1),
    .optional(1),
    .named(x: 1),
  ];
  var nullableIntegerExtList = <FutureOr<ConstructorExt?>>[
    .new(1),
    .regular(1),
    .optional(1),
    .named(x: 1),
  ...
  var ctorExtContextPositional = ConstructorExtFutureOrContext(
    .new(1),
    .regular(1),
  );
  var ctorExtContextPositional2 = ConstructorExtFutureOrContext(
    .optional(1),
    .named(x: 1),
  );
  var ctorExtContextNamed = ConstructorExtFutureOrContext.named(
    ctorExt: .new(1),
    nullableCtorExt: .regular(1),
  );
  var ctorExtContextNamed2 = ConstructorExtFutureOrContext.named(
    ctorExt: .optional(1),
    nullableCtorExt: .named(x: 1),
  );
  var ctorExtContextOptional = ConstructorExtFutureOrContext.optional(
    .new(1),
    .regular(1),
  );
  var ctorExtContextOptional2 = ConstructorExtFutureOrContext.optional(
    .optional(1),
    .named(x: 1),
  );
}
