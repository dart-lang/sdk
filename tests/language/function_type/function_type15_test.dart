...
typedef F7<T> = Function Function(int x2, [int x3]) Function<B extends core.int>(int x);
typedef F8<T> = Function Function(int x1, {List<Function> x}) Function<B extends core.int>(int x);
...
typedef F11<T> = List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>(int x);
typedef F12<T> = core.List<core.int> Function({Function x}) Function<B extends core.int>(int x);
...
typedef F17<T> = Function(int y, {List<Function> x}) Function<B extends core.int>(int x);
...
typedef F20<T> = void Function(int x, [List<T> x1]) Function<B extends core.int>(int x);
typedef F21<T> = List<Function> Function<A>(List<T> x) Function<B extends core.int>(int x);
...
Function Function(int x0, {List<Function> x}) f8<B extends core.int>(int x) => null;
...
List<Function> Function(int x0, [List<int> x1]) f11<B extends core.int>(int x) => null;
core.List<core.int> Function({Function x}) f12<B extends core.int>(int x) => null;
...
class U15<T> {
  ...
  Function Function(int x1, {List<Function> x}) Function<B extends core.int>(int x) x8;
  ...
  List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>(int x) x11;
  core.List<core.int> Function({Function x}) Function<B extends core.int>(int x) x12;
  ...
  Function Function(int x0, {List<Function> x}) m8<B extends core.int>(int x) => null;
  ...
  List<Function> Function(int x0, [List<T> x1]) m11<B extends core.int>(int x) => null;
  core.List<core.int> Function({Function x}) m12<B extends core.int>(int x) => null;
  ...
  void testF7() {
    ...
    Expect.isTrue(m7 is Function Function(int x2, [int x3]) Function<B extends core.int>(int x));
  ...
  void testF8() {
    ...
    // In checked mode, verifies the type.
    Function Function(int x1, {List<Function> x}) Function<B extends core.int>(int x) l8;
    ...
    Expect.isTrue(m8 is Function Function(int x1, {List<Function> x}) Function<B extends core.int>(int x));
  ...
  void testF11() {
    ...
    // In checked mode, verifies the type.
    List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>(int x) l11;
    ...
    Expect.isTrue(m11 is List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>(int x) l11 = m11;
      // In checked mode, verifies the type.
      x11 = m11;
      x11 = confuse(m11);
    }
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function({Function x}) Function<B extends core.int>(int x) l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function({Function x}) Function<B extends core.int>(int x));
  ...
  void testF16() {
    ...
    Expect.isTrue(m16 is Function(int x, [int x1]) Function<B extends core.int>(int x));
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function(int y, {List<Function> x}) Function<B extends core.int>(int x));
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is void Function(int x, [List<T> x1]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      void Function(int x, [List<T> x1]) Function<B extends core.int>(int x) l20 = m20;
      // In checked mode, verifies the type.
      x20 = m20;
      x20 = confuse(m20);
    }
  ...
  void testF21() {
    ...
    // In checked mode, verifies the type.
    List<Function> Function<A>(List<T> x) Function<B extends core.int>(int x) l21;
    ...
    Expect.isTrue(m21 is List<Function> Function<A>(List<T> x) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<Function> Function<A>(List<T> x) Function<B extends core.int>(int x) l21 = m21;
      // In checked mode, verifies the type.
      x21 = m21;
      x21 = confuse(m21);
    }
  ...
  void testF23() {
    ...
    Expect.isTrue(m23 is void Function<A>(A x) Function<B extends core.int>(int x));
