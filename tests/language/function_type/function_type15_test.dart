...
class U15<T> {
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7 is Function Function(int, [int]) Function<B extends core.int>(int x),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9 is List<Function> Function(int x) Function<B extends core.int>(int x),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19 is void Function(List<Function>) Function<B extends core.int>(int x),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20
          is void Function(int x, [List<T>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is List<Function> Function<A>(List<T> x) Function<B extends core.int>(
            int x,
          ),
    );
