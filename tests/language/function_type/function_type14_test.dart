...
class U14<T> {
  ...
  void testF10() {
    ...
    Expect.isTrue(
      m10
          is List<Function> Function(int y, [List<Function> x])
          Function<B extends core.int>(),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11
          is List<Function> Function(int, [List<T>])
          Function<B extends core.int>(),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14 is List<T> Function(int, [Function x]) Function<B extends core.int>(),
    );
  ...
  void testF15() {
    ...
    Expect.isTrue(
      m15
          is List<T> Function([core.List<core.int>])
          Function<B extends core.int>(),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17 is Function(int y, {List<Function> x}) Function<B extends core.int>(),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is List<Function> Function<A>(List<T> x)
          Function<B extends core.int>(),
    );
