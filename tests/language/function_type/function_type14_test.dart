...
typedef F7<T> = Function Function(int x2, [int x3]) Function<B extends core.int>();
typedef F8<T> = Function Function(int x1, {List<Function> x}) Function<B extends core.int>();
...
typedef F11<T> = List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>();
typedef F12<T> = core.List<core.int> Function({Function x}) Function<B extends core.int>();
...
typedef F17<T> = Function(int y, {List<Function> x}) Function<B extends core.int>();
...
typedef F20<T> = void Function(int x, [List<T> x1]) Function<B extends core.int>();
typedef F21<T> = List<Function> Function<A>(List<T> x) Function<B extends core.int>();
...
List<Function> Function(int x0, [List<int> x1]) f11<B extends core.int>() => null;
...
class U14<T> {
  ...
  Function Function(int x1, {List<Function> x}) Function<B extends core.int>() x8;
  ...
  List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>() x11;
  ...
  Function Function(int x0, {List<Function> x}) m8<B extends core.int>() => null;
  ...
  List<Function> Function(int x0, [List<T> x1]) m11<B extends core.int>() => null;
  ...
  void testF7() {
    ...
    Expect.isTrue(m7 is Function Function(int x2, [int x3]) Function<B extends core.int>());
  ...
  void testF8() {
    ...
    // In checked mode, verifies the type.
    Function Function(int x1, {List<Function> x}) Function<B extends core.int>() l8;
    ...
    Expect.isTrue(m8 is Function Function(int x1, {List<Function> x}) Function<B extends core.int>());
  ...
  void testF11() {
    ...
    // In checked mode, verifies the type.
    List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>() l11;
    ...
    Expect.isTrue(m11 is List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<Function> Function(int x2, [List<T> x3]) Function<B extends core.int>() l11 = m11;
      // In checked mode, verifies the type.
      x11 = m11;
      x11 = confuse(m11);
    }
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function({Function x}) Function<B extends core.int>() l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function({Function x}) Function<B extends core.int>());
  ...
  void testF16() {
    ...
    Expect.isTrue(m16 is Function(int x, [int x1]) Function<B extends core.int>());
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function(int y, {List<Function> x}) Function<B extends core.int>());
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is void Function(int x, [List<T> x1]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      void Function(int x, [List<T> x1]) Function<B extends core.int>() l20 = m20;
      // In checked mode, verifies the type.
      x20 = m20;
      x20 = confuse(m20);
    }
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is List<Function> Function<A>(List<T> x) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<Function> Function<A>(List<T> x) Function<B extends core.int>() l21 = m21;
      // In checked mode, verifies the type.
      x21 = m21;
      x21 = confuse(m21);
    }
