...
typedef F19<T> = void Function(int x2, [core.List<core.int> x3]) Function(int x);
...
class U65<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(m5 is int Function(int y, [List<Function> x]) Function(int x));
  ...
  void testF9() {
    ...
    Expect.isTrue(m9 is List<Function> Function(int x1, [Function x]) Function(int x));
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int x, [int x1]) Function(int x));
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function(int x2, [core.List<core.int> x3]) Function(int x));
