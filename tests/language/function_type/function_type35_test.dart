...
class U35<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5 is int Function(int, [Function]) Function<B extends core.int>(int x),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int x, [Function]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17 is Function(core.List<core.int>) Function<B extends core.int>(int x),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22
          is A Function<A>(List<Function> x) Function<B extends core.int>(
            int x,
          ),
    );
