...
typedef F7<T> = Function Function(int y, [List<Function> x]) Function<B extends core.int>();
typedef F8<T> = Function Function(int x2, [List<T> x3]) Function<B extends core.int>();
...
typedef F11<T> = core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>();
...
core.List<core.int> Function(int x0, [Function x]) f11<B extends core.int>() => null;
...
class U90<T> {
  ...
  Function Function(int y, [List<Function> x]) Function<B extends core.int>() x7;
  ...
  core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>() x11;
  ...
  core.List<core.int> Function(int x0, [Function x]) m11<B extends core.int>() => null;
  ...
  void testF4() {
    ...
    Expect.isTrue(m4 is int Function(int x2, [int x3]) Function<B extends core.int>());
  ...
  void testF7() {
    ...
    // In checked mode, verifies the type.
    Function Function(int y, [List<Function> x]) Function<B extends core.int>() l7;
    ...
    Expect.isTrue(m7 is Function Function(int y, [List<Function> x]) Function<B extends core.int>());
  ...
  void testF8() {
    ...
    Expect.isTrue(m8 is Function Function(int x2, [List<T> x3]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      Function Function(int x2, [List<T> x3]) Function<B extends core.int>() l8 = m8;
      // In checked mode, verifies the type.
      x8 = m8;
      x8 = confuse(m8);
    }
  ...
  void testF11() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>() l11;
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>());
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is List<T> Function(int x, [int x1]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int x, [int x1]) Function<B extends core.int>() l13 = m13;
      // In checked mode, verifies the type.
      x13 = m13;
      x13 = confuse(m13);
    }
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function(int x, [List<T> x1]) Function<B extends core.int>());
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is Function Function<A>(A x) Function<B extends core.int>());
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is List<T> Function<A>(List<A> x) Function<B extends core.int>());
  ...
  void testF22() {
    ...
    Expect.isTrue(m22 is void Function<A>(int x) Function<B extends core.int>());
