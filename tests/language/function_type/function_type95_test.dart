...
class U95<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int x, [List<T>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20
          is Function Function<A>(List<A> x) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22 is void Function<A>(Function x) Function<B extends core.int>(int x),
    );
