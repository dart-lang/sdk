...
typedef F10<T> = List<Function> Function(core.List<core.int> x1) Function(int x);
...
class U61<T> {
  ...
  void testF7() {
    ...
    Expect.isTrue(m7 is Function Function(int x, [Function x1]) Function(int x));
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(core.List<core.int> x1) Function(int x));
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int x2, [int x3]) Function(int x));
  ...
  void testF15() {
    ...
    Expect.isTrue(m15 is List<T> Function(int x2, [List<T> x3]) Function(int x));
