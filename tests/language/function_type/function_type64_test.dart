...
class U64<T> {
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function([core.List<core.int> x1]) Function());
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int x, [int x2]) Function());
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function(int x1, [core.List<core.int> x2]) Function());
