...
typedef F8<T> = Function Function(int x, [List<Function> x1]) Function<B extends core.int>();
typedef F9<T> = Function Function(int y, {List<T> x}) Function<B extends core.int>();
...
typedef F12<T> = core.List<core.int> Function(int x2, [Function x3]) Function<B extends core.int>();
typedef F13<T> = core.List<core.int> Function(int x1, {core.List<core.int> x}) Function<B extends core.int>();
...
typedef F21<T> = List<Function> Function<A>(List<Function> x) Function<B extends core.int>();
typedef F22<T> = Function<A>(core.List<core.int> x) Function<B extends core.int>();
...
core.List<core.int> Function(int x0, [Function x1]) f12<B extends core.int>() => null;
core.List<core.int> Function(int x0, {core.List<core.int> x}) f13<B extends core.int>() => null;
...
class U6<T> {
  ...
  Function Function(int x, [List<Function> x1]) Function<B extends core.int>() x8;
  ...
  core.List<core.int> Function(int x2, [Function x3]) Function<B extends core.int>() x12;
  core.List<core.int> Function(int x1, {core.List<core.int> x}) Function<B extends core.int>() x13;
  ...
  List<Function> Function<A>(List<Function> x) Function<B extends core.int>() x21;
  ...
  Function Function(int x, [List<Function> x0]) m8<B extends core.int>() => null;
  ...
  core.List<core.int> Function(int x0, [Function x1]) m12<B extends core.int>() => null;
  core.List<core.int> Function(int x0, {core.List<core.int> x}) m13<B extends core.int>() => null;
  ...
  List<Function> Function<A>(List<Function> x) m21<B extends core.int>() => null;
  ...
  void testF5() {
    ...
    Expect.isTrue(m5 is int Function(int y, {int x}) Function<B extends core.int>());
  ...
  void testF8() {
    ...
    // In checked mode, verifies the type.
    Function Function(int x, [List<Function> x1]) Function<B extends core.int>() l8;
    ...
    Expect.isTrue(m8 is Function Function(int x, [List<Function> x1]) Function<B extends core.int>());
  ...
  void testF9() {
    ...
    Expect.isTrue(m9 is Function Function(int y, {List<T> x}) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      Function Function(int y, {List<T> x}) Function<B extends core.int>() l9 = m9;
      // In checked mode, verifies the type.
      x9 = m9;
      x9 = confuse(m9);
    }
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x2, [Function x3]) Function<B extends core.int>() l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x2, [Function x3]) Function<B extends core.int>());
  ...
  void testF13() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x1, {core.List<core.int> x}) Function<B extends core.int>() l13;
    ...
    Expect.isTrue(m13 is core.List<core.int> Function(int x1, {core.List<core.int> x}) Function<B extends core.int>());
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function({List<Function> x}) Function<B extends core.int>());
  ...
  void testF21() {
    ...
    // In checked mode, verifies the type.
    List<Function> Function<A>(List<Function> x) Function<B extends core.int>() l21;
    ...
    Expect.isTrue(m21 is List<Function> Function<A>(List<Function> x) Function<B extends core.int>());
  ...
  void testF22() {
    ...
    Expect.isTrue(m22 is Function<A>(core.List<core.int> x) Function<B extends core.int>());
  ...
  void testF23() {
    ...
    Expect.isTrue(m23 is void Function<A>(List<T> x) Function<B extends core.int>());
