...
typedef F8<T> = Function Function(int x, [core.List<core.int> x1]) Function(int x);
...
typedef F12<T> = core.List<core.int> Function(int x2, [List<Function> x3]) Function(int x);
...
class U49<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(m8 is Function Function(int x, [core.List<core.int> x1]) Function(int x));
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x2, [List<Function> x3]) Function(int x) l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x2, [List<Function> x3]) Function(int x));
