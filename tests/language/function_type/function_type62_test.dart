...
typedef F5<T> = int Function(int x1, [List<Function> x]) Function<B extends core.int>();
typedef F6<T> = int Function([List<T> x1]) Function<B extends core.int>();
typedef F7<T> = Function Function(int x, [Function x1]) Function<B extends core.int>();
typedef F8<T> = Function Function(int y, {core.List<core.int> x}) Function<B extends core.int>();
typedef F9<T> = List<Function> Function([Function x]) Function<B extends core.int>();
typedef F10<T> = List<Function> Function(core.List<core.int> x1) Function<B extends core.int>();
typedef F11<T> = core.List<core.int> Function(int x2, [int x3]) Function<B extends core.int>();
...
typedef F14<T> = List<T> Function(int y, [List<Function> x]) Function<B extends core.int>();
typedef F15<T> = List<T> Function(int x2, [List<T> x3]) Function<B extends core.int>();
typedef F16<T> = Function({Function x}) Function<B extends core.int>();
typedef F17<T> = Function(List<T> x) Function<B extends core.int>();
typedef F18<T> = void Function(int x1, [Function x]) Function<B extends core.int>();
typedef F19<T> = void Function([core.List<core.int> x1]) Function<B extends core.int>();
...
core.List<core.int> Function(int x0, [int x1]) f11<B extends core.int>() => null;
...
class U62<T> {
  ...
  core.List<core.int> Function(int x2, [int x3]) Function<B extends core.int>() x11;
  ...
  List<T> Function(int y, [List<Function> x]) Function<B extends core.int>() x14;
  ...
  core.List<core.int> Function(int x0, [int x1]) m11<B extends core.int>() => null;
  ...
  void testF5() {
    ...
    Expect.isTrue(m5 is int Function(int x1, [List<Function> x]) Function<B extends core.int>());
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function([List<T> x1]) Function<B extends core.int>());
  ...
  void testF7() {
    ...
    Expect.isTrue(m7 is Function Function(int x, [Function x1]) Function<B extends core.int>());
  ...
  void testF9() {
    ...
    Expect.isTrue(m9 is List<Function> Function([Function x]) Function<B extends core.int>());
  ...
  void testF11() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x2, [int x3]) Function<B extends core.int>() l11;
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int x2, [int x3]) Function<B extends core.int>());
  ...
  void testF14() {
    ...
    // In checked mode, verifies the type.
    List<T> Function(int y, [List<Function> x]) Function<B extends core.int>() l14;
    ...
    Expect.isTrue(m14 is List<T> Function(int y, [List<Function> x]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int y, [List<Function> x]) Function<B extends core.int>() l14 = m14;
      // In checked mode, verifies the type.
      x14 = m14;
      x14 = confuse(m14);
    }
  ...
  void testF15() {
    ...
    Expect.isTrue(m15 is List<T> Function(int x2, [List<T> x3]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int x2, [List<T> x3]) Function<B extends core.int>() l15 = m15;
      // In checked mode, verifies the type.
      x15 = m15;
      x15 = confuse(m15);
    }
  ...
  void testF18() {
    ...
    Expect.isTrue(m18 is void Function(int x1, [Function x]) Function<B extends core.int>());
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function([core.List<core.int> x1]) Function<B extends core.int>());
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is int Function<A>(List<A> x) Function<B extends core.int>());
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is List<T> Function<A>(int x) Function<B extends core.int>());
  ...
  void testF22() {
    ...
    Expect.isTrue(m22 is List<A> Function<A>(Function x) Function<B extends core.int>());
