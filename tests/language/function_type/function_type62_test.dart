...
class U62<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5
          is int Function(int, [List<Function> x])
          Function<B extends core.int>(),
    );
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7 is Function Function(int x, [Function]) Function<B extends core.int>(),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function([Function x])
          Function<B extends core.int>(),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19
          is void Function([core.List<core.int>])
          Function<B extends core.int>(),
    );
