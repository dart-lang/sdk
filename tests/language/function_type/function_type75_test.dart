...
class U75<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int, [List<T> x]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(Function) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF10() {
    ...
    Expect.isTrue(
      m10
          is List<Function> Function(int x, [core.List<core.int>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13
          is List<T> Function(int y, [int x]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int, [List<Function>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17 is Function(int y, [List<T> x]) Function<B extends core.int>(int x),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20
          is Function Function<A>(List<Function> x)
          Function<B extends core.int>(int x),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is List<T> Function<A>(core.List<core.int> x)
          Function<B extends core.int>(int x),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22 is List<A> Function<A>(List<T> x) Function<B extends core.int>(int x),
    );
