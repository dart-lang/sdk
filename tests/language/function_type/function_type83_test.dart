...
class U83<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5
          is int Function(int x, [List<Function>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF18() {
    ...
    Expect.isTrue(
      m18
          is void Function(int x, [Function]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20
          is Function Function<A>(List<T> x) Function<B extends core.int>(
            int x,
          ),
    );
