...
class U26<T> {
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20 is void Function(int y, {List<T> x}) Function<B extends core.int>(),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is List<Function> Function<A>(List<A> x)
          Function<B extends core.int>(),
    );
  ...
  void testF23() {
    ...
    Expect.isTrue(
      m23 is core.List<core.int> Function(B x) Function<B extends core.int>(),
    );
