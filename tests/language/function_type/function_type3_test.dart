...
class U3<T> {
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17
          is Function(int x, [List<Function>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF18() {
    ...
    Expect.isTrue(
      m18 is Function(int y, {List<T> x}) Function<B extends core.int>(int x),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22 is Function<A>(List<Function> x) Function<B extends core.int>(int x),
    );
