...
typedef F10<T> = List<Function> Function(int x1, [List<Function> x2]) Function();
...
class U24<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function(int x, [core.List<core.int> x2]) Function());
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x1, [List<Function> x2]) Function());
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is List<Function> Function(int x0, {List<T> x}) Function());
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is core.List<core.int> Function(int y, [List<T> x]) Function());
  ...
  void testF23() {
    ...
    Expect.isTrue(m23 is List<Function> Function(B x) Function<B extends core.int>());
