...
typedef F12<T> = core.List<core.int> Function(int y, [List<Function> x]) Function();
...
class U36<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function(int y, {core.List<core.int> x}) Function());
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x0, {List<Function> x}) Function());
  ...
  void testF12() {
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int y, [List<Function> x]) Function());
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is core.List<core.int> Function(int x1, [List<T> x2]) Function());
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is core.List<core.int> Function<A>(List<Function> x) Function());
