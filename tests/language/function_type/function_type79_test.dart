...
class U79<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5
          is int Function(int, [List<Function>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF18() {
    ...
    Expect.isTrue(
      m18 is void Function(int, [Function]) Function<B extends core.int>(int x),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21 is List<T> Function<A>(List<T> x) Function<B extends core.int>(int x),
    );
