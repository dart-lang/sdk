...
typedef F10<T> = List<Function> Function(int x2, [List<Function> x3]) Function(int x);
...
typedef F23<T> = List<Function> Function(B x) Function<B extends core.int>(int x);
...
class U25<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function(int x, [core.List<core.int> x1]) Function(int x));
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x2, [List<Function> x3]) Function(int x));
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is List<Function> Function(int x1, {List<T> x}) Function(int x));
  ...
  void testF15() {
    ...
    Expect.isTrue(m15 is List<T> Function({core.List<core.int> x}) Function(int x));
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function(int x, [List<Function> x1]) Function(int x));
  ...
  void testF23() {
    ...
    Expect.isTrue(m23 is List<Function> Function(B x) Function<B extends core.int>(int x));
