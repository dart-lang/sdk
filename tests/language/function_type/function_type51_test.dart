...
class U51<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(
      m6 is int Function(int, [List<T> x]) Function<B extends core.int>(int x),
    );
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int x, [core.List<core.int>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF12() {
    ...
    Expect.isTrue(
      m12
          is core.List<core.int> Function(int, [List<Function>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF15() {
    ...
    Expect.isTrue(
      m15
          is List<T> Function(int y, [List<T> x]) Function<B extends core.int>(
            int x,
          ),
    );
