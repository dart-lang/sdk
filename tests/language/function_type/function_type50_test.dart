...
class U50<T> {
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(int, {int x})
          Function<B extends core.int>(),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14 is List<T> Function(List<Function> x) Function<B extends core.int>(),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21 is core.List<core.int> Function<A>() Function<B extends core.int>(),
    );
