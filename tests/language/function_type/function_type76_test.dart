...
typedef F12<T> = core.List<core.int> Function(int x0, [core.List<core.int> x]) Function();
...
class U76<T> {
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int y, {int x}) Function());
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x0, [core.List<core.int> x]) Function() l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x0, [core.List<core.int> x]) Function());
  ...
  void testF14() {
    ...
    Expect.isTrue(m14 is List<T> Function(int x, [List<Function> x2]) Function());
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function(int x0, {core.List<core.int> x}) Function());
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is Function Function<A>(core.List<core.int> x) Function());
