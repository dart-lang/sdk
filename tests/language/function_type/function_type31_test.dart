...
class U31<T> {
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7
          is Function Function(int y, {int x}) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13
          is core.List<core.int> Function(List<T>) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int, [Function]) Function<B extends core.int>(
            int x,
          ),
    );
