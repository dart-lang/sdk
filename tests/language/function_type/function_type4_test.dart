...
typedef F13<T> = core.List<core.int> Function(int x0, {core.List<core.int> x}) Function();
...
class U4<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function(int x0, [core.List<core.int> x]) Function());
  ...
  void testF8() {
    ...
    Expect.isTrue(m8 is Function Function(int x, [List<Function> x2]) Function());
  ...
  void testF12() {
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x1, [Function x2]) Function());
  ...
  void testF13() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x0, {core.List<core.int> x}) Function() l13;
    ...
    Expect.isTrue(m13 is core.List<core.int> Function(int x0, {core.List<core.int> x}) Function());
  ...
  void testF15() {
    ...
    Expect.isTrue(m15 is List<T> Function(int y, [core.List<core.int> x]) Function());
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is List<Function> Function<A>(List<Function> x) Function());
