...
class U82<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5
          is int Function(int x, [List<Function>])
          Function<B extends core.int>(),
    );
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7
          is Function Function([List<Function> x])
          Function<B extends core.int>(),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(int, [Function])
          Function<B extends core.int>(),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function({List<Function> x})
          Function<B extends core.int>(),
    );
  ...
  void testF16() {
    ...
    Expect.isTrue(
      m16 is Function(int, [List<Function> x]) Function<B extends core.int>(),
    );
