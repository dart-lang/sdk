...
typedef F12<T> = core.List<core.int> Function(int x1, [List<Function> x2]) Function();
...
class U48<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(m8 is Function Function(int x, [core.List<core.int> x2]) Function());
  ...
  void testF12() {
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x1, [List<Function> x2]) Function());
