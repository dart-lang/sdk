...
class U34<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int y, [core.List<core.int> x])
          Function<B extends core.int>(),
    );
  ...
  void testF12() {
    ...
    Expect.isTrue(
      m12
          is core.List<core.int> Function(int, [List<Function> x])
          Function<B extends core.int>(),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13
          is core.List<core.int> Function([List<T>])
          Function<B extends core.int>(),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14 is List<T> Function(int x, [Function]) Function<B extends core.int>(),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is core.List<core.int> Function<A>(Function x)
          Function<B extends core.int>(),
    );
