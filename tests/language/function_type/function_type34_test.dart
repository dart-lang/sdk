...
typedef F5<T> = int Function(int x2, [Function x3]) Function<B extends core.int>();
typedef F6<T> = int Function(int x1, {core.List<core.int> x}) Function<B extends core.int>();
typedef F7<T> = Function Function(Function x) Function<B extends core.int>();
typedef F8<T> = Function Function(int y, [core.List<core.int> x]) Function<B extends core.int>();
...
typedef F12<T> = core.List<core.int> Function(int x1, [List<Function> x]) Function<B extends core.int>();
typedef F13<T> = core.List<core.int> Function([List<T> x1]) Function<B extends core.int>();
typedef F14<T> = List<T> Function(int x, [Function x1]) Function<B extends core.int>();
typedef F15<T> = List<T> Function(int y, {core.List<core.int> x}) Function<B extends core.int>();
...
typedef F19<T> = void Function(int x1, {List<Function> x}) Function<B extends core.int>();
typedef F20<T> = int Function<A>(int x) Function<B extends core.int>();
typedef F21<T> = core.List<core.int> Function<A>(Function x) Function<B extends core.int>();
...
Function Function(int y, [core.List<core.int> x]) f8<B extends core.int>() => null;
...
core.List<core.int> Function(int x0, [List<Function> x]) f12<B extends core.int>() => null;
...
List<int> Function(int y, {core.List<core.int> x}) f15<B extends core.int>() => null;
...
class U34<T> {
  ...
  int Function(int x1, {core.List<core.int> x}) Function<B extends core.int>() x6;
  Function Function(Function x) Function<B extends core.int>() x7;
  Function Function(int y, [core.List<core.int> x]) Function<B extends core.int>() x8;
  ...
  core.List<core.int> Function(int x1, [List<Function> x]) Function<B extends core.int>() x12;
  ...
  List<T> Function(int y, {core.List<core.int> x}) Function<B extends core.int>() x15;
  ...
  core.List<core.int> Function<A>(Function x) Function<B extends core.int>() x21;
  ...
  int Function(int x0, {core.List<core.int> x}) m6<B extends core.int>() => null;
  Function Function(Function x) m7<B extends core.int>() => null;
  Function Function(int y, [core.List<core.int> x]) m8<B extends core.int>() => null;
  ...
  core.List<core.int> Function(int x0, [List<Function> x]) m12<B extends core.int>() => null;
  ...
  List<T> Function(int y, {core.List<core.int> x}) m15<B extends core.int>() => null;
  ...
  void testF5() {
    ...
    Expect.isTrue(m5 is int Function(int x2, [Function x3]) Function<B extends core.int>());
  ...
  void testF6() {
    ...
    // In checked mode, verifies the type.
    int Function(int x1, {core.List<core.int> x}) Function<B extends core.int>() l6;
    ...
    Expect.isTrue(m6 is int Function(int x1, {core.List<core.int> x}) Function<B extends core.int>());
  ...
  void testF7() {
    ...
    Expect.isTrue(m7 is Function Function(Function x) Function<B extends core.int>());
  ...
  void testF8() {
    ...
    // In checked mode, verifies the type.
    Function Function(int y, [core.List<core.int> x]) Function<B extends core.int>() l8;
    ...
    Expect.isTrue(m8 is Function Function(int y, [core.List<core.int> x]) Function<B extends core.int>());
  ...
  void testF9() {
    ...
    Expect.isTrue(m9 is List<Function> Function([int x1]) Function<B extends core.int>());
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is List<Function> Function() Function<B extends core.int>());
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x1, [List<Function> x]) Function<B extends core.int>() l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x1, [List<Function> x]) Function<B extends core.int>());
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is core.List<core.int> Function([List<T> x1]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      core.List<core.int> Function([List<T> x1]) Function<B extends core.int>() l13 = m13;
      // In checked mode, verifies the type.
      x13 = m13;
      x13 = confuse(m13);
    }
  ...
  void testF14() {
    ...
    Expect.isTrue(m14 is List<T> Function(int x, [Function x1]) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int x, [Function x1]) Function<B extends core.int>() l14 = m14;
      // In checked mode, verifies the type.
      x14 = m14;
      x14 = confuse(m14);
    }
  ...
  void testF15() {
    ...
    // In checked mode, verifies the type.
    List<T> Function(int y, {core.List<core.int> x}) Function<B extends core.int>() l15;
    ...
    Expect.isTrue(m15 is List<T> Function(int y, {core.List<core.int> x}) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int y, {core.List<core.int> x}) Function<B extends core.int>() l15 = m15;
      // In checked mode, verifies the type.
      x15 = m15;
      x15 = confuse(m15);
    }
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function(core.List<core.int> x1) Function<B extends core.int>());
  ...
  void testF18() {
    ...
    Expect.isTrue(m18 is void Function(int x2, [int x3]) Function<B extends core.int>());
  ...
  void testF19() {
    ...
    // In checked mode, verifies the type.
    void Function(int x1, {List<Function> x}) Function<B extends core.int>() l19;
    ...
    Expect.isTrue(m19 is void Function(int x1, {List<Function> x}) Function<B extends core.int>());
  ...
  void testF21() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function<A>(Function x) Function<B extends core.int>() l21;
    ...
    Expect.isTrue(m21 is core.List<core.int> Function<A>(Function x) Function<B extends core.int>());
  ...
  void testF22() {
    ...
    Expect.isTrue(m22 is A Function<A>(List<Function> x) Function<B extends core.int>());
