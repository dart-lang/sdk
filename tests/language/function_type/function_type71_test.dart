...
typedef F6<T> = int Function(int x, [List<T> x1]) Function<B extends core.int>(int x);
typedef F7<T> = Function Function(int x1, {Function x}) Function<B extends core.int>(int x);
typedef F8<T> = Function Function([List<T> x]) Function<B extends core.int>(int x);
typedef F9<T> = List<Function> Function(int y, [Function x]) Function<B extends core.int>(int x);
typedef F10<T> = List<Function> Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>(int x);
typedef F11<T> = core.List<core.int> Function({int x}) Function<B extends core.int>(int x);
typedef F12<T> = core.List<core.int> Function(core.List<core.int> x) Function<B extends core.int>(int x);
typedef F13<T> = List<T> Function(int x1, [int x]) Function<B extends core.int>(int x);
typedef F14<T> = List<T> Function([List<Function> x1]) Function<B extends core.int>(int x);
typedef F15<T> = List<T> Function({List<T> x}) Function<B extends core.int>(int x);
typedef F16<T> = Function(int y, {Function x}) Function<B extends core.int>(int x);
typedef F17<T> = Function(int x1, [List<T> x]) Function<B extends core.int>(int x);
typedef F18<T> = void Function(Function x1) Function<B extends core.int>(int x);
typedef F19<T> = void Function(int x, [core.List<core.int> x1]) Function<B extends core.int>(int x);
typedef F20<T> = Function Function<A>(Function x) Function<B extends core.int>(int x);
typedef F21<T> = List<T> Function<A>(List<Function> x) Function<B extends core.int>(int x);
typedef F22<T> = List<A> Function<A>(core.List<core.int> x) Function<B extends core.int>(int x);
...
List<Function> Function(int y, [Function x]) f9<B extends core.int>(int x) => null;
List<Function> Function(int x0, [core.List<core.int> x1]) f10<B extends core.int>(int x) => null;
...
void Function(int x, [core.List<core.int> x0]) f19<B extends core.int>(int x) => null;
...
List<A> Function<A>(core.List<core.int> x) f22<B extends core.int>(int x) => null;
...
class U71<T> {
  ...
  Function Function(int x1, {Function x}) Function<B extends core.int>(int x) x7;
  Function Function([List<T> x]) Function<B extends core.int>(int x) x8;
  List<Function> Function(int y, [Function x]) Function<B extends core.int>(int x) x9;
  List<Function> Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>(int x) x10;
  ...
  void Function(int x, [core.List<core.int> x1]) Function<B extends core.int>(int x) x19;
  ...
  List<A> Function<A>(core.List<core.int> x) Function<B extends core.int>(int x) x22;
  ...
  List<Function> Function(int y, [Function x]) m9<B extends core.int>(int x) => null;
  List<Function> Function(int x0, [core.List<core.int> x1]) m10<B extends core.int>(int x) => null;
  ...
  void Function(int x, [core.List<core.int> x0]) m19<B extends core.int>(int x) => null;
  ...
  List<A> Function<A>(core.List<core.int> x) m22<B extends core.int>(int x) => null;
  ...
  void testF4() {
    ...
    Expect.isTrue(m4 is int Function([int x]) Function<B extends core.int>(int x));
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function(int x, [List<T> x1]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      int Function(int x, [List<T> x1]) Function<B extends core.int>(int x) l6 = m6;
      // In checked mode, verifies the type.
      x6 = m6;
      x6 = confuse(m6);
    }
  ...
  void testF7() {
    ...
    // In checked mode, verifies the type.
    Function Function(int x1, {Function x}) Function<B extends core.int>(int x) l7;
    ...
    Expect.isTrue(m7 is Function Function(int x1, {Function x}) Function<B extends core.int>(int x));
  ...
  void testF8() {
    ...
    Expect.isTrue(m8 is Function Function([List<T> x]) Function<B extends core.int>(int x));
  ...
  void testF9() {
    ...
    // In checked mode, verifies the type.
    List<Function> Function(int y, [Function x]) Function<B extends core.int>(int x) l9;
    ...
    Expect.isTrue(m9 is List<Function> Function(int y, [Function x]) Function<B extends core.int>(int x));
  ...
  void testF10() {
    ...
    // In checked mode, verifies the type.
    List<Function> Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>(int x) l10;
    ...
    Expect.isTrue(m10 is List<Function> Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>(int x));
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is core.List<core.int> Function({int x}) Function<B extends core.int>(int x));
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is List<T> Function(int x1, [int x]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int x1, [int x]) Function<B extends core.int>(int x) l13 = m13;
      // In checked mode, verifies the type.
      x13 = m13;
      x13 = confuse(m13);
    }
  ...
  void testF14() {
    ...
    Expect.isTrue(m14 is List<T> Function([List<Function> x1]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<T> Function([List<Function> x1]) Function<B extends core.int>(int x) l14 = m14;
      // In checked mode, verifies the type.
      x14 = m14;
      x14 = confuse(m14);
    }
  ...
  void testF15() {
    ...
    Expect.isTrue(m15 is List<T> Function({List<T> x}) Function<B extends core.int>(int x));
  ...
  void testF16() {
    ...
    Expect.isTrue(m16 is Function(int y, {Function x}) Function<B extends core.int>(int x));
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function(int x1, [List<T> x]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      Function(int x1, [List<T> x]) Function<B extends core.int>(int x) l17 = m17;
      // In checked mode, verifies the type.
      x17 = m17;
      x17 = confuse(m17);
    }
  ...
  void testF19() {
    ...
    // In checked mode, verifies the type.
    void Function(int x, [core.List<core.int> x1]) Function<B extends core.int>(int x) l19;
    ...
    Expect.isTrue(m19 is void Function(int x, [core.List<core.int> x1]) Function<B extends core.int>(int x));
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is Function Function<A>(Function x) Function<B extends core.int>(int x));
  ...
  void testF21() {
    ...
    // In checked mode, verifies the type.
    List<T> Function<A>(List<Function> x) Function<B extends core.int>(int x) l21;
    ...
    Expect.isTrue(m21 is List<T> Function<A>(List<Function> x) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<T> Function<A>(List<Function> x) Function<B extends core.int>(int x) l21 = m21;
      // In checked mode, verifies the type.
      x21 = m21;
      x21 = confuse(m21);
    }
  ...
  void testF22() {
    ...
    // In checked mode, verifies the type.
    List<A> Function<A>(core.List<core.int> x) Function<B extends core.int>(int x) l22;
    ...
    Expect.isTrue(m22 is List<A> Function<A>(core.List<core.int> x) Function<B extends core.int>(int x));
