...
typedef F10<T> = List<Function> Function(int x, [core.List<core.int> x2]) Function();
...
class U72<T> {
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x, [core.List<core.int> x2]) Function());
  ...
  void testF12() {
    ...
    Expect.isTrue(m12 is core.List<core.int> Function([core.List<core.int> x]) Function());
  ...
  void testF14() {
    ...
    Expect.isTrue(m14 is List<T> Function(int x1, [List<Function> x2]) Function());
