...
class U78<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5 is int Function(int, [List<Function>]) Function<B extends core.int>(),
    );
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7 is Function Function(List<Function> x) Function<B extends core.int>(),
    );
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int y, [List<T> x])
          Function<B extends core.int>(),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11
          is core.List<core.int> Function(int y, {int x})
          Function<B extends core.int>(),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int x, [List<Function>])
          Function<B extends core.int>(),
    );
  ...
  void testF15() {
    ...
    Expect.isTrue(
      m15
          is List<T> Function(int y, {List<T> x})
          Function<B extends core.int>(),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19
          is void Function(int, {core.List<core.int> x})
          Function<B extends core.int>(),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20
          is Function Function<A>(core.List<core.int> x)
          Function<B extends core.int>(),
    );
