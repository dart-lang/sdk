...
class U38<T> {
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9 is List<Function> Function(int, [int]) Function<B extends core.int>(),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11 is core.List<core.int> Function(int x) Function<B extends core.int>(),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22
          is A Function<A>(core.List<core.int> x)
          Function<B extends core.int>(),
    );
