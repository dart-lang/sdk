...
typedef F12<T> = core.List<core.int> Function(int x, [core.List<core.int> x1]) Function(int x);
...
core.List<core.int> Function(int x, [core.List<core.int> x0]) f12(int x) => null;
...
class U97<T> {
  ...
  core.List<core.int> Function(int x, [core.List<core.int> x1]) Function(int x) x12;
  ...
  core.List<core.int> Function(int x, [core.List<core.int> x0]) m12(int x) => null;
  ...
  void testF1() {
    ...
    Expect.isTrue(m1 is core.List<core.int> Function(int x, [List<Function> x2]));
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x1, [List<T> x]) Function(int x));
  ...
  void testF11() {
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(Function x1) Function(int x));
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x, [core.List<core.int> x1]) Function(int x) l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int x, [core.List<core.int> x1]) Function(int x));
  ...
  void testF14() {
    ...
    Expect.isTrue(m14 is List<T> Function([core.List<core.int> x]) Function(int x));
