...
typedef F10<T> = List<Function> Function(int x1, [core.List<core.int> x2]) Function();
...
class U68<T> {
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x1, [core.List<core.int> x2]) Function());
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function(int x, [core.List<core.int> x2]) Function());
