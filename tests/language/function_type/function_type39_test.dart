...
class U39<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5 is int Function(int x, [Function]) Function<B extends core.int>(int x),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(int, [int]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13
          is core.List<core.int> Function(int, [List<T>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17
          is Function([core.List<core.int>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is core.List<core.int> Function<A>(List<Function> x)
          Function<B extends core.int>(int x),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22
          is A Function<A>(core.List<core.int> x) Function<B extends core.int>(
            int x,
          ),
    );
