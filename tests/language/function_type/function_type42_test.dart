...
class U42<T> {
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7 is Function Function(int, [Function x]) Function<B extends core.int>(),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(int x, [int])
          Function<B extends core.int>(),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11
          is core.List<core.int> Function([int x])
          Function<B extends core.int>(),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17
          is Function(int, [core.List<core.int>])
          Function<B extends core.int>(),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20 is int Function<A>(List<Function> x) Function<B extends core.int>(),
    );
