...
class U58<T> {
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7 is Function Function(int, [Function]) Function<B extends core.int>(),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9 is List<Function> Function(Function x) Function<B extends core.int>(),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11 is core.List<core.int> Function([int]) Function<B extends core.int>(),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19 is void Function(core.List<core.int>) Function<B extends core.int>(),
    );
