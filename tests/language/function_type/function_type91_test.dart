...
class U91<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int, [List<T>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13 is List<T> Function(int x, [int]) Function<B extends core.int>(int x),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21 is List<T> Function<A>(List<A> x) Function<B extends core.int>(int x),
    );
