...
typedef F4<T> = int Function(int x2, [int x3]) Function<B extends core.int>(int x);
...
typedef F7<T> = Function Function(int y, [List<Function> x]) Function<B extends core.int>(int x);
typedef F8<T> = Function Function(int x2, [List<T> x3]) Function<B extends core.int>(int x);
...
typedef F11<T> = core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>(int x);
typedef F12<T> = core.List<core.int> Function([core.List<core.int> x1]) Function<B extends core.int>(int x);
typedef F13<T> = List<T> Function(int x, [int x1]) Function<B extends core.int>(int x);
...
typedef F17<T> = Function(int x, [List<T> x1]) Function<B extends core.int>(int x);
...
typedef F21<T> = List<T> Function<A>(List<A> x) Function<B extends core.int>(int x);
...
Function Function(int y, [List<Function> x]) f7<B extends core.int>(int x) => null;
...
core.List<core.int> Function(int x0, [Function x]) f11<B extends core.int>(int x) => null;
...
class U91<T> {
  ...
  Function Function(int y, [List<Function> x]) Function<B extends core.int>(int x) x7;
  Function Function(int x2, [List<T> x3]) Function<B extends core.int>(int x) x8;
  ...
  core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>(int x) x11;
  ...
  Function Function(int y, [List<Function> x]) m7<B extends core.int>(int x) => null;
  ...
  core.List<core.int> Function(int x0, [Function x]) m11<B extends core.int>(int x) => null;
  ...
  void testF4() {
    ...
    Expect.isTrue(m4 is int Function(int x2, [int x3]) Function<B extends core.int>(int x));
  ...
  void testF7() {
    ...
    // In checked mode, verifies the type.
    Function Function(int y, [List<Function> x]) Function<B extends core.int>(int x) l7;
    ...
    Expect.isTrue(m7 is Function Function(int y, [List<Function> x]) Function<B extends core.int>(int x));
  ...
  void testF8() {
    ...
    // In checked mode, verifies the type.
    Function Function(int x2, [List<T> x3]) Function<B extends core.int>(int x) l8;
    ...
    Expect.isTrue(m8 is Function Function(int x2, [List<T> x3]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      Function Function(int x2, [List<T> x3]) Function<B extends core.int>(int x) l8 = m8;
      // In checked mode, verifies the type.
      x8 = m8;
      x8 = confuse(m8);
    }
  ...
  void testF11() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>(int x) l11;
    ...
    Expect.isTrue(m11 is core.List<core.int> Function(int x1, [Function x]) Function<B extends core.int>(int x));
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is List<T> Function(int x, [int x1]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<T> Function(int x, [int x1]) Function<B extends core.int>(int x) l13 = m13;
      // In checked mode, verifies the type.
      x13 = m13;
      x13 = confuse(m13);
    }
  ...
  void testF17() {
    ...
    Expect.isTrue(m17 is Function(int x, [List<T> x1]) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      Function(int x, [List<T> x1]) Function<B extends core.int>(int x) l17 = m17;
      // In checked mode, verifies the type.
      x17 = m17;
      x17 = confuse(m17);
    }
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is Function Function<A>(A x) Function<B extends core.int>(int x));
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is List<T> Function<A>(List<A> x) Function<B extends core.int>(int x));
    ...
    if (!tIsBool) {
      ...
      List<T> Function<A>(List<A> x) Function<B extends core.int>(int x) l21 = m21;
      // In checked mode, verifies the type.
      x21 = m21;
      x21 = confuse(m21);
    }
  ...
  void testF22() {
    ...
    Expect.isTrue(m22 is void Function<A>(int x) Function<B extends core.int>(int x));
