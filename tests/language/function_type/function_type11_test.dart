...
class U11<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(
      m6
          is int Function(int y, [core.List<core.int> x])
          Function<B extends core.int>(int x),
    );
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function({List<Function> x}) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF10() {
    ...
    Expect.isTrue(
      m10
          is List<Function> Function(int, [List<Function> x])
          Function<B extends core.int>(int x),
    );
  ...
  void testF12() {
    ...
    Expect.isTrue(
      m12
          is core.List<core.int> Function(int x, [Function])
          Function<B extends core.int>(int x),
    );
  ...
  void testF15() {
    ...
    Expect.isTrue(
      m15
          is List<T> Function(core.List<core.int>) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17
          is Function(int, {List<Function> x}) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19
          is void Function(int y, [List<Function> x])
          Function<B extends core.int>(int x),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20 is void Function(int, [List<T>]) Function<B extends core.int>(int x),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is List<Function> Function<A>(core.List<core.int> x)
          Function<B extends core.int>(int x),
    );
