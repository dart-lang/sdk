...
typedef F12<T> = core.List<core.int> Function(int y, [core.List<core.int> x]) Function(int x);
...
class U81<T> {
  ...
  core.List<core.int> Function(int y, [core.List<core.int> x]) Function(int x) x12;
  ...
  core.List<core.int> Function(int y, [core.List<core.int> x]) m12(int x) => null;
  ...
  void testF5() {
    ...
    Expect.isTrue(m5 is int Function(int x, [List<Function> x1]) Function(int x));
  ...
  void testF9() {
    ...
    Expect.isTrue(m9 is List<Function> Function(int x2, [Function x3]) Function(int x));
  ...
  void testF12() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function(int y, [core.List<core.int> x]) Function(int x) l12;
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int y, [core.List<core.int> x]) Function(int x));
