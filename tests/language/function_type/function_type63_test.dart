...
class U63<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5
          is int Function(int, [List<Function> x]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7
          is Function Function(int x, [Function]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function([Function x]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF10() {
    ...
    Expect.isTrue(
      m10
          is List<Function> Function(core.List<core.int>)
          Function<B extends core.int>(int x),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11
          is core.List<core.int> Function(int, [int])
          Function<B extends core.int>(int x),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int y, [List<Function> x])
          Function<B extends core.int>(int x),
    );
  ...
  void testF15() {
    ...
    Expect.isTrue(
      m15
          is List<T> Function(int, [List<T>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF18() {
    ...
    Expect.isTrue(
      m18
          is void Function(int, [Function x]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19
          is void Function([core.List<core.int>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22
          is List<A> Function<A>(Function x) Function<B extends core.int>(
            int x,
          ),
    );
