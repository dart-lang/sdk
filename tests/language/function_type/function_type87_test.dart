...
class U87<T> {
  ...
  void testF5() {
    ...
    Expect.isTrue(
      m5
          is int Function({List<Function> x}) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF7() {
    ...
    Expect.isTrue(
      m7
          is Function Function(int, [List<Function> x])
          Function<B extends core.int>(int x),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(int x, [Function])
          Function<B extends core.int>(int x),
    );
  ...
  void testF10() {
    ...
    Expect.isTrue(
      m10
          is List<Function> Function(int y, {core.List<core.int> x})
          Function<B extends core.int>(int x),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11
          is core.List<core.int> Function([Function x])
          Function<B extends core.int>(int x),
    );
  ...
  void testF12() {
    ...
    Expect.isTrue(
      m12
          is core.List<core.int> Function(core.List<core.int>)
          Function<B extends core.int>(int x),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13 is List<T> Function(int, [int]) Function<B extends core.int>(int x),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int, {List<Function> x})
          Function<B extends core.int>(int x),
    );
  ...
  void testF16() {
    ...
    Expect.isTrue(
      m16
          is Function(int y, [List<Function> x]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF22() {
    ...
    Expect.isTrue(
      m22 is List<A> Function<A>(List<A> x) Function<B extends core.int>(int x),
    );
