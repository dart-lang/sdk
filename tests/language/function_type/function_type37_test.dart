...
typedef F10<T> = List<Function> Function(int x1, {List<Function> x}) Function(int x);
typedef F11<T> = core.List<core.int> Function(int x) Function(int x);
typedef F12<T> = core.List<core.int> Function(int y, [List<Function> x]) Function(int x);
typedef F13<T> = core.List<core.int> Function(int x2, [List<T> x3]) Function(int x);
...
typedef F21<T> = core.List<core.int> Function<A>(List<Function> x) Function(int x);
...
class U37<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(m6 is int Function(int y, {core.List<core.int> x}) Function(int x));
  ...
  void testF9() {
    ...
    Expect.isTrue(m9 is List<Function> Function(int x2, [int x3]) Function(int x));
  ...
  void testF10() {
    ...
    Expect.isTrue(m10 is List<Function> Function(int x1, {List<Function> x}) Function(int x));
  ...
  void testF12() {
    ...
    Expect.isTrue(m12 is core.List<core.int> Function(int y, [List<Function> x]) Function(int x));
  ...
  void testF13() {
    ...
    Expect.isTrue(m13 is core.List<core.int> Function(int x2, [List<T> x3]) Function(int x));
    ...
    if (!tIsBool) {
      ...
      core.List<core.int> Function(int x2, [List<T> x3]) Function(int x) l13 = m13;
      // In checked mode, verifies the type.
      x13 = m13;
      x13 = confuse(m13);
    }
  ...
  void testF19() {
    ...
    Expect.isTrue(m19 is void Function(int y, {List<Function> x}) Function(int x));
  ...
  void testF21() {
    ...
    Expect.isTrue(m21 is core.List<core.int> Function<A>(List<Function> x) Function(int x));
  ...
  void testF23() {
    ...
    Expect.isTrue(m23 is void Function(B x) Function<B extends core.int>(int x));
