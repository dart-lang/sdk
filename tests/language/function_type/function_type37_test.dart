...
class U37<T> {
  ...
  void testF10() {
    ...
    Expect.isTrue(
      m10 is List<Function> Function(int, {List<Function> x}) Function(int x),
    );
  ...
  void testF12() {
    ...
    Expect.isTrue(
      m12
          is core.List<core.int> Function(int y, [List<Function> x]) Function(
            int x,
          ),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21 is core.List<core.int> Function<A>(List<Function> x) Function(int x),
    );
