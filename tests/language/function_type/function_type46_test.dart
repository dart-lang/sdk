...
typedef F8<T> = Function Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>();
...
typedef F17<T> = Function(int x, [core.List<core.int> x1]) Function<B extends core.int>();
...
typedef F20<T> = int Function<A>(core.List<core.int> x) Function<B extends core.int>();
typedef F21<T> = core.List<core.int> Function<A>(List<T> x) Function<B extends core.int>();
...
Function Function(int x0, [core.List<core.int> x1]) f8<B extends core.int>() => null;
...
class U46<T> {
  ...
  Function Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>() x8;
  ...
  Function Function(int x0, [core.List<core.int> x1]) m8<B extends core.int>() => null;
  ...
  void testF8() {
    ...
    // In checked mode, verifies the type.
    Function Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>() l8;
    ...
    Expect.isTrue(m8 is Function Function(int x2, [core.List<core.int> x3]) Function<B extends core.int>());
  ...
  void testF17() {
    ...
    // In checked mode, verifies the type.
    Function(int x, [core.List<core.int> x1]) Function<B extends core.int>() l17;
    ...
    Expect.isTrue(m17 is Function(int x, [core.List<core.int> x1]) Function<B extends core.int>());
  ...
  void testF20() {
    ...
    Expect.isTrue(m20 is int Function<A>(core.List<core.int> x) Function<B extends core.int>());
  ...
  void testF21() {
    ...
    // In checked mode, verifies the type.
    core.List<core.int> Function<A>(List<T> x) Function<B extends core.int>() l21;
    ...
    Expect.isTrue(m21 is core.List<core.int> Function<A>(List<T> x) Function<B extends core.int>());
    ...
    if (!tIsBool) {
      ...
      core.List<core.int> Function<A>(List<T> x) Function<B extends core.int>() l21 = m21;
      // In checked mode, verifies the type.
      x21 = m21;
      x21 = confuse(m21);
    }
