...
class U43<T> {
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function([core.List<core.int>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9
          is List<Function> Function(int x, [int]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13
          is core.List<core.int> Function(int x, [List<T>])
          Function<B extends core.int>(int x),
    );
  ...
  void testF14() {
    ...
    Expect.isTrue(
      m14
          is List<T> Function(int, {Function x}) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17
          is Function(int, [core.List<core.int>]) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19
          is void Function(core.List<core.int> x) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF20() {
    ...
    Expect.isTrue(
      m20
          is int Function<A>(List<Function> x) Function<B extends core.int>(
            int x,
          ),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is core.List<core.int> Function<A>(core.List<core.int> x)
          Function<B extends core.int>(int x),
    );
  ...
  void testF23() {
    ...
    Expect.isTrue(
      m23 is B Function(List<Function> x) Function<B extends core.int>(int x),
    );
