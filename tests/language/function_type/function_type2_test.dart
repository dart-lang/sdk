...
class U2<T> {
  ...
  void testF6() {
    ...
    Expect.isTrue(
      m6
          is int Function([core.List<core.int> x])
          Function<B extends core.int>(),
    );
  ...
  void testF8() {
    ...
    Expect.isTrue(
      m8
          is Function Function(int, [List<Function>])
          Function<B extends core.int>(),
    );
  ...
  void testF9() {
    ...
    Expect.isTrue(
      m9 is Function Function(int, {List<T> x}) Function<B extends core.int>(),
    );
  ...
  void testF11() {
    ...
    Expect.isTrue(
      m11
          is List<Function> Function(int y, [List<T> x])
          Function<B extends core.int>(),
    );
  ...
  void testF12() {
    ...
    Expect.isTrue(
      m12
          is core.List<core.int> Function([Function])
          Function<B extends core.int>(),
    );
  ...
  void testF13() {
    ...
    Expect.isTrue(
      m13
          is core.List<core.int> Function({core.List<core.int> x})
          Function<B extends core.int>(),
    );
  ...
  void testF15() {
    ...
    Expect.isTrue(
      m15
          is List<T> Function(int, [core.List<core.int> x])
          Function<B extends core.int>(),
    );
  ...
  void testF17() {
    ...
    Expect.isTrue(
      m17 is Function(int x, [List<Function>]) Function<B extends core.int>(),
    );
  ...
  void testF19() {
    ...
    Expect.isTrue(
      m19 is void Function([List<Function> x]) Function<B extends core.int>(),
    );
  ...
  void testF21() {
    ...
    Expect.isTrue(
      m21
          is List<Function> Function<A>(Function x)
          Function<B extends core.int>(),
    );
  ...
  void testF23() {
    ...
    Expect.isTrue(
      m23
          is void Function<A>(core.List<core.int> x)
          Function<B extends core.int>(),
    );
