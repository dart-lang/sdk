...
extension E on C {
  int? get i => null;
  //       ^
  // [context 1] 'i' refers to a property so it couldn't be promoted.  See http://dart.dev/go/non-promo-non-field
  // [context 2] 'i' refers to a property so it couldn't be promoted.  See http://dart.dev/go/non-promo-non-field
  // [context 3] 'i' refers to a property so it couldn't be promoted.  See http://dart.dev/go/non-promo-non-field
  // [context 4] 'i' refers to a property so it couldn't be promoted.  See http://dart.dev/go/non-promo-non-field
  // [context 5] 'i' refers to a property so it couldn't be promoted.  See http://dart.dev/go/non-promo-non-field
