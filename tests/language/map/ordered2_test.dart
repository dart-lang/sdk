...
main() {
  ...
  // ASCII order
  check('100,200,30,40,5,6', '1,2,3,4,5,6', const {
    '100': 1,
    '200': 2,
    '30': 3,
    '40': 4,
  ...
  // Reverse ASCII order
  check('6,5,40,30,200,100', '6,5,4,3,2,1', const {
    '6': 6,
    '5': 5,
    '40': 4,
    '30': 3,
  ...
  // Numeric order
  check('5,6,30,40,100,200', '5,6,3,4,1,2', const {
    '5': 5,
    '6': 6,
    '30': 3,
    '40': 4,
  ...
  check('5,6,100,200,30,40', '5,6,1,2,3,4', const {
    '5': 5,
    '6': 6,
    '100': 1,
    '200': 2,
  ...
  // Records.
  check('(1, 1),(2, 2),(3, 3)', '1,2,3', const {
    (1, 1): 1,
    (2, 2): 2,
    (3, 3): 3,
  });
  check('(1, 1),(3, 3),(2, 2)', '1,3,2', const {
    (1, 1): 1,
    (3, 3): 3,
    (2, 2): 2,
  });
  check('(2, 2),(1, 1),(3, 3)', '2,1,3', const {
    (2, 2): 2,
    (1, 1): 1,
    (3, 3): 3,
  });
  check('(2, 2),(3, 3),(1, 1)', '2,3,1', const {
    (2, 2): 2,
    (3, 3): 3,
    (1, 1): 1,
  });
  check('(3, 3),(1, 1),(2, 2)', '3,1,2', const {
    (3, 3): 3,
    (1, 1): 1,
    (2, 2): 2,
  });
  check('(3, 3),(2, 2),(1, 1)', '3,2,1', const {
    (3, 3): 3,
    (2, 2): 2,
    (1, 1): 1,
  });
