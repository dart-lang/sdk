...
// assignments whose target is a static property access.
...
class Test {
  static C1<int> Function()? get staticC1IntFunctionQuestion => null;
  static set staticC1IntFunctionQuestion(Function? value) {}
  static double? get staticDoubleQuestion => null;
  static set staticDoubleQuestion(Object? value) {}
  static Function? get staticFunctionQuestion => null;
  static set staticFunctionQuestion(Function? value) {}
  static int? get staticIntQuestion => null;
  static set staticIntQuestion(Object? value) {}
  static Iterable<int>? get staticIterableIntQuestion => null;
  static set staticIterableIntQuestion(Object? value) {}
  static String get staticString => '';
  static set staticString(Object? value) {}
  static String? get staticStringQuestion => null;
  ...
  // `String?`.
  static set staticStringQuestion(String? value) {}
}
...
main() {
  ...
  //       imposes on its second argument).
  {
    ...
    Test.staticString ??= contextType('')..expectStaticType<Exactly<Object?>>();

    Test.staticStringQuestion ??= contextType('')
