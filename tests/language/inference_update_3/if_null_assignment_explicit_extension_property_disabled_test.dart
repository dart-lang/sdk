...
// assignments whose target is an access to an extension property, using
// explicit extension syntax.
...
main() {
  ...
  //       imposes on its second argument).
  {
    ...
    Extension('').pString ??= contextType('')
      ..expectStaticType<Exactly<Object?>>();

    Extension('').pStringQuestion ??= contextType('')
