...
The double will be backfilled into the xmm register.""",
  ...
  FunctionType(
    [struct40bytesDouble, struct4bytesInt, struct8bytesFloat],
    double_,
    """
...
stack.""",
  ...
  FunctionType(
    [uint8, struct1byteBool],
    bool_,
    """
Returning a bool.""",
  ),
  FunctionType(
    [wchar, structArrayWChar, uintptr, uintptr, long, ulong],
    wchar,
    """
Returning a wchar.""",
  ),
  FunctionType(
    [int64, int64, int64, int64, int64, int64, int64, struct12bytesInt],
    int64,
    """
...
On arm64, both argument and return value are passed in by pointer.""",
  ...
  FunctionType(
    [int32, int32, int32, int32, int32, int32, int32, int32, struct20bytesInt],
    struct20bytesInt,
    """
On arm64, both argument and return value are passed in by pointer.
...
Simple nested struct with floats."""),
  FunctionType(
    struct8bytesNestedFloat2.memberTypes,
...
Even deeper nested struct to test recursive member access."""),
  FunctionType(
    structNestedAlignmentInt16.memberTypes,
    structNestedAlignmentInt16,
    """
Test alignment and padding of nested struct with 16 byte int.""",
  ),
  FunctionType(
    structNestedAlignmentInt32.memberTypes,
    structNestedAlignmentInt32,
    """
Test alignment and padding of nested struct with 32 byte int.""",
  ),
  FunctionType(
    structNestedAlignmentInt64.memberTypes,
    structNestedAlignmentInt64,
    """
Test alignment and padding of nested struct with 64 byte int.""",
  ),
...
https://github.com/dart-lang/sdk/issues/49460""",
  ...
  FunctionType(
    varArgsIndex: 1,
    [struct12bytesInt, int32, int32, int32, int32],
    int32,
...
final struct9bytesInt2 = StructType.disambiguate([
  int64,
  int8,
], "4Or8ByteAligned");
...
final struct16bytesMixed2 = StructType.disambiguate([
  float,
  float,
  float,
  int32,
...
/// arm64.
final struct40bytesDouble = StructType([
  double_,
  double_,
  double_,
  double_,
...
final struct8bytesNestedFloat = StructType([
  struct4bytesFloat,
  struct4bytesFloat,
]);
final struct8bytesNestedFloat2 = StructType.disambiguate([
  struct4bytesFloat,
  float,
], "2");
final struct8bytesNestedMixed = StructType([
  struct4bytesInt,
  struct4bytesFloat,
]);

final struct16bytesNestedInt = StructType([
  struct8bytesNestedInt,
  struct8bytesNestedInt,
]);
final struct32bytesNestedInt = StructType([
  struct16bytesNestedInt,
  struct16bytesNestedInt,
]);

final structNestedAlignmentInt16 = StructType.disambiguate(
  List.filled(2, structAlignmentInt16),
  structAlignmentInt16.name,
);
final structNestedAlignmentInt32 = StructType.disambiguate(
  List.filled(2, structAlignmentInt32),
  structAlignmentInt32.name,
);
final structNestedAlignmentInt64 = StructType.disambiguate(
  List.filled(2, structAlignmentInt64),
  structAlignmentInt64.name,
);
...
final structInlineArrayIrregular = StructType.override([
  FixedLengthArrayType(struct3bytesInt2, 2),
  uint8,
], "InlineArrayIrregular");

final structInlineArray100Bytes = StructType.override([
  FixedLengthArrayType(uint8, 100),
], "InlineArray100Bytes");

final structInlineArrayBig = StructType.override([
  uint32,
  uint32,
  FixedLengthArrayType(uint8, 4000),
], "InlineArrayBig");
...
final struct3bytesPackedMembersAligned = StructType.disambiguate(
  [int8, int16],
  "MembersAligned",
  packing: 1,
);
...
final struct6bytesPacked2 = StructType([
  FixedLengthArrayType(struct3bytesPackedMembersAligned, 2),
]);

final struct8bytesPacked = StructType([
  uint8,
  uint32,
  uint8,
  uint8,
...
final struct15bytesPacked = StructType([
  FixedLengthArrayType(struct5bytesPacked, 3),
]);
...
final union16bytesFloat = UnionType([
  FixedLengthArrayType(float, 4),
  struct16bytesFloat,
]);

/// This union has homogenous floats of different sizes.
final union16bytesFloat2 = UnionType([
  struct8bytesFloat,
  struct12bytesFloat,
  struct16bytesFloat,
]);
