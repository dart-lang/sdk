...
Future<void> selfInvokes() async {
  final selfSourceUri = Platform.script.resolve(
    'asset_library_annotation_test.dart',
  );
...
Future<void> runTests() async {
  ...
  testCodeAssetNotFound(assetName);
  testOpenFfiTestFunctionsAssetCanClose(assetName);
}
...
void testFfiTestfunctionsDll() {
  ...
  final ptr = Native.addressOf<NativeFunction<Int32 Function(Int32, Int32)>>(
    SumPlus42,
  );
