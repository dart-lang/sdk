...
double manyArgs(
  ...
  print(
    "manyArgs( $_1, $_2, $_3, $_4, $_5, $_6, $_7, $_8, $_9, $_10," +
...
final testcases = [
  ...
  CallbackTest(
    "ManyDoubles",
    Pointer.fromFunction<ManyDoublesType>(manyDoubles, 0.0),
  ),
  ...
  CallbackTest(
    "NullPointers",
    Pointer.fromFunction<NullPointersType>(nullPointers),
  ),
