...
class FakeFunctionNSM {
  noSuchMethod(Invocation msg) => msg.positionalArguments.join(', ');
}

class C {
  var fakeFunctionCall = FakeFunctionCall();
  var fakeFunctionNSM = FakeFunctionNSM();
...
class D {
  static dynamic fakeFunctionCall = FakeFunctionCall();
  static dynamic fakeFunctionNSM = FakeFunctionNSM();
