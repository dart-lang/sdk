...
testConstructor() {
  ...
  var b = Float64x2.splat(1.0);
  Expect.equals(1.0, b.x);
  Expect.equals(1.0, b.y);
  var c = Float64x2.zero();
  Expect.equals(0.0, c.x);
  Expect.equals(0.0, c.y);
}

testCastConstructor() {
  var a = Float32x4(9.0, 8.0, 7.0, 6.0);
  var b = Float64x2.fromFloat32x4(a);
  Expect.equals(9.0, b.x);
  Expect.equals(8.0, b.y);
  var c = Float32x4.fromFloat64x2(b);
...
testAbs() {
  var m = Float64x2(1.0, -0.5).abs();
  var n = Float64x2(-2.0, 1.0).abs();
...
testClamp() {
  var m = Float64x2(1.0, -2.0);
  var lo = Float64x2(0.0, 0.5);
  var hi = Float64x2(2.0, 2.0);
  m = m.clamp(lo, hi);
  Expect.equals(1.0, m.x);
  Expect.equals(0.5, m.y);
}
...
testMin() {
  var m = Float64x2(0.0, -99.0);
  var n = Float64x2(-1.0, -1.0);
  var o = m.min(n);
  Expect.equals(-1.0, o.x);
...
testTypedListFromList() {
  var l = [Float64x2(1.0, 2.0), Float64x2(3.0, 4.0)];
  var m = Float64x2List.fromList(l);
...
testTypedListFromTypedList() {
  var l = Float64x2List(2);
  l[0] = Float64x2(1.0, 2.0);
  l[1] = Float64x2(3.0, 4.0);
...
testTypedListView() {
  ...
  var fl = Float64List.fromList(l);
  Expect.equals(4, fl.length);
  var m = Float64x2List.view(fl.buffer);
  Expect.equals(2, m.length);
  Expect.equals(1.0, m[0].x);
  Expect.equals(2.0, m[0].y);
  Expect.equals(3.0, m[1].x);
...
testTypedListFullView() {
  ...
  var n = Float64x2List.view(m.buffer);
  ...
  var o = Float64x2List.view(m.buffer, 0, 2);
