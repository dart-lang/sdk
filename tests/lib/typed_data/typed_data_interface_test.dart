...
void main() {
  ...
  for (var bytes in [0, 16, 64]) {
    ...
    test(
      Uint8ClampedList.sublistView(typedList, 32, 32 + bytes * size),
      size,
      bytes,
    );
    ...
    test(
      Uint16List.sublistView(typedList, 32, 32 + bytes * size ~/ 2),
      size,
      bytes,
    );
    ...
    test(
      Int16List.sublistView(typedList, 32, 32 + bytes * size ~/ 2),
      size,
      bytes,
    );
    ...
    test(
      Uint32List.sublistView(typedList, 32, 32 + bytes * size ~/ 4),
      size,
      bytes,
    );
    ...
    test(
      Int32List.sublistView(typedList, 32, 32 + bytes * size ~/ 4),
      size,
      bytes,
    );
    ...
    if (!jsNumbers) {
      ...
      test(
        Uint64List.sublistView(typedList, 32, 32 + bytes * size ~/ 8),
        size,
        bytes,
      );
      ...
      test(
        Int64List.sublistView(typedList, 32, 32 + bytes * size ~/ 8),
        size,
        bytes,
      );
    }
    ...
    test(
      Float32List.sublistView(typedList, 32, 32 + bytes * size ~/ 4),
      size,
      bytes,
    );
    ...
    test(
      Float64List.sublistView(typedList, 32, 32 + bytes * size ~/ 8),
      size,
      bytes,
    );
    ...
    test(
      Int32x4List.sublistView(typedList, 32, 32 + bytes * size ~/ 16),
      size,
      bytes,
    );
    ...
    test(
      Float32x4List.sublistView(typedList, 32, 32 + bytes * size ~/ 16),
      size,
      bytes,
    );
    ...
    test(
      Float64x2List.sublistView(typedList, 32, 32 + bytes * size ~/ 16),
      size,
      bytes,
    );
  }
  ...
  Expect.equals(
    roundTo(oddSize, Uint8List.bytesPerElement),
    Uint8List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Int8List.bytesPerElement),
    Int8List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Uint8ClampedList.bytesPerElement),
    Uint8ClampedList.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Uint16List.bytesPerElement),
    Uint16List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Int16List.bytesPerElement),
    Int16List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Uint32List.bytesPerElement),
    Uint32List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Int32List.bytesPerElement),
    Int32List.view(oddBuffer).lengthInBytes,
  );
  if (!jsNumbers) {
    Expect.equals(
      roundTo(oddSize, Uint64List.bytesPerElement),
      Uint64List.view(oddBuffer).lengthInBytes,
    );
    Expect.equals(
      roundTo(oddSize, Int64List.bytesPerElement),
      Int64List.view(oddBuffer).lengthInBytes,
    );
  }
  Expect.equals(
    roundTo(oddSize, Float32List.bytesPerElement),
    Float32List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Float64List.bytesPerElement),
    Float64List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Int32x4List.bytesPerElement),
    Int32x4List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Float32x4List.bytesPerElement),
    Float32x4List.view(oddBuffer).lengthInBytes,
  );
  Expect.equals(
    roundTo(oddSize, Float64x2List.bytesPerElement),
