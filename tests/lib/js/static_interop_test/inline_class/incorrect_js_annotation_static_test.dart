...
//           ^
// [web] Inline classes should use `dart:js_interop`'s `@JS` annotation, not `package:js`' `@JS` annotation.

@jsi.JS()
class JsiClass {}
//    ^
// [web] `dart:js_interop`'s `@JS` annotation can only be used for static interop, either through inline classes or `@staticInterop`.
