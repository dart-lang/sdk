...
main() {
  ...
  check(
    new DateTime.utc(2012, 02, 27, 13, 27, 0, 123, 456),
  ...
  check(
    new DateTime.utc(2015, 02, 14, 13, 0, 0, 0),
    "2015-02-15T00:00:00+11:00",
  );

  check(
    new DateTime.utc(2015, 02, 15, 0, 0, 0, 500, 500),
    "2015-02-15T00:00:00.500500Z",
  );
  check(
    new DateTime.utc(2015, 02, 15, 0, 0, 0, 511, 500),
