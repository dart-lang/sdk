...
void testInvalidBind() {
  ...
  asyncStart();
  SecureServerSocket.bind("ko.faar.__hest__", 0, serverContext)
      .then((_) {
  ...
  asyncStart();
  SecureServerSocket.bind("8.8.8.8", 0, serverContext)
      .then((_) {
        Expect.fail("Failure expected");
      })
      .catchError((error) {
  ...
  asyncStart();
  SecureServerSocket.bind(HOST, 0, serverContext).then((s) {
    SecureServerSocket.bind(HOST, s.port, serverContext)
        .then((t) {
