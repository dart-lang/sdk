...
vars = {
  ...
  "fuchsia_sdk_version": "version:27.20250421.4.1",
  ...
  "boringssl_rev": "cccf8525db8a57153d3cb3e22efed2db4b71a8ab",
  ...
  "native_rev": "f1e2d898e78c17ff413727a58170d4bc21ec5678", # rolled manually while native assets are experimental
...
deps = {
  ...
  Var("dart_root") + "/third_party/fuchsia/test_scripts": {
    "packages": [
      ...
      "version": "TcALRG6cjvR6RVe4L8oiH60SOFvQQM9bP54kURsCgyAC",
      }
    ],
  ...
  Var("dart_root") + "/third_party/fuchsia/gn-sdk": {
    "packages": [
      ...
      "version": "jsZSHIOmQAs3URvWUa19VXM9ijCxdttNwanuXXmxltsC",
      }
    ],
    "condition": 'download_fuchsia_deps',
    "dep_type": "cipd",
