...
vars = {
  ...
  "co19_rev": "379503dac3a560fa1651d50d2920ab77f01e3d3a",
  ...
  "fuchsia_sdk_version": "version:30.20260108.5.1",
  ...
  "boringssl_rev": "78ab2c2774bccbd29ec217fd071e6ee63bde6bb1",
...
deps = {
  ...
  Var("dart_root") + "/third_party/fuchsia/test_scripts": {
    "packages": [
      ...
      "version": "nR2ESa1Gd8yPcWo063yCqGBh6aAsLcwhgsRPFU0I0v0C",
      }
    ],
