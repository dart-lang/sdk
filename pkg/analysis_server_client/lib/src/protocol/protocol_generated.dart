...
class AnalysisClosingLabelsParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['labels'] = labels
        .map((ClosingLabel value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisErrorFixes implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['fixes'] = fixes
        .map((SourceChange value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisErrorsParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['errors'] = errors
        .map((AnalysisError value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisFoldingParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['regions'] = regions
        .map((FoldingRegion value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisGetHoverResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    ...
    result['hovers'] = hovers
        .map((HoverInformation value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisGetImportedElementsResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    ...
    result['elements'] = elements
        .map((ImportedElements value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisGetNavigationResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    ...
    result['targets'] = targets
        .map((NavigationTarget value) => value.toJson())
        .toList();
    result['regions'] = regions
        .map((NavigationRegion value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisGetSignatureResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    ...
    result['parameters'] = parameters
        .map((ParameterInfo value) => value.toJson())
        .toList();
...
class AnalysisHighlightsParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['file'] = file;
    result['regions'] = regions
        .map((HighlightRegion value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisImplementedParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['classes'] = classes
        .map((ImplementedClass value) => value.toJson())
        .toList();
    result['members'] = members
        .map((ImplementedMember value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisOccurrencesParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['occurrences'] = occurrences
        .map((Occurrences value) => value.toJson())
        .toList();
    return result;
  }
...
class AnalysisOverridesParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['overrides'] = overrides
        .map((Override value) => value.toJson())
        .toList();
    return result;
  }
...
class BulkFix implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['path'] = path;
    result['fixes'] = fixes
        .map((BulkFixDetail value) => value.toJson())
        .toList();
    return result;
  }
...
class CompletionGetSuggestions2Params implements RequestParams {
  ...
  Map<String, Object> toJson() {
    ...
    if (completionCaseMatchingMode != null) {
      result['completionCaseMatchingMode'] = completionCaseMatchingMode
          .toJson();
    }
...
class CompletionRegisterLibraryPathsParams implements RequestParams {
  ...
  Map<String, Object> toJson() {
    var result = <String, Object>{};
    result['paths'] = paths
        .map((LibraryPathSet value) => value.toJson())
        .toList();
    return result;
  }
...
class DiagnosticGetDiagnosticsResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    ...
    result['contexts'] = contexts
        .map((ContextData value) => value.toJson())
        .toList();
    return result;
  }
...
class EditGetAvailableRefactoringsResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    var result = <String, Object>{};
    result['kinds'] = kinds
        .map((RefactoringKind value) => value.toJson())
        .toList();
    return result;
  }
...
class EditGetFixesResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    var result = <String, Object>{};
    result['fixes'] = fixes
        .map((AnalysisErrorFixes value) => value.toJson())
        .toList();
    return result;
  }
    ...
    if (json is Map) {
      ...
      if (json.containsKey('expressions')) {
        expressions = jsonDecoder.decodeList(
          ...
          json['expressions'],
          (String jsonPath, Object? json) =>
              RuntimeCompletionExpression.fromJson(jsonDecoder, jsonPath, json),
        );
      }
...
class ExecutionSetSubscriptionsParams implements RequestParams {
  ...
  Map<String, Object> toJson() {
    var result = <String, Object>{};
    result['subscriptions'] = subscriptions
        .map((ExecutionService value) => value.toJson())
        .toList();
    return result;
  }
...
class ExistingImports implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['imports'] = imports
        .map((ExistingImport value) => value.toJson())
        .toList();
    return result;
  }
  ...
  Map<String, Object> toJson() {
    ...
    if (children != null) {
      result['children'] = children
          .map((FlutterOutline value) => value.toJson())
          .toList();
    }
    return result;
  }
  ...
  factory MoveFileOptions.fromJson(
    ...
    if (json is Map) {
      ...
      if (json.containsKey('newFile')) {
        newFile = jsonDecoder.decodeString(
          '$jsonPath.newFile',
          json['newFile'],
        );
      } else {
...
class SearchGetElementDeclarationsResult implements ResponseResult {
  ...
  Map<String, Object> toJson() {
    ...
    result['declarations'] = declarations
        .map((ElementDeclaration value) => value.toJson())
        .toList();
    result['files'] = files;
    return result;
  }
...
class SearchResultsParams implements HasToJson {
  ...
  Map<String, Object> toJson() {
    ...
    result['results'] = results
        .map((SearchResult value) => value.toJson())
        .toList();
...
class ServerSetSubscriptionsParams implements RequestParams {
  ...
  Map<String, Object> toJson() {
    var result = <String, Object>{};
    result['subscriptions'] = subscriptions
        .map((ServerService value) => value.toJson())
        .toList();
    return result;
  }
...
class ServerShowMessageRequestParams implements RequestParams {
  ...
  Map<String, Object> toJson() {
    ...
    result['actions'] = actions
        .map((MessageAction value) => value.toJson())
        .toList();
    return result;
  }
