  ...
  group('explicit dartdev smoke -', () {
    ...
    test('dart run smoke.dart', () async {
      for (int i = 1; i <= numRuns; ++i) {
        ...
        final result = await Process.run(Platform.executable, ['run', script]);
    ...
    test('dart --enable-experiment=variance '
    ...
    // is passed.
    test('dart --enable-experiment=invalid-experiment-name '
        'run smoke.dart', () async {
      final result = await Process.run(Platform.executable, [
