...
class Class1<T> {
  ...
  "inferredType": "[subclass=Closure|powerset={N}{O}]",
  "code": "",
  "type": "Type Function()"
},
    {
  ...
  "returnType": "Type",
  "inferredReturnType": "[exact=_Type|powerset={N}{O}]",
  "parameters": [],
  ...
  */
  ...
  "parent": "class/memory:sdk/tests/web/native/main.dart::Class1",
  "children": [],
  "inferredType": "[null|subclass=Closure|powerset={null}{N}{O}]",
  "code": "",
  "type": "dynamic"
}],
   holding=[
  ...
  */
  ...
  "returnType": "dynamic",
  "inferredReturnType": "[exact=Class1|powerset={N}{O}]",
  "parameters": [],
  ...
  */
  ...
  "inferredReturnType": "[subclass=_LinkedHashSet|powerset={N}{O}]",
  "parameters": [],
  ...
  */
  ...
  "returnType": "dynamic",
  "inferredReturnType": "[subclass=Closure|powerset={N}{O}]",
  "parameters": [],
  "sideEffects": "SideEffects(reads nothing; writes nothing)",
  "inlinedCount": 0,
  ...
  */
  ...
  "inferredReturnType": "[exact=JsLinkedHashMap|powerset={N}{O}]",
  "parameters": [],
  "sideEffects": "SideEffects(reads nothing; writes nothing)",
  "inlinedCount": 0,
  ...
  "returnType": "String",
  "inferredReturnType": "[exact=JSString|powerset={I}{O}]",
  "parameters": [],
...
/*member: nested2:
 ...
 function=[
  ...
  "returnType": "int",
  "inferredReturnType": "[subclass=JSInt|powerset={I}{O}]",
  "parameters": [],
  "sideEffects": "SideEffects(reads anything; writes anything)",
  "inlinedCount": 0,
  ...
  "returnType": "int",
  "inferredReturnType": "[exact=JSUInt31|powerset={I}{O}]",
  "parameters": [],
  "sideEffects": "SideEffects(reads nothing; writes nothing)",
  "inlinedCount": 0,
  "code": "call$0() {\n      return 2;\n    }",
