...
void verifyGraphFileLines(
  ...
  verifyGeneratedFile(
    graphIsomorphizer.mainFilename,
    graphIsomorphizer.mainBuffer,
    expectations,
  );
  verifyGeneratedFile(
    graphIsomorphizer.rootImportFilename,
    graphIsomorphizer.rootImportBuffer,
    expectations,
  );
...
void generateGoldens() {
  testCases.forEach((name, test) {
    var graphIsomorphizer = generateFiles(
      test,
      outDirectory: goldenDirectory + '/' + name,
    );
