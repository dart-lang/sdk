...
/*member: whileNull:Value([null|exact=JSString|powerset={null}{I}], value: "null", powerset: {null}{I})*/
whileNull() {
  var o;
  while (o == null) {
...
/*member: whileNotNull:[exact=JSString|powerset={I}]*/
whileNotNull() {
  var o = '';
...
/*member: whileNullUnreachable:Value([exact=JSString|powerset={I}], value: "", powerset: {I})*/
whileNullUnreachable() {
  var o = '';
  while (o /*invoke: [exact=JSString|powerset={I}]*/ == null) {
...
/*member: _whileUnion1:Union(null, [exact=Class1|powerset={N}], [exact=Class2|powerset={N}], powerset: {null}{N})*/
_whileUnion1(/*[exact=Class1|powerset={N}]*/ o) {
  while (o != null) {
    o = o. /*Union([exact=Class1|powerset={N}], [exact=Class2|powerset={N}], powerset: {N})*/ field;
  }
  return o;
}
...
/*member: _whileUnion2:Union(null, [exact=Class3|powerset={N}], [exact=Class4|powerset={N}], powerset: {null}{N})*/
_whileUnion2(/*[exact=Class4|powerset={N}]*/ o) {
  while (o != null) {
    o = o. /*Union([exact=Class3|powerset={N}], [exact=Class4|powerset={N}], powerset: {N})*/ field;
  }
  return o;
}
...
/*member: _whileUnion3:Union(null, [exact=Class5|powerset={N}], [exact=Class6|powerset={N}], powerset: {null}{N})*/
_whileUnion3(
  /*Union([exact=Class5|powerset={N}], [exact=Class6|powerset={N}], powerset: {N})*/ o,
) {
  while (o != null) {
    o = o. /*Union([exact=Class5|powerset={N}], [exact=Class6|powerset={N}], powerset: {N})*/ field;
  }
  return o;
}
...
class Class7 {
  /*member: Class7.field:[null|exact=Class8|powerset={null}{N}]*/
  var field;
}

/*member: Class8.:[exact=Class8|powerset={N}]*/
class Class8 {
  /*member: Class8.field:[null|exact=Class7|powerset={null}{N}]*/
  var field;
}

/*member: _whileIs:Union(null, [exact=Class7|powerset={N}], [exact=Class8|powerset={N}], powerset: {null}{N})*/
_whileIs(/*[exact=Class7|powerset={N}]*/ o) {
  while (o is Class7) {
    o = o. /*[exact=Class7|powerset={N}]*/ field;
  }
  return o;
}
...
whileIs() {
  var c1 = Class7();
  var c2 = Class8();
  c1. /*update: [exact=Class7|powerset={N}]*/ field = c2;
  c2. /*update: [exact=Class8|powerset={N}]*/ field = c1;
  _whileIs(c1);
}
...
class Class9 {
  /*member: Class9.field:[null|exact=Class10|powerset={null}{N}]*/
  var field;
}

/*member: Class10.:[exact=Class10|powerset={N}]*/
class Class10 {
  /*member: Class10.field:[null|exact=Class9|powerset={null}{N}]*/
  var field;
}

/*member: _whileIsNot:Union(null, [exact=Class10|powerset={N}], [exact=Class9|powerset={N}], powerset: {null}{N})*/
_whileIsNot(/*[exact=Class9|powerset={N}]*/ o) {
  while (o is! Class10) {
    o = o. /*Union(null, [exact=Class10|powerset={N}], [exact=Class9|powerset={N}], powerset: {null}{N})*/ field;
  }
  return o;
}
...
whileIsNot() {
  var c1 = Class9();
  var c2 = Class10();
  c1. /*update: [exact=Class9|powerset={N}]*/ field = c2;
  c2. /*update: [exact=Class10|powerset={N}]*/ field = c1;
  _whileIsNot(c1);
}
