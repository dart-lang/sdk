...
/*member: Super1.:[exact=Class1|powerset={N}]*/
...
/*member: Super2.:[exact=Class2|powerset={N}]*/
...
/*member: Super3.:[exact=Class3|powerset={N}]*/
...
/*member: field4:[null|exact=Class4|powerset={null}{N}]*/
var field4;

abstract class Super4 {
  /*member: Super4.:[exact=Class4|powerset={N}]*/
  Super4() {
    field4 = this;
  }
}
