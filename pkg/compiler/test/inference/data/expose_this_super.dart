...
/*member: Super1.:[exact=Class1|powerset={N}{O}]*/
...
/*member: Super2.:[exact=Class2|powerset={N}{O}]*/
...
/*member: Super3.:[exact=Class3|powerset={N}{O}]*/
...
/*member: field4:[null|exact=Class4|powerset={null}{N}{O}]*/
var field4;

abstract class Super4 {
  /*member: Super4.:[exact=Class4|powerset={N}{O}]*/
  Super4() {
    field4 = this;
  }
}
