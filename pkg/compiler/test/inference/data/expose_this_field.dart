...
class Class2 {
  ...
  Class2() {
    ...
    field = /*[exact=Class2|powerset={N}]*/ field;
  }
}
...
class Class3 {
  ...
  Class3() {
    ...
    field = /*[exact=Class3|powerset={N}]*/ field;
    /*update: [exact=Class3|powerset={N}]*/
    field = 42;
  }
}
...
class Class4 {
  ...
  Class4() {
    ...
    var o = /*[exact=Class4|powerset={N}]*/ field;
...
class Class5 {
  /*member: Class5.field:[null|subclass=JSPositiveInt|powerset={null}{I}]*/
  var field;

  /*member: Class5.:[exact=Class5|powerset={N}]*/
  Class5() {
    /*[exact=Class5|powerset={N}]*/ /*update: [exact=Class5|powerset={N}]*/
    field /*invoke: [null|subclass=JSPositiveInt|powerset={null}{I}]*/ ++;
...
class Class6 {
  /*member: Class6.field:[subclass=JSPositiveInt|powerset={I}]*/
  var field;
  ...
  Class6() {
    ...
    field = 42;
    /*[exact=Class6|powerset={N}]*/ /*update: [exact=Class6|powerset={N}]*/
    field /*invoke: [subclass=JSPositiveInt|powerset={I}]*/ ++;
  }
}
...
class Class7 {
  /*member: Class7.field1:[null|exact=JSUInt31|powerset={null}{I}]*/
  var field1;

  /*member: Class7.field2:[null|exact=JSUInt31|powerset={null}{I}]*/
  var field2;

  /*member: Class7.:[exact=Class7|powerset={N}]*/
  Class7() {
    // ignore: UNUSED_LOCAL_VARIABLE
    var o1 = /*[exact=Class7|powerset={N}]*/ field1;
    // ignore: UNUSED_LOCAL_VARIABLE
    var o2 = /*[exact=Class7|powerset={N}]*/ field2;
