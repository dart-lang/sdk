...
/*member: a:Value([exact=JSString|powerset={I}{O}], value: "", powerset: {I}{O})*/
var a = '';

/*member: A.:[exact=A|powerset={N}{O}]*/
class A {
  /*member: A.+:[exact=JSUInt31|powerset={I}{O}]*/
  operator +(/*[exact=JSUInt31|powerset={I}{O}]*/ other) => other;
}
...
foo() {
  ...
  return a /*invoke: Value([exact=JSString|powerset={I}{O}], value: "", powerset: {I}{O})*/ +
      'foo';
}

/*member: main:[null|powerset={null}]*/
main() {
  A() /*invoke: [exact=A|powerset={N}{O}]*/ + 42;
  foo();
}
