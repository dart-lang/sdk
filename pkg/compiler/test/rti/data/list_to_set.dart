...
/*spec.class: global#List:deps=[Class,JSArray.markFixedList],explicit=[Iterable<List.E>,List,List.E,List<List.E>,List<Object>,List<String>?,List<markFixedList.T>],needsArgs,test*/
