...
/*spec.class: global#List:deps=[Class.m,JSArray.markFixedList],explicit=[Iterable<List.E>,List,List.E,List<List.E>,List<Object>,List<String>?,List<markFixedList.T>],needsArgs,test*/
