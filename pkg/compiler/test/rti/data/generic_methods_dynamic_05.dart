...
/*spec.class: global#List:deps=[C.bar,JSArray.markFixedList],explicit=[List,List.E,List<B*>*,List<List.E>,List<Object>,List<String>?,List<markFixedList.T>],needsArgs,test*/
