...
class SingleTargetCacheViewElement extends CustomElement implements Renderable {
  ...
  factory SingleTargetCacheViewElement(
    ...
    e._r = new RenderingScheduler<SingleTargetCacheViewElement>(
      e,
      queue: queue,
    );
    e._vm = vm;
  ...
  SingleTargetCacheViewElement.created()
    : super.created('singletargetcache-view');
              ...
              new HTMLDivElement()
                ...
                ..appendChildren(<HTMLElement>[
                  ...
                  new HTMLDivElement()
                    ...
                    ..appendChildren(<HTMLElement>[
                      new HTMLSpanElement()
                        ..textContent = _singleTargetCache.lowerLimit
                            .toString(),
                    ]),
                ]),
              new HTMLDivElement()
                ...
                ..appendChildren(<HTMLElement>[
                  ...
                  new HTMLDivElement()
                    ...
                    ..appendChildren(<HTMLElement>[
                      new HTMLSpanElement()
                        ..textContent = _singleTargetCache.upperLimit
                            .toString(),
                    ]),
                ]),
            ]),
