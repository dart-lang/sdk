...
class DdsHostedAdapter
  ...
  Future<void> launchImpl() async {
    sendConsoleOutput('Launch is not supported for the attach only adapter');
  ...
  Future<void> attachImpl() async {
    ...
    if (vmServiceUri == null) {
      sendConsoleOutput('To attach, provide vmServiceUri');
      handleSessionTerminate();
      return;
    }
  ...
  Map<String, Object?> _createVariableForInstance(Object? arguments) {
    ...
    final variablesReference = thread.storeData(
      WrappedInstanceVariable(instanceId),
    );

    return {Parameters.variablesReference: variablesReference};
  }
  ...
  Map<String, Object?> _getVariablesInstanceId(Object? arguments) {
    ...
    return {Parameters.instanceId: instanceId};
  }
  ...
  void handleMessage(String message, void Function(Response) responseWriter) {
    final potentialException = DebugAdapterException(
      'Message does not conform to DAP spec: $message',
    );
