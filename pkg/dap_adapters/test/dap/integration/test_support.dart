...
import 'package:dap_adapters/src/logging.dart';
...
Future<Process> startDartProcessPaused(
  ...
  final processArgs = [...vmArgs, script, ...args];

  return Process.start(vmPath, processArgs, workingDirectory: cwd);
}
...
class DapTestSession {
  ...
  Future<(Uri, File)> createFooPackage([String? filename]) {
    return createSimplePackage('foo', '''
...
enum DriveLetterCasing { uppercase, lowercase }
