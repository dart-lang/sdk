...
import 'package:dap_adapters/src/protocol_stream.dart';
  ...
  group('dart base adapter', () {
    ...
    group('custom Dart SDK', () {
      ...
      final testUri = Uri.parse(
        'org-dartlang-sdk:///custom-dart/sdk/lib/core.dart',
      );
      final defaultSdkTestUri = Uri.parse(
        'org-dartlang-sdk:///sdk/lib/core.dart',
      );
    ...
    group('handles DebugAdapterExceptions', () {
      ...
      test('attach errors are shown to the user', () async {
        ...
        final args = DartAttachRequestArguments(vmServiceUri: 'phony-uri');
    ...
    test(
      'getFullString falls back to the truncated value if expansion fails',
      () async {
        final adapter = MockDartCliDebugAdapter()
