...
exhaustiveToString(Typedef o) {
  return /*
   ...
   type=Null
  */switch (o) {
    Typedef(:String Function() toString) /*space=Null(toString: String Function())*/=> toString,
  };
}
...
exhaustiveNoSuchMethod(Typedef o) {
  return /*
   ...
   type=Null
  */switch (o) {
    Typedef(:dynamic Function(Invocation) noSuchMethod) /*space=Null(noSuchMethod: dynamic Function(Invocation))*/=> noSuchMethod,
  };
}
...
nonExhaustiveRestrictedType(Typedef o) {
  return /*
   error=non-exhaustive:Null(noSuchMethod: dynamic Function(Invocation)),
   fields={noSuchMethod:dynamic Function(Invocation)},
   type=Null
  */switch (o) {
    Typedef(:int Function(Invocation) noSuchMethod) /*space=Null(noSuchMethod: int Function(Invocation))*/=> noSuchMethod,
  };
}
