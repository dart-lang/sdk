...
class C {
  get_property_via_explicit_this() {
    ...
    this
        .i
        . /*notPromoted(propertyNotPromotedForInherentReason(target: member:E|get#i))*/ isEven;
  }
  ...
  get_property_by_implicit_this() {
    if (i == null) return;
    i. /*notPromoted(propertyNotPromotedForInherentReason(target: member:E|get#i))*/ isEven;
  }
}
...
get_property_via_prefixed_identifier(C c) {
  if (c.i == null) return;
  c.i. /*notPromoted(propertyNotPromotedForInherentReason(target: member:E|get#i))*/ isEven;
}
