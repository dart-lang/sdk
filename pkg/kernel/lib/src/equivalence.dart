...
class EquivalenceStrategy {
  ...
  bool checkCatchVariable(
      EquivalenceVisitor visitor, CatchVariable? node, Object? other) {
    if (identical(node, other)) return true;
  ...
  bool checkAbstractSuperPropertyGet_receiver(EquivalenceVisitor visitor,
  ...
  bool checkSuperPropertyGet_receiver(EquivalenceVisitor visitor,
  ...
  bool checkAbstractSuperPropertySet_receiver(EquivalenceVisitor visitor,
  ...
  bool checkSuperPropertySet_receiver(EquivalenceVisitor visitor,
  ...
  bool checkAbstractSuperMethodInvocation_receiver(EquivalenceVisitor visitor,
  ...
  bool checkSuperMethodInvocation_receiver(EquivalenceVisitor visitor,
  ...
  bool checkVariableInitialization_contexts(EquivalenceVisitor visitor,
      VariableInitialization node, VariableInitialization other) {
    return visitor.checkLists(
        node.contexts, other.contexts, visitor.checkNodes, 'contexts');
  }
  ...
  bool checkVariableStatement_annotations(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return visitor.checkLists(
        node.annotations, other.annotations, visitor.checkNodes, 'annotations');
  }

  bool checkVariableStatement_name(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return visitor.checkValues(node.name, other.name, 'name');
  }

  bool checkVariableStatement_flags(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return visitor.checkValues(node.flags, other.flags, 'flags');
  }

  bool checkVariableStatement_type(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return visitor.checkNodes(node.type, other.type, 'type');
  }

  bool checkVariableStatement_binaryOffsetNoTag(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return visitor.checkValues(
        node.binaryOffsetNoTag, other.binaryOffsetNoTag, 'binaryOffsetNoTag');
  }

  bool checkVariableStatement_initializer(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return visitor.checkNodes(
        node.initializer, other.initializer, 'initializer');
  }

  bool checkVariableStatement_fileOffset(EquivalenceVisitor visitor,
      VariableStatement node, VariableStatement other) {
    return checkStatement_fileOffset(visitor, node, other);
  }
  ...
  bool checkCatch_exceptionCatchVariable(
    ...
    return visitor.checkNodes(node.exceptionCatchVariable,
        other.exceptionCatchVariable, 'exceptionCatchVariable');
  }

  bool checkCatch_stackTraceCatchVariable(
      EquivalenceVisitor visitor, Catch node, Catch other) {
    return visitor.checkNodes(node.stackTraceCatchVariable,
        other.stackTraceCatchVariable, 'stackTraceCatchVariable');
  }
  ...
  bool checkCatchVariable_catchVariableName(
    ...
    return visitor.checkValues(
        node.catchVariableName, other.catchVariableName, 'catchVariableName');
  }
  ...
  bool checkPositionalParameter_annotations(EquivalenceVisitor visitor,
      PositionalParameter node, PositionalParameter other) {
    return visitor.checkLists(
        node.annotations, other.annotations, visitor.checkNodes, 'annotations');
  }

  bool checkPositionalParameter_binaryOffsetNoTag(EquivalenceVisitor visitor,
      PositionalParameter node, PositionalParameter other) {
    return visitor.checkValues(
        node.binaryOffsetNoTag, other.binaryOffsetNoTag, 'binaryOffsetNoTag');
  }

  bool checkPositionalParameter_fileEqualsOffset(EquivalenceVisitor visitor,
      PositionalParameter node, PositionalParameter other) {
    return visitor.checkValues(
        node.fileEqualsOffset, other.fileEqualsOffset, 'fileEqualsOffset');
  }

  bool checkFunctionParameter_defaultValue(EquivalenceVisitor visitor,
      FunctionParameter node, FunctionParameter other) {
    return visitor.checkNodes(
        node.defaultValue, other.defaultValue, 'defaultValue');
  }

  bool checkPositionalParameter_defaultValue(EquivalenceVisitor visitor,
      PositionalParameter node, PositionalParameter other) {
  ...
  bool checkNamedParameter_parameterName(
    ...
    return visitor.checkValues(
        node.parameterName, other.parameterName, 'parameterName');
  }
  ...
  bool checkSyntheticVariable_annotations(EquivalenceVisitor visitor,
      SyntheticVariable node, SyntheticVariable other) {
    return visitor.checkLists(
        node.annotations, other.annotations, visitor.checkNodes, 'annotations');
  }
