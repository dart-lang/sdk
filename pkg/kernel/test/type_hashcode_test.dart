...
final List<TestCase> testCases = <TestCase>[
  ...
  failureCase(
    'Map<Map<S,String>, Map<int,S>>',
    'Map<Map<int, S>, Map<S, String>>',
    ['S'],
  ),
  successCase(
    'Map<Map<S, int>, Map<int, S>>',
    'Map<Map<int, S>, Map<S, int>>',
    {'S': 'int'},
  ),
  successCase(
    'Map<Map<S, String>, Map<int, T>>',
    'Map<Map<int, T>, Map<S, String>>',
    {'S': 'int', 'T': 'String'},
  ),
  ...
  successCase('Map<List<S>, T>', 'Map<T, List<S>>', {
    'T': 'List<S>',
    'S': null,
  }),
...
TestCase failureCase(
  String type1,
  String type2,
  List<String> quantifiedVariables, {
  bool debug = false,
}) {
