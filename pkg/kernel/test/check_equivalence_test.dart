  ...
  new Test(
    (bool first) {
      return new Component()
        ..libraries.add(
          new Library(
            first ? importUri1 : importUri2,
            fileUri: first ? fileUri1 : fileUri2,
          ),
        )
        ..libraries.add(
          new Library(
            first ? importUri2 : importUri1,
  ...
  new Test(
    (bool first) {
      ...
      Constructor c1 = new Constructor(
        new FunctionNode(null),
        name: new Name('constructor1'),
        fileUri: fileUri1,
      );
      Constructor c2 = new Constructor(
        new FunctionNode(null),
        name: new Name('constructor2'),
        fileUri: fileUri1,
      );
