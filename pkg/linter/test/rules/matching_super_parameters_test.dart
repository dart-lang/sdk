...
class MatchingSuperParametersTest extends LintRuleTest {
  ...
  test_inBodyToInBody_explicitInvocation_matchingWithOffset() async {
...
''');
  ...
  test_inBodyToInBody_explicitInvocation_matchingWithOffset_withNamedExplicit() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToInBody_explicitInvocation_matchingWithOffset_withNamedSuper() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToInBody_implicitInvocation_matchingWithGap() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToInBody_implicitInvocation_matchingWithOffset() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToInBody_implicitInvocation_nonMatching_tooMany() async {
...
''',
  ...
  test_inBodyToPrimary_explicitInvocation_matchingWithOffset() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToPrimary_explicitInvocation_matchingWithOffset_withNamedExplicit() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToPrimary_explicitInvocation_matchingWithOffset_withNamedSuper() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToPrimary_implicitInvocation_matchingWithGap() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToPrimary_implicitInvocation_matchingWithOffset() async {
    await assertNoDiagnostics(r'''
class D extends C {
  final String w;
...
''');
  ...
  test_inBodyToPrimary_implicitInvocation_nonMatching_tooMany() async {
    await assertDiagnostics(
      r'''
class D extends C {
  final String w;
...
''',
  ...
  test_primaryToInBody_explicitInvocation_matchingWithOffset() async {
    await assertNoDiagnostics(r'''
...
''');
  ...
  test_primaryToInBody_explicitInvocation_matchingWithOffset_withNamedExplicit() async {
    await assertNoDiagnostics(r'''
class D(this.w, super.x, super.y) extends C {
  final String w;
...
''');
  ...
  test_primaryToInBody_explicitInvocation_matchingWithOffset_withNamedSuper() async {
    await assertNoDiagnostics(r'''
...
''');
  ...
  test_primaryToInBody_implicitInvocation_matchingWithGap() async {
    await assertNoDiagnostics(r'''
...
''');
  ...
  test_primaryToInBody_implicitInvocation_matchingWithOffset() async {
    await assertNoDiagnostics(r'''
class D(this.w, super.x, super.y) extends C {
  final String w;
}
...
''');
  ...
  test_primaryToInBody_implicitInvocation_nonMatching_tooMany() async {
    await assertDiagnostics(
      r'''
