...
void testProperties() {
  ...
  var cfe = StaticError(
    ErrorSource.cfe,
    "Error.",
    path: '${Directory.current.path}/test.dart',
    line: 4,
    column: 5,
  );
...
void testIsWarning() {
  ...
  Expect.isFalse(
    makeError(analyzerError: "SYNTACTIC_ERROR.MISSING_FUNCTION_BODY").isWarning,
  );
  Expect.isFalse(
    makeError(
...
void expectValidate(
  List<StaticError> expected,
  List<StaticError> actual,
