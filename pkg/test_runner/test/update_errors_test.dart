...
/\/ [web] Wrong.
""",
    remove: {ErrorSource.analyzer, ErrorSource.web},
    expected: """
int i = "bad";
/\/      ^^^^^
/\/ [cfe] CFE error.
...
""",
    errors: [makeError(line: 2, column: 4, length: 5, cfeError: "Error.")],
    expected: """
main() {
  ["bad"];
...
int i = "bad";
""",
    errors: [makeError(line: 1, column: 9, cfeError: "Error.")],
    expected: """
int i = "bad";
/\/      ^
/\/ [cfe] Error.
...
"bad";
""",
    errors: [makeError(line: 2, column: 1, cfeError: "Error.")],
    expected: """
int i =
"bad";
/\/ [error column 1]
...
// Line comment.
""",
    errors: [makeError(line: 1, column: 9, length: 5, cfeError: "Wrong.")],
    expected: """
int i = "bad";
/\/      ^^^^^
/\/ [cfe] Wrong.
...
void expectUpdate(
  ...
  var actual = updateErrorExpectations(
    'some_test.dart',
    original,
    errors,
    remove: remove,
