...
const String ANALYSIS_NOTIFICATION_FLUTTER_OUTLINE = 'analysis.flutterOutline';
const String ANALYSIS_NOTIFICATION_FLUTTER_OUTLINE_FILE = 'file';
const String ANALYSIS_NOTIFICATION_FLUTTER_OUTLINE_OUTLINE = 'outline';
