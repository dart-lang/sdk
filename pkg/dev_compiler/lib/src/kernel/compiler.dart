...
class ProgramCompiler extends ComputeOnceConstantVisitor<js_ast.Expression>
  ...
  void _emitClass(Class c) {
    ...
    var savedStaticTypeContext = _staticTypeContext;
    ...
    _staticTypeContext =
        StaticTypeContext.forAnnotations(_currentLibrary, _types);
    ...
    _staticTypeContext = savedStaticTypeContext;
  }
  ...
  js_ast.Expression _emitConstructor(
    ...
    _staticTypeContext = StaticTypeContext(node, _types);
  ...
  js_ast.Statement _initializeFields(List<Field> fields, [Constructor ctor]) {
    ...
    for (var f in fields) {
      ...
      var savedStaticTypeContext = _staticTypeContext;
      _staticTypeContext = StaticTypeContext(f, _types);
  ...
  List<js_ast.Method> _emitClassMethods(Class c) {
    ...
    for (var m in c.procedures) {
      var savedStaticTypeContext = _staticTypeContext;
      _staticTypeContext = StaticTypeContext(m, _types);
  ...
  void _emitTopLevelFields(List<Field> fields) {
    if (isSdkInternalRuntime(_currentLibrary)) {
      ...
      for (var field in fields) {
        var savedStaticTypeContext = _staticTypeContext;
        _staticTypeContext = StaticTypeContext(field, _types);
  ...
  js_ast.Statement _emitLibraryFunction(Procedure p) {
    var savedStaticTypeContext = _staticTypeContext;
    var savedUri = _currentUri;
    _staticTypeContext = StaticTypeContext(p, _types);
  ...
  List<js_ast.Statement> _withCurrentFunction(
    ...
    _currentFunction = fn;
    _nullableInference.enterFunction(_staticTypeContext, fn);
