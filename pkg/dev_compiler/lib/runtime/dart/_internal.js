...
(function(exports) {
  ...
  let ExpandIterable$ = dart.generic(function(S, T) {
    class ExpandIterable extends collection.IterableBase$(T) {
      ...
      get iterator() {
        return new (ExpandIterator$(S, T))(this[_iterable].iterator, dart.as(this[_f], dart.throw_("Unimplemented type (S) → Iterable<T>")));
      }
    }
  ...
  let TakeWhileIterable$ = dart.generic(function(E) {
    class TakeWhileIterable extends collection.IterableBase$(E) {
      ...
      get iterator() {
        return new (TakeWhileIterator$(E))(this[_iterable].iterator, dart.as(this[_f], dart.throw_("Unimplemented type (E) → bool")));
      }
    }
  ...
  let SkipWhileIterable$ = dart.generic(function(E) {
    class SkipWhileIterable extends collection.IterableBase$(E) {
      ...
      get iterator() {
        return new (SkipWhileIterator$(E))(this[_iterable].iterator, dart.as(this[_f], dart.throw_("Unimplemented type (E) → bool")));
      }
    }
