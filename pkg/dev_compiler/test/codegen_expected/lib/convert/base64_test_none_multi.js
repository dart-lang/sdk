dart_library.library('lib/convert/base64_test_none_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__base64_test_none_multi(exports, dart_sdk, expect) {
  'use strict';
  ...
  const base64_test_none_multi = Object.create(null);
  ...
  let TestSinkOfListOfint = () => (TestSinkOfListOfint = dart.constFn(base64_test_none_multi.TestSink$(ListOfint())))();
  let TestSinkOfString = () => (TestSinkOfString = dart.constFn(base64_test_none_multi.TestSink$(core.String)))();
  let TestSink = () => (TestSink = dart.constFn(base64_test_none_multi.TestSink$()))();
  ...
  base64_test_none_multi.main = function() {
    for (let list of JSArrayOfListOfint().of([JSArrayOfint().of([]), JSArrayOfint().of([0]), JSArrayOfint().of([255, 0]), JSArrayOfint().of([255, 170, 85]), JSArrayOfint().of([0, 1, 2, 3]), IterableOfint().generate(13)[dartx.toList](), IterableOfint().generate(254)[dartx.toList](), IterableOfint().generate(255)[dartx.toList](), IterableOfint().generate(256)[dartx.toList]()])) {
      base64_test_none_multi.testRoundtrip(list, dart.str`List#${list[dartx.length]}`);
      base64_test_none_multi.testRoundtrip(typed_data.Uint8List.fromList(list), dart.str`Uint8List#${list[dartx.length]}`);
    }
    base64_test_none_multi.testErrors();
    base64_test_none_multi.testIssue25577();
    expect$.Expect.listEquals(JSArrayOfint().of([251, 255, 191, 0]), convert.BASE64.decode("-_+/AA%3D="));
    expect$.Expect.listEquals(JSArrayOfint().of([251, 255, 191, 0]), convert.BASE64.decode("-_+/AA=%3D"));
  };
  dart.fn(base64_test_none_multi.main, VoidTodynamic());
  base64_test_none_multi.testRoundtrip = function(list, name) {
  ...
  dart.fn(base64_test_none_multi.testRoundtrip, ListOfintAndStringTovoid());
  base64_test_none_multi.isFormatException = function(e) {
    return core.FormatException.is(e);
  };
  dart.fn(base64_test_none_multi.isFormatException, dynamicTobool());
  base64_test_none_multi.isArgumentError = function(e) {
    return core.ArgumentError.is(e);
  };
  dart.fn(base64_test_none_multi.isArgumentError, dynamicTobool());
  base64_test_none_multi.testErrors = function() {
    function badChunkDecode(list) {
      expect$.Expect.throws(dart.fn(() => {
        ...
        c.close();
      }, VoidTovoid()), base64_test_none_multi.isFormatException, dart.str`chunk ${list}`);
    }
    dart.fn(badChunkDecode, ListOfStringTovoid());
    function badDecode(string) {
      expect$.Expect.throws(dart.fn(() => convert.BASE64.decode(string), VoidToListOfint()), base64_test_none_multi.isFormatException, string);
      expect$.Expect.throws(dart.fn(() => convert.BASE64URL.decode(string), VoidToListOfint()), base64_test_none_multi.isFormatException, string);
      ...
      for (let i = 0; i < dart.notNull(list[dartx.length]); i++) {
        for (let j = 0; j < dart.notNull(list[dartx.length]); j++) {
          expect$.Expect.throws(dart.fn(() => {
            ...
            c.close();
          }, VoidTovoid()), base64_test_none_multi.isArgumentError, dart.str`chunk ${list}`);
        }
      }
      for (let i = 0; i < dart.notNull(list[dartx.length]); i++) {
        for (let j = 0; j < dart.notNull(list[dartx.length]); j++) {
    ...
    function badEncode(invalid) {
      ...
      }, VoidTovoid()), base64_test_none_multi.isArgumentError, dart.str`${invalid}`);
      expect$.Expect.throws(dart.fn(() => {
  ...
  dart.fn(base64_test_none_multi.testErrors, VoidTovoid());
  base64_test_none_multi.testIssue25577 = function() {
  ...
  dart.fn(base64_test_none_multi.testIssue25577, VoidTovoid());
  base64_test_none_multi.TestSink$ = dart.generic(T => {
  ...
  base64_test_none_multi.TestSink = TestSink();
  // Exports:
  exports.base64_test_none_multi = base64_test_none_multi;
});
