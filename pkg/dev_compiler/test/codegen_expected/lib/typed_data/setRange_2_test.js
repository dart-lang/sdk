dart_library.library('lib/typed_data/setRange_2_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__setRange_2_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  dart.fn(setRange_2_test.sameElementSizeTest, VoidTodynamic());
  setRange_2_test.main = function() {
    setRange_2_test.sameElementSizeTest();
  };
  dart.fn(setRange_2_test.main, VoidTodynamic());
