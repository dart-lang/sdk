dart_library.library('lib/html/js_typed_interop_default_arg_test_default_value_multi', null, /* Imports */[
  'dart_sdk',
  'unittest'
], function load__js_typed_interop_default_arg_test_default_value_multi(exports, dart_sdk, unittest) {
  'use strict';
  ...
  dart.fn(js_typed_interop_default_arg_test_default_value_multi._injectJs, VoidTodynamic());
  js_typed_interop_default_arg_test_default_value_multi.main = function() {
    ...
    unittest$.test('call tearoff from dart with default', dart.fn(() => {
      let f = dart.global.Foo.get42;
      src__matcher__expect.expect(f(), 3);
      f = dart.global.Foo.get43;
      src__matcher__expect.expect(f(), 43);
    }, VoidTodynamic()));
  };
  dart.fn(js_typed_interop_default_arg_test_default_value_multi.main, VoidTodynamic());
  // Exports:
