dart_library.library('lib/html/js_typed_interop_default_arg_test_explicit_argument_multi', null, /* Imports */[
  'dart_sdk',
  'unittest'
], function load__js_typed_interop_default_arg_test_explicit_argument_multi(exports, dart_sdk, unittest) {
  'use strict';
  ...
  dart.fn(js_typed_interop_default_arg_test_explicit_argument_multi._injectJs, VoidTodynamic());
  js_typed_interop_default_arg_test_explicit_argument_multi.main = function() {
    ...
    unittest$.test('call tearoff from dart with arg', dart.fn(() => {
      ...
      src__matcher__expect.expect(f(2), 2);
    }, VoidTodynamic()));
  ...
  dart.fn(js_typed_interop_default_arg_test_explicit_argument_multi.main, VoidTodynamic());
  // Exports:
