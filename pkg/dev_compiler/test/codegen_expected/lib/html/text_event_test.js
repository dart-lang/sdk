dart_library.library('lib/html/text_event_test', null, /* Imports */[
  'dart_sdk',
  'unittest'
], function load__text_event_test(exports, dart_sdk, unittest) {
  'use strict';
  ...
  let VoidToTextEvent = () => (VoidToTextEvent = dart.constFn(dart.definiteFunctionType(html.TextEvent, [])))();
  ...
  text_event_test.main = function() {
    ...
    event_test.eventTest('TextEvent', dart.fn(() => html.TextEvent.new('foo', {view: html.window, data: 'data'}), VoidToTextEvent()), dart.fn(ev => {
      src__matcher__expect.expect(dart.dload(ev, 'data'), 'data');
    }, dynamicTovoid$()));
  };
  dart.fn(text_event_test.main, VoidTodynamic());
