dart_library.library('lib/html/filteredelementlist_test', null, /* Imports */[
  ...
  let VoidToDivElement = () => (VoidToDivElement = dart.constFn(dart.definiteFunctionType(html.DivElement, [])))();
  ...
  filteredelementlist_test.main = function() {
    ...
    dart.fn(createTestDiv, VoidToDivElement());
    html_config.useHtmlConfiguration();
    unittest$.test('FilteredElementList.insert test', dart.fn(() => {
      let i = html.DivElement.new();
      let nodeList = createTestDiv();
      let elementList = new html_common.FilteredElementList(nodeList);
      elementList.insert(0, i);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](0), t1);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](1), i);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](2), d1);
      nodeList = createTestDiv();
      elementList = new html_common.FilteredElementList(nodeList);
      elementList.insert(1, i);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](2), t2);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](3), i);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](4), d2);
      nodeList = createTestDiv();
      elementList = new html_common.FilteredElementList(nodeList);
      elementList.insert(2, i);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](4), t3);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](5), i);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](6), d3);
    }, VoidTodynamic()));
    unittest$.test('FilteredElementList.insertAll test', dart.fn(() => {
      ...
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](0), t1);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](1), i1);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](2), i2);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](3), d1);
      nodeList = createTestDiv();
      elementList = new html_common.FilteredElementList(nodeList);
      elementList.insertAll(1, it);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](2), t2);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](3), i1);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](4), i2);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](5), d2);
      nodeList = createTestDiv();
      elementList = new html_common.FilteredElementList(nodeList);
      elementList.insertAll(2, it);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](4), t3);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](5), i1);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](6), i2);
      src__matcher__expect.expect(nodeList[dartx.childNodes][dartx.get](7), d3);
    }, VoidTodynamic()));
