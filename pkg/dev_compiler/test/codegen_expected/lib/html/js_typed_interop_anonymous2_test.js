dart_library.library('lib/html/js_typed_interop_anonymous2_test', null, /* Imports */[
  'dart_sdk',
  'unittest'
], function load__js_typed_interop_anonymous2_test(exports, dart_sdk, unittest) {
  'use strict';
  ...
  dart.fn(js_typed_interop_anonymous2_test.main, VoidTodynamic());
  // Exports:
