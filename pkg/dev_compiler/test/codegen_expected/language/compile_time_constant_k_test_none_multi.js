dart_library.library('language/compile_time_constant_k_test_none_multi', null, /* Imports */[
  ...
  compile_time_constant_k_test_none_multi.x = dart.const(dart.map({a: 4}, core.String, core.int));
  compile_time_constant_k_test_none_multi.z = dart.const(dart.map({__proto__: 499}, core.String, core.int));
  compile_time_constant_k_test_none_multi.x2 = dart.const(dart.map({a: 4}, core.String, core.int));
  compile_time_constant_k_test_none_multi.y2 = dart.const(dart.map({a: 14, b: 13}, core.String, core.int));
  compile_time_constant_k_test_none_multi.z2 = dart.const(dart.map({__proto__: 499}, core.String, core.int));
