dart_library.library('language/async_star_test_04_multi', null, /* Imports */[
  ...
  async_star_test_04_multi.main = function() {
  ...
  async_star_test_04_multi.id = function(x) {
    try {
  ...
  dart.fn(async_star_test_04_multi.id, dynamicTodynamic());
  async_star_test_04_multi.expectList = function(stream, list) {
  ...
  dart.fn(async_star_test_04_multi.expectList, dynamicAnddynamicTodynamic());
  async_star_test_04_multi.MS = dart.const(new core.Duration({milliseconds: 1}));
  dart.defineLazy(async_star_test_04_multi, {
    get getErrors() {
  ...
  async_star_test_04_multi.NotAStream = class NotAStream extends core.Object {
    listen(oData, opts) {
  ...
  dart.setSignature(async_star_test_04_multi.NotAStream, {
  ...
  async_star_test_04_multi.Sync = class Sync extends core.Object {
    new() {
  ...
  dart.setSignature(async_star_test_04_multi.Sync, {
    methods: () => ({
  ...
  // Exports:
  exports.async_star_test_04_multi = async_star_test_04_multi;
});
