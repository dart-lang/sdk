dart_library.library('language/instanceof4_test_01_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__instanceof4_test_01_multi(exports, dart_sdk, expect) {
  'use strict';
  ...
  const instanceof4_test_01_multi = Object.create(null);
  let JSArrayOfint = () => (JSArrayOfint = dart.constFn(_interceptors.JSArray$(core.int)))();
  let Foo = () => (Foo = dart.constFn(instanceof4_test_01_multi.Foo$()))();
  let FooOfString = () => (FooOfString = dart.constFn(instanceof4_test_01_multi.Foo$(core.String)))();
  let FooOfint = () => (FooOfint = dart.constFn(instanceof4_test_01_multi.Foo$(core.int)))();
  let VoidTodynamic = () => (VoidTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [])))();
  instanceof4_test_01_multi.Foo$ = dart.generic(T => {
  ...
  instanceof4_test_01_multi.Foo = Foo();
  instanceof4_test_01_multi.testFooString = function() {
    ...
    expect$.Expect.isTrue(!dart.test(o.isAlsoListT()));
    ...
    expect$.Expect.isTrue(!dart.test(o.isAlsoListT()), "5");
    expect$.Expect.isTrue(o.isNeitherListT(), "6");
  };
  dart.fn(instanceof4_test_01_multi.testFooString, VoidTodynamic());
  instanceof4_test_01_multi.testFooInt = function() {
    let o = new (FooOfint())();
  ...
  dart.fn(instanceof4_test_01_multi.testFooInt, VoidTodynamic());
  instanceof4_test_01_multi.main = function() {
    instanceof4_test_01_multi.testFooString();
    instanceof4_test_01_multi.testFooInt();
  };
  dart.fn(instanceof4_test_01_multi.main, VoidTodynamic());
  // Exports:
  exports.instanceof4_test_01_multi = instanceof4_test_01_multi;
});
