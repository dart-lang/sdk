dart_library.library('language/deferred_type_dependency_test_type_annotation_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__deferred_type_dependency_test_type_annotation_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const deferred_type_dependency_test_type_annotation_multi = Object.create(null);
  ...
  deferred_type_dependency_test_type_annotation_multi.main = function() {
  ...
  dart.fn(deferred_type_dependency_test_type_annotation_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.deferred_type_dependency_test_type_annotation_multi = deferred_type_dependency_test_type_annotation_multi;
