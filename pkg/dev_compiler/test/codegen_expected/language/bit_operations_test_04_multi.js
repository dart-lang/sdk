dart_library.library('language/bit_operations_test_04_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__bit_operations_test_04_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const bit_operations_test_04_multi = Object.create(null);
  ...
  bit_operations_test_04_multi.main = function() {
    for (let i = 0; i < 4; i++) {
      bit_operations_test_04_multi.test();
    }
  };
  dart.fn(bit_operations_test_04_multi.main, VoidTovoid());
  bit_operations_test_04_multi.test = function() {
    ...
    bit_operations_test_04_multi.testNegativeValueShifts();
    bit_operations_test_04_multi.testPositiveValueShifts();
    bit_operations_test_04_multi.testNoMaskingOfShiftCount();
    bit_operations_test_04_multi.testNegativeCountShifts();
    for (let i = 0; i < 20; i++) {
      bit_operations_test_04_multi.testCornerCasesRightShifts();
      bit_operations_test_04_multi.testRightShift64Bit();
      bit_operations_test_04_multi.testLeftShift64Bit();
      bit_operations_test_04_multi.testLeftShift64BitWithOverflow1();
      bit_operations_test_04_multi.testLeftShift64BitWithOverflow2();
      bit_operations_test_04_multi.testLeftShift64BitWithOverflow3();
    }
    bit_operations_test_04_multi.testPrecedence(4, 5, 3, 1);
    bit_operations_test_04_multi.testPrecedence(3, 4, 5, 9);
    bit_operations_test_04_multi.testPrecedence(23665, 27538, 30292, 32040);
  };
  dart.fn(bit_operations_test_04_multi.test, VoidTovoid());
  bit_operations_test_04_multi.testCornerCasesRightShifts = function() {
    let v32 = 4278190080;
  ...
  dart.fn(bit_operations_test_04_multi.testCornerCasesRightShifts, VoidTovoid());
  bit_operations_test_04_multi.testRightShift64Bit = function() {
    let t = 8589934591;
    expect$.Expect.equals(4294967295, t[dartx['>>']](1));
  };
  dart.fn(bit_operations_test_04_multi.testRightShift64Bit, VoidTovoid());
  bit_operations_test_04_multi.testLeftShift64Bit = function() {
    let t = 4294967295;
  ...
  dart.fn(bit_operations_test_04_multi.testLeftShift64Bit, VoidTovoid());
  bit_operations_test_04_multi.testLeftShift64BitWithOverflow1 = function() {
    let t = 4294967295;
  };
  dart.fn(bit_operations_test_04_multi.testLeftShift64BitWithOverflow1, VoidTovoid());
  bit_operations_test_04_multi.testLeftShift64BitWithOverflow2 = function() {
    let t = 4294967295;
    expect$.Expect.equals(36893488147419103232, 4 * (t + 1) << 31 >>> 0);
  };
  dart.fn(bit_operations_test_04_multi.testLeftShift64BitWithOverflow2, VoidTovoid());
  bit_operations_test_04_multi.testLeftShift64BitWithOverflow3 = function() {
    let t = 4294967295;
    expect$.Expect.equals(9223372036854775808, t + 1 << 31 >>> 0);
  };
  dart.fn(bit_operations_test_04_multi.testLeftShift64BitWithOverflow3, VoidTovoid());
  bit_operations_test_04_multi.testNegativeCountShifts = function() {
  ...
  dart.fn(bit_operations_test_04_multi.testNegativeCountShifts, VoidTovoid());
  bit_operations_test_04_multi.testNegativeValueShifts = function() {
  ...
  dart.fn(bit_operations_test_04_multi.testNegativeValueShifts, VoidTovoid());
  bit_operations_test_04_multi.testPositiveValueShifts = function() {
    for (let value = 0; value < 100; value++) {
      for (let i = 0; i < 300; i++) {
        let b = value[dartx['<<']](i)[dartx['>>']](i);
        expect$.Expect.equals(value, b);
  ...
  dart.fn(bit_operations_test_04_multi.testPositiveValueShifts, VoidTovoid());
  bit_operations_test_04_multi.testNoMaskingOfShiftCount = function() {
    expect$.Expect.equals(0, (0)[dartx['>>']](256));
    expect$.Expect.equals(0, (1)[dartx['>>']](256));
    expect$.Expect.equals(0, (2)[dartx['>>']](256));
    expect$.Expect.equals(0, bit_operations_test_04_multi.shiftRight(0, 256));
    expect$.Expect.equals(0, bit_operations_test_04_multi.shiftRight(1, 256));
    expect$.Expect.equals(0, bit_operations_test_04_multi.shiftRight(2, 256));
    for (let shift = 1; shift <= 256; shift++) {
      expect$.Expect.equals(0, bit_operations_test_04_multi.shiftRight(1, shift));
      expect$.Expect.equals(-1, bit_operations_test_04_multi.shiftRight(-1, shift));
      expect$.Expect.equals(true, dart.notNull(bit_operations_test_04_multi.shiftLeft(1, shift)) > dart.notNull(bit_operations_test_04_multi.shiftLeft(1, shift - 1)));
    }
  };
  dart.fn(bit_operations_test_04_multi.testNoMaskingOfShiftCount, VoidTovoid());
  bit_operations_test_04_multi.shiftLeft = function(a, b) {
    return a[dartx['<<']](b);
  };
  dart.fn(bit_operations_test_04_multi.shiftLeft, intAndintToint());
  bit_operations_test_04_multi.shiftRight = function(a, b) {
    return a[dartx['>>']](b);
  };
  dart.fn(bit_operations_test_04_multi.shiftRight, intAndintToint());
  bit_operations_test_04_multi.testPrecedence = function(a, b, c, d) {
  ...
  dart.fn(bit_operations_test_04_multi.testPrecedence, intAndintAndint__Tovoid());
  // Exports:
  exports.bit_operations_test_04_multi = bit_operations_test_04_multi;
});
