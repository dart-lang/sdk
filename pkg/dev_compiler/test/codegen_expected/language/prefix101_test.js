dart_library.library('language/prefix101_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__prefix101_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const prefix101_test = Object.create(null);
  ...
  prefix101_test.Prefix101Test = class Prefix101Test extends core.Object {
    static Test1() {
      let result = 0;
  ...
  dart.setSignature(prefix101_test.Prefix101Test, {
    statics: () => ({
  ...
  prefix101_test.main = function() {
    prefix101_test.Prefix101Test.Test1();
    prefix101_test.Prefix101Test.Test2();
    prefix101_test.Prefix101Test.Test3();
    prefix101_test.Prefix101Test.Test4();
  };
  dart.fn(prefix101_test.main, VoidTodynamic());
  ...
  // Exports:
  exports.prefix101_test = prefix101_test;
