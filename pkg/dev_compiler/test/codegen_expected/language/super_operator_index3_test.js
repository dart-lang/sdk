dart_library.library('language/super_operator_index3_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__super_operator_index3_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const super_operator_index3_test = Object.create(null);
  let VoidTodynamic = () => (VoidTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [])))();
  super_operator_index3_test.A = class A extends core.Object {
    new() {
  ...
  dart.setSignature(super_operator_index3_test.A, {
    methods: () => ({set: dart.definiteFunctionType(dart.dynamic, [dart.dynamic, dart.dynamic])})
  });
  super_operator_index3_test.B = class B extends super_operator_index3_test.A {
    new() {
      super.new();
    }
    get(index) {
  ...
  dart.setSignature(super_operator_index3_test.B, {
    methods: () => ({get: dart.definiteFunctionType(dart.dynamic, [dart.dynamic])})
  });
  super_operator_index3_test.C = class C extends super_operator_index3_test.B {
    test() {
  ...
  dart.setSignature(super_operator_index3_test.C, {
    methods: () => ({test: dart.definiteFunctionType(dart.dynamic, [])})
  });
  super_operator_index3_test.main = function() {
    new super_operator_index3_test.C().test();
  };
  dart.fn(super_operator_index3_test.main, VoidTodynamic());
  // Exports:
  exports.super_operator_index3_test = super_operator_index3_test;
});
