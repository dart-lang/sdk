dart_library.library('language/deferred_constraints_type_annotation_test_new_generic1_multi', null, /* Imports */[
  'dart_sdk',
  'async_helper'
], function load__deferred_constraints_type_annotation_test_new_generic1_multi(exports, dart_sdk, async_helper) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const async_helper$ = async_helper.async_helper;
  const deferred_constraints_type_annotation_test_new_generic1_multi = Object.create(null);
  const deferred_constraints_lib = Object.create(null);
  let G2 = () => (G2 = dart.constFn(deferred_constraints_type_annotation_test_new_generic1_multi.G2$()))();
  let GOfF = () => (GOfF = dart.constFn(deferred_constraints_lib.G$(deferred_constraints_type_annotation_test_new_generic1_multi.F)))();
  let G = () => (G = dart.constFn(deferred_constraints_lib.G$()))();
  let dynamicTodynamic = () => (dynamicTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [dart.dynamic])))();
  let VoidTodynamic = () => (VoidTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [])))();
  deferred_constraints_type_annotation_test_new_generic1_multi.F = class F extends core.Object {};
  deferred_constraints_type_annotation_test_new_generic1_multi.G2$ = dart.generic(T => {
    class G2 extends core.Object {}
    dart.addTypeTests(G2);
    return G2;
  });
  deferred_constraints_type_annotation_test_new_generic1_multi.G2 = G2();
  deferred_constraints_type_annotation_test_new_generic1_multi.main = function() {
  ...
  dart.fn(deferred_constraints_type_annotation_test_new_generic1_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.deferred_constraints_type_annotation_test_new_generic1_multi = deferred_constraints_type_annotation_test_new_generic1_multi;
