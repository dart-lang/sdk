dart_library.library('language/regress_21998_3_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__regress_21998_3_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const regress_21998_3_test = Object.create(null);
  ...
  regress_21998_3_test.main = function() {
    expect$.Expect.equals(4, new regress_21998_3_test.C().m());
  };
  dart.fn(regress_21998_3_test.main, VoidTodynamic());
  regress_21998_3_test.C = class C extends core.Object {
    max(a) {
      return a;
    }
    m() {
      return this.max(math.max(core.num)(core.num._check(regress_21998_lib2.lib2_max(1, 2)), regress_21998_lib1.max('a', 'b', 'cd')[dartx.length]));
    }
  };
  dart.setSignature(regress_21998_3_test.C, {
    methods: () => ({
  ...
  // Exports:
  exports.regress_21998_3_test = regress_21998_3_test;
