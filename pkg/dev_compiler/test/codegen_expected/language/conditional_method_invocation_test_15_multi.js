dart_library.library('language/conditional_method_invocation_test_15_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__conditional_method_invocation_test_15_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const conditional_method_invocation_test_15_multi = Object.create(null);
  const conditional_access_helper = Object.create(null);
  let VoidTodynamic = () => (VoidTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [])))();
  let dynamicTodynamic = () => (dynamicTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [dart.dynamic])))();
  let VoidToC = () => (VoidToC = dart.constFn(dart.definiteFunctionType(conditional_method_invocation_test_15_multi.C, [])))();
  let VoidToint = () => (VoidToint = dart.constFn(dart.definiteFunctionType(core.int, [])))();
  let VoidTovoid = () => (VoidTovoid = dart.constFn(dart.definiteFunctionType(dart.void, [])))();
  let VoidToC$ = () => (VoidToC$ = dart.constFn(dart.definiteFunctionType(conditional_access_helper.C, [])))();
  conditional_method_invocation_test_15_multi.bad = function() {
    expect$.Expect.fail('Should not be executed');
  };
  dart.fn(conditional_method_invocation_test_15_multi.bad, VoidTodynamic());
  conditional_method_invocation_test_15_multi.noMethod = function(e) {
    return core.NoSuchMethodError.is(e);
  };
  dart.fn(conditional_method_invocation_test_15_multi.noMethod, dynamicTodynamic());
  conditional_method_invocation_test_15_multi.B = class B extends core.Object {};
  conditional_method_invocation_test_15_multi.C = class C extends conditional_method_invocation_test_15_multi.B {
    f(callback) {
      return callback();
    }
    g(callback) {
  ...
  dart.setSignature(conditional_method_invocation_test_15_multi.C, {
    methods: () => ({
  ...
  conditional_method_invocation_test_15_multi.nullC = function() {
    return null;
  };
  dart.fn(conditional_method_invocation_test_15_multi.nullC, VoidToC());
  conditional_method_invocation_test_15_multi.main = function() {
    dart.nullSafe(conditional_method_invocation_test_15_multi.nullC(), _ => _.f(null));
    expect$.Expect.equals(1, conditional_access_helper.C.staticF(dart.fn(() => 1, VoidToint())));
  };
  dart.fn(conditional_method_invocation_test_15_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.conditional_method_invocation_test_15_multi = conditional_method_invocation_test_15_multi;
