dart_library.library('language/compile_time_constant10_test_none_multi', null, /* Imports */[
  ...
  compile_time_constant10_test_none_multi.m1 = dart.const(dart.map({x: 1}, core.String, core.int));
  compile_time_constant10_test_none_multi.m2 = dart.const(dart.map({x: 2}, core.String, core.int));
