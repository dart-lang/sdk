dart_library.library('language/multiline_newline_test_06_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__multiline_newline_test_06_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const multiline_newline_test_06_multi = Object.create(null);
  ...
  multiline_newline_test_06_multi.main = function() {
    ...
    let c12 = dart.test(c9) ? 3 : 4;
  };
  dart.fn(multiline_newline_test_06_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.multiline_newline_test_06_multi = multiline_newline_test_06_multi;
