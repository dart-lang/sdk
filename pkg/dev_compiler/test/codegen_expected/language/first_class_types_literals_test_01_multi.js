dart_library.library('language/first_class_types_literals_test_01_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__first_class_types_literals_test_01_multi(exports, dart_sdk, expect) {
  'use strict';
  ...
  const first_class_types_literals_test_01_multi = Object.create(null);
  let C = () => (C = dart.constFn(first_class_types_literals_test_01_multi.C$()))();
  ...
  first_class_types_literals_test_01_multi.C$ = dart.generic((T, U, V) => {
    class C extends core.Object {}
    dart.addTypeTests(C);
    return C;
  });
  first_class_types_literals_test_01_multi.C = C();
  first_class_types_literals_test_01_multi.D = class D extends core.Object {};
  first_class_types_literals_test_01_multi.Foo = dart.typedef('Foo', () => dart.functionType(core.int, [core.bool]));
  first_class_types_literals_test_01_multi.sameType = function(a, b) {
    expect$.Expect.equals(dart.runtimeType(a), dart.runtimeType(b));
  };
  dart.fn(first_class_types_literals_test_01_multi.sameType, dynamicAnddynamicTodynamic());
  first_class_types_literals_test_01_multi.main = function() {
    function foo(a) {
    }
    ...
    expect$.Expect.isTrue(core.Type.is(dart.wrapType(first_class_types_literals_test_01_multi.D).runtimeType));
    ...
    expect$.Expect.equals(dart.wrapType(first_class_types_literals_test_01_multi.C), new first_class_types_literals_test_01_multi.C().runtimeType);
    expect$.Expect.equals(dart.wrapType(first_class_types_literals_test_01_multi.D).runtimeType, dart.runtimeType(dart.wrapType(first_class_types_literals_test_01_multi.D).runtimeType));
    expect$.Expect.equals(dart.toString(dart.wrapType(dart.dynamic)), 'dynamic');
  };
  dart.fn(first_class_types_literals_test_01_multi.main, VoidTodynamic());
  // Exports:
  exports.first_class_types_literals_test_01_multi = first_class_types_literals_test_01_multi;
});
