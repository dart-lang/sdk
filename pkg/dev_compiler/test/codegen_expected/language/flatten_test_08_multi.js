dart_library.library('language/flatten_test_08_multi', null, /* Imports */[
  'dart_sdk'
], function load__flatten_test_08_multi(exports, dart_sdk) {
  'use strict';
  const core = dart_sdk.core;
  const async = dart_sdk.async;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const flatten_test_08_multi = Object.create(null);
  let Derived = () => (Derived = dart.constFn(flatten_test_08_multi.Derived$()))();
  let FixedPoint = () => (FixedPoint = dart.constFn(flatten_test_08_multi.FixedPoint$()))();
  let VoidTodynamic = () => (VoidTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [])))();
  flatten_test_08_multi.Derived$ = dart.generic(T => {
  ...
  flatten_test_08_multi.Derived = Derived();
  flatten_test_08_multi.FixedPoint$ = dart.generic(T => {
    let FixedPointOfT = () => (FixedPointOfT = dart.constFn(flatten_test_08_multi.FixedPoint$(T)))();
  ...
  flatten_test_08_multi.FixedPoint = FixedPoint();
  flatten_test_08_multi.test = function() {
    return dart.async(function*() {
    }, dart.dynamic);
  };
  dart.fn(flatten_test_08_multi.test, VoidTodynamic());
  flatten_test_08_multi.main = function() {
    flatten_test_08_multi.test();
  };
  dart.fn(flatten_test_08_multi.main, VoidTodynamic());
  // Exports:
  exports.flatten_test_08_multi = flatten_test_08_multi;
});
