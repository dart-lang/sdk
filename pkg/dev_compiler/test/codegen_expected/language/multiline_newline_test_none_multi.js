dart_library.library('language/multiline_newline_test_none_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__multiline_newline_test_none_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const multiline_newline_test_none_multi = Object.create(null);
  ...
  multiline_newline_test_none_multi.main = function() {
  ...
  dart.fn(multiline_newline_test_none_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.multiline_newline_test_none_multi = multiline_newline_test_none_multi;
