dart_library.library('language/multiline_newline_test_05_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__multiline_newline_test_05_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const multiline_newline_test_05_multi = Object.create(null);
  ...
  multiline_newline_test_05_multi.main = function() {
    ...
    let c11 = dart.test(c8) ? 2 : 3;
  };
  dart.fn(multiline_newline_test_05_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.multiline_newline_test_05_multi = multiline_newline_test_05_multi;
