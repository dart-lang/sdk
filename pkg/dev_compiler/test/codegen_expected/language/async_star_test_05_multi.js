dart_library.library('language/async_star_test_05_multi', null, /* Imports */[
  'dart_sdk',
  'unittest'
], function load__async_star_test_05_multi(exports, dart_sdk, unittest) {
  'use strict';
  ...
  const async_star_test_05_multi = Object.create(null);
  ...
  async_star_test_05_multi.main = function() {
    unittest$.group("basic", dart.fn(() => {
      ...
      unittest$.test("multiple", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), core.List.generate(10, async_star_test_05_multi.id));
      }, VoidTodynamic()));
      unittest$.test("allows await", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([42]));
      }, VoidTodynamic()));
      ...
      unittest$.test("allows yield*", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([1, 2, 3]));
      }, VoidTodynamic()));
      unittest$.test("allows yield* of async*", dart.fn(() => {
        ...
        return async_star_test_05_multi.expectList(f(3), JSArrayOfint().of([3, 2, 1, 0, 1, 2, 3]));
      }, VoidTodynamic()));
      unittest$.test("Cannot yield* non-stream", dart.fn(() => {
        ...
        dart.fn(f, dynamicTodynamic());
        return dart.dsend(dart.dload(dart.dsend(f(42), 'transform', async_star_test_05_multi.getErrors), 'single'), 'then', dart.fn(v => {
      ...
      unittest$.test("Cannot yield* non-stream", dart.fn(() => {
        ...
        dart.fn(f, dynamicTodynamic());
        return dart.dsend(dart.dload(dart.dsend(f(new async_star_test_05_multi.NotAStream()), 'transform', async_star_test_05_multi.getErrors), 'single'), 'then', dart.fn(v => {
          src__matcher__expect.expect(core.Error.is(v), src__matcher__core_matchers.isTrue);
        }, dynamicTodynamic()));
      }, VoidTodynamic()));
    }, VoidTovoid()));
    unittest$.group("yield statement context", dart.fn(() => {
      unittest$.test("plain", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([0]));
      }, VoidTodynamic()));
      unittest$.test("if-then-else", dart.fn(() => {
        ...
        dart.fn(f, dynamicTodynamic());
        return dart.dsend(async_star_test_05_multi.expectList(f(true), JSArrayOfint().of([0])), 'whenComplete', dart.fn(() => {
          async_star_test_05_multi.expectList(f(false), JSArrayOfint().of([1]));
        }, VoidTodynamic()));
      }, VoidTodynamic()));
      unittest$.test("block", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([0, 1, 2]));
      }, VoidTodynamic()));
      ...
      unittest$.test("try-catch-finally", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([0, 2]));
      }, VoidTodynamic()));
      unittest$.test("try-catch-finally 2", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([1, 2]));
      }, VoidTodynamic()));
      unittest$.test("dead-code return", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), []);
      }, VoidTodynamic()));
    ...
    unittest$.group("loops", dart.fn(() => {
      ...
      unittest$.test("yield in double loop", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(f(), JSArrayOfint().of([0, 1, 2, 3, 4, 5]));
      }, VoidTodynamic()));
      unittest$.test("yield in try body", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return dart.dsend(async_star_test_05_multi.expectList(f(), JSArrayOfint().of([0, 1, 2])), 'whenComplete', dart.fn(() => {
      ...
      unittest$.test("keep yielding after cancel", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 3), JSArrayOfint().of([0, 1, 2]));
      }, VoidTodynamic()));
    }, VoidTovoid()));
    unittest$.group("canceling", dart.fn(() => {
      ...
      unittest$.test("does cancel eventually", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        return dart.dsend(dart.dsend(async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 5), JSArrayOfint().of([0, 1, 2, 3, 4])), 'then', dart.fn(_ => exits.future, dynamicToFuture())), 'then', dart.fn(v => {
      ...
      unittest$.group("at index", dart.fn(() => {
        ...
        dart.fn(f, VoidTodynamic());
        unittest$.test("- all, sanity check", dart.fn(() => async_star_test_05_multi.expectList(f(), JSArrayOfint().of([1, 2, 3])), VoidTodynamic()));
        unittest$.test("after end", dart.fn(() => async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 4), JSArrayOfint().of([1, 2, 3])), VoidTodynamic()));
        unittest$.test("at end", dart.fn(() => async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 3), JSArrayOfint().of([1, 2, 3])), VoidTodynamic()));
        unittest$.test("before end", dart.fn(() => async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 2), JSArrayOfint().of([1, 2])), VoidTodynamic()));
        unittest$.test("early", dart.fn(() => async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 1), JSArrayOfint().of([1])), VoidTodynamic()));
        unittest$.test("at start", dart.fn(() => async_star_test_05_multi.expectList(dart.dsend(f(), 'take', 0), []), VoidTodynamic()));
      }, VoidTovoid()));
    }, VoidTovoid()));
      ...
      unittest$.test("pause stops execution at yield", dart.fn(() => {
        ...
        sub = dart.dsend(f(), 'listen', dart.fn(v => {
          if (dart.equals(v, 2)) {
            ...
            async.Timer.new(async_star_test_05_multi.MS['*'](300), dart.fn(() => {
      ...
      unittest$.test("pause stops execution at yield 2", dart.fn(() => {
        ...
        sub = dart.dsend(f(), 'listen', dart.fn(v => {
          ...
          if (dart.equals(dart.dsend(v, '%', 5), 0)) {
            dart.dsend(sub, 'pause', async.Future.delayed(async_star_test_05_multi.MS['*'](300)));
    ...
    unittest$.group("await for", dart.fn(() => {
      ...
      unittest$.test("simple stream reyield", dart.fn(() => {
        ...
        dart.fn(f, dynamicTodynamic());
        return async_star_test_05_multi.expectList(f(mkStream(5)), JSArrayOfint().of([0, 1, 3, 6, 10]));
      }, VoidTodynamic()));
        ...
        function f(s) {
          return dart.async(function*(s) {
            ...
            try {
              while (yield it.moveNext()) {
                let i = it.current;
                r = dart.notNull(r) + dart.notNull(core.int._check(yield async.Future.delayed(async_star_test_05_multi.MS['*'](10), dart.fn(() => i, VoidTodynamic()))));
              }
            } finally {
              yield it.cancel();
            }
  ...
  dart.fn(async_star_test_05_multi.main, VoidTodynamic());
  async_star_test_05_multi.id = function(x) {
    try {
  ...
  dart.fn(async_star_test_05_multi.id, dynamicTodynamic());
  async_star_test_05_multi.expectList = function(stream, list) {
  ...
  dart.fn(async_star_test_05_multi.expectList, dynamicAnddynamicTodynamic());
  async_star_test_05_multi.MS = dart.const(new core.Duration({milliseconds: 1}));
  dart.defineLazy(async_star_test_05_multi, {
    get getErrors() {
  ...
  async_star_test_05_multi.NotAStream = class NotAStream extends core.Object {
    listen(oData, opts) {
  ...
  dart.setSignature(async_star_test_05_multi.NotAStream, {
  ...
  async_star_test_05_multi.Sync = class Sync extends core.Object {
    new() {
  ...
  dart.setSignature(async_star_test_05_multi.Sync, {
    methods: () => ({
  ...
  // Exports:
  exports.async_star_test_05_multi = async_star_test_05_multi;
});
