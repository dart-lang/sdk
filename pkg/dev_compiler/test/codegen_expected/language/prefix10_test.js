dart_library.library('language/prefix10_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__prefix10_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const prefix10_test = Object.create(null);
  ...
  prefix10_test.Prefix10Test = class Prefix10Test extends core.Object {
    static Test1() {
      let result = 0;
  ...
  dart.setSignature(prefix10_test.Prefix10Test, {
    statics: () => ({
  ...
  prefix10_test.main = function() {
    prefix10_test.Prefix10Test.Test1();
    prefix10_test.Prefix10Test.Test2();
    prefix10_test.Prefix10Test.Test3();
    prefix10_test.Prefix10Test.Test4();
  };
  dart.fn(prefix10_test.main, VoidTodynamic());
  ...
  // Exports:
  exports.prefix10_test = prefix10_test;
