dart_library.library('language/conditional_property_access_test_13_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__conditional_property_access_test_13_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const conditional_property_access_test_13_multi = Object.create(null);
  const conditional_access_helper = Object.create(null);
  let dynamicTodynamic = () => (dynamicTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [dart.dynamic])))();
  let VoidToC = () => (VoidToC = dart.constFn(dart.definiteFunctionType(conditional_property_access_test_13_multi.C, [])))();
  let VoidTodynamic = () => (VoidTodynamic = dart.constFn(dart.definiteFunctionType(dart.dynamic, [])))();
  let VoidTovoid = () => (VoidTovoid = dart.constFn(dart.definiteFunctionType(dart.void, [])))();
  let VoidToC$ = () => (VoidToC$ = dart.constFn(dart.definiteFunctionType(conditional_access_helper.C, [])))();
  conditional_property_access_test_13_multi.noMethod = function(e) {
    return core.NoSuchMethodError.is(e);
  };
  dart.fn(conditional_property_access_test_13_multi.noMethod, dynamicTodynamic());
  conditional_property_access_test_13_multi.B = class B extends core.Object {};
  conditional_property_access_test_13_multi.C = class C extends conditional_property_access_test_13_multi.B {
    new(v) {
      this.v = v;
    }
  };
  dart.setSignature(conditional_property_access_test_13_multi.C, {
    constructors: () => ({new: dart.definiteFunctionType(conditional_property_access_test_13_multi.C, [core.int])})
  });
  conditional_property_access_test_13_multi.C.staticInt = null;
  conditional_property_access_test_13_multi.nullC = function() {
    return null;
  };
  dart.fn(conditional_property_access_test_13_multi.nullC, VoidToC());
  conditional_property_access_test_13_multi.main = function() {
    dart.nullSafe(conditional_property_access_test_13_multi.nullC(), _ => _.v);
    {
      conditional_access_helper.C.staticInt = 1;
      expect$.Expect.equals(1, conditional_access_helper.C.staticInt);
    }
  };
  dart.fn(conditional_property_access_test_13_multi.main, VoidTodynamic());
  ...
  // Exports:
  exports.conditional_property_access_test_13_multi = conditional_property_access_test_13_multi;
