dart_library.library('corelib/integer_to_string_test_none_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__integer_to_string_test_none_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const integer_to_string_test_none_multi = Object.create(null);
  ...
  integer_to_string_test_none_multi.main = function() {
  ...
  dart.fn(integer_to_string_test_none_multi.main, VoidTodynamic());
  // Exports:
  exports.integer_to_string_test_none_multi = integer_to_string_test_none_multi;
});
