dart_library.library('corelib/int_modulo_arith_test_modPow_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__int_modulo_arith_test_modPow_multi(exports, dart_sdk, expect) {
  'use strict';
  ...
  const int_modulo_arith_test_modPow_multi = Object.create(null);
  ...
  int_modulo_arith_test_modPow_multi.smallNumber = 1234567890;
  int_modulo_arith_test_modPow_multi.mediumNumber = 1234567890123456;
  int_modulo_arith_test_modPow_multi.bigNumber = 590295810358705600000;
  int_modulo_arith_test_modPow_multi.testModPow = function() {
  ...
  dart.fn(int_modulo_arith_test_modPow_multi.testModPow, VoidTodynamic());
  int_modulo_arith_test_modPow_multi.testModInverse = function() {
    ...
    test(12345, 12346, 12345);
    test(int_modulo_arith_test_modPow_multi.smallNumber, 137, 42);
    test(137, int_modulo_arith_test_modPow_multi.smallNumber, 856087223);
    test(int_modulo_arith_test_modPow_multi.mediumNumber, 137, 77);
    test(137, int_modulo_arith_test_modPow_multi.mediumNumber, 540686667207353);
  };
  dart.fn(int_modulo_arith_test_modPow_multi.testModInverse, VoidTodynamic());
  int_modulo_arith_test_modPow_multi.testGcd = function() {
  ...
  dart.fn(int_modulo_arith_test_modPow_multi.testGcd, VoidTodynamic());
  int_modulo_arith_test_modPow_multi.main = function() {
    int_modulo_arith_test_modPow_multi.testModPow();
    int_modulo_arith_test_modPow_multi.testModInverse();
    int_modulo_arith_test_modPow_multi.testGcd();
  };
  dart.fn(int_modulo_arith_test_modPow_multi.main, VoidTodynamic());
  // Exports:
  exports.int_modulo_arith_test_modPow_multi = int_modulo_arith_test_modPow_multi;
});
