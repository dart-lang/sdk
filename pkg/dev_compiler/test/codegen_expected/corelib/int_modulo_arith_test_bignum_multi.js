dart_library.library('corelib/int_modulo_arith_test_bignum_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__int_modulo_arith_test_bignum_multi(exports, dart_sdk, expect) {
  'use strict';
  ...
  int_modulo_arith_test_bignum_multi.mediumNumber = 1234567890123456;
  int_modulo_arith_test_bignum_multi.bigNumber = 590295810358705600000;
  int_modulo_arith_test_bignum_multi.testModPow = function() {
  ...
  dart.fn(int_modulo_arith_test_bignum_multi.testModPow, VoidTodynamic());
  int_modulo_arith_test_bignum_multi.testModInverse = function() {
    ...
    test(12345, 12346, 12345);
    test(int_modulo_arith_test_bignum_multi.smallNumber, 137, 42);
    test(137, int_modulo_arith_test_bignum_multi.smallNumber, 856087223);
    test(int_modulo_arith_test_bignum_multi.mediumNumber, 137, 77);
    test(137, int_modulo_arith_test_bignum_multi.mediumNumber, 540686667207353);
    test(int_modulo_arith_test_bignum_multi.bigNumber, 137, 128);
  };
  dart.fn(int_modulo_arith_test_bignum_multi.testModInverse, VoidTodynamic());
  int_modulo_arith_test_bignum_multi.testGcd = function() {
  ...
  dart.fn(int_modulo_arith_test_bignum_multi.testGcd, VoidTodynamic());
  int_modulo_arith_test_bignum_multi.main = function() {
    int_modulo_arith_test_bignum_multi.testModInverse();
    int_modulo_arith_test_bignum_multi.testGcd();
  };
  dart.fn(int_modulo_arith_test_bignum_multi.main, VoidTodynamic());
  // Exports:
  exports.int_modulo_arith_test_bignum_multi = int_modulo_arith_test_bignum_multi;
});
