dart_library.library('corelib/regexp/norepeat_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__norepeat_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const norepeat_test = Object.create(null);
  ...
  norepeat_test.main = function() {
    v8_regexp_utils.description('Test for https://bugs.webkit.org/show_bug.cgi?id=46077');
    let re = core.RegExp.new("^b|^cd");
    let str = "abcd";
    v8_regexp_utils.shouldBeFalse(re.hasMatch(str));
  };
  dart.fn(norepeat_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.norepeat_test = norepeat_test;
