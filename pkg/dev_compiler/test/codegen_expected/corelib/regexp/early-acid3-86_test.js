dart_library.library('corelib/regexp/early-acid3-86_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__early$45acid3$4586_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const early$45acid3$4586_test = Object.create(null);
  ...
  early$45acid3$4586_test.main = function() {
    v8_regexp_utils.description('Test that covers capturing brackets, and was adapted from a part of an early version of Acid3.');
    v8_regexp_utils.assertThrows(dart.fn(() => core.RegExp.new("TA[])]").firstMatch('TA]'), VoidToMatch()));
    v8_regexp_utils.shouldBeNull(core.RegExp.new("[]").firstMatch(''));
    v8_regexp_utils.shouldBe(core.RegExp.new("(\\3)(\\1)(a)").firstMatch('cat'), JSArrayOfString().of(['a', '', '', 'a']));
  };
  dart.fn(early$45acid3$4586_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.early$45acid3$4586_test = early$45acid3$4586_test;
