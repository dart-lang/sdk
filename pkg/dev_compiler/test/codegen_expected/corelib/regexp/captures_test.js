dart_library.library('corelib/regexp/captures_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__captures_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const captures_test = Object.create(null);
  ...
  captures_test.main = function() {
    let re = core.RegExp.new("^(((N({)?)|(R)|(U)|(V)|(B)|(H)|(n((n)|(r)|(v)|(h))?)|(r(r)?)|(v)|(b((n)|(b))?)|(h))|((Y)|(A)|(E)|(o(u)?)|(p(u)?)|(q(u)?)|(s)|(t)|(u)|(w)|(x(u)?)|(y)|(z)|(a((T)|(A)|(L))?)|(c)|(e)|(f(u)?)|(g(u)?)|(i)|(j)|(l)|(m(u)?)))+");
    let str = "Avtnennan gunzvmu pubExnY nEvln vaTxh rmuhguhaTxnY";
    v8_regexp_utils.assertTrue(re.hasMatch(str));
  };
  dart.fn(captures_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.captures_test = captures_test;
