dart_library.library('corelib/regexp/non-capturing-backtracking_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__non$45capturing$45backtracking_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const non$45capturing$45backtracking_test = Object.create(null);
  ...
  non$45capturing$45backtracking_test.main = function() {
    v8_regexp_utils.description("This page tests for proper backtracking with greedy quantifiers and non-capturing parentheses.");
    let re = core.RegExp.new("(?:a*)a");
    v8_regexp_utils.shouldBe(re.firstMatch('a'), JSArrayOfString().of(['a']));
  };
  dart.fn(non$45capturing$45backtracking_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.non$45capturing$45backtracking_test = non$45capturing$45backtracking_test;
