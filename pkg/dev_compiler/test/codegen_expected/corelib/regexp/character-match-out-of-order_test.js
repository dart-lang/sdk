dart_library.library('corelib/regexp/character-match-out-of-order_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__character$45match$45out$45of$45order_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const character$45match$45out$45of$45order_test = Object.create(null);
  ...
  character$45match$45out$45of$45order_test.main = function() {
    v8_regexp_utils.description('Test to ensure RegExp generates single character matches in the correct order');
    v8_regexp_utils.shouldBe(core.RegExp.new("[\\w']+").firstMatch("'_'"), JSArrayOfString().of(["'_'"]));
  };
  dart.fn(character$45match$45out$45of$45order_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.character$45match$45out$45of$45order_test = character$45match$45out$45of$45order_test;
