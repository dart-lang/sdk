dart_library.library('corelib/regexp/loop-capture_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__loop$45capture_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const loop$45capture_test = Object.create(null);
  ...
  loop$45capture_test.main = function() {
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:(a)|(b)|(c))+").firstMatch("abc"), JSArrayOfString().of(["abc", null, null, "c"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:(a)|b)*").firstMatch("ab"), JSArrayOfString().of(["ab", null]));
  };
  dart.fn(loop$45capture_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.loop$45capture_test = loop$45capture_test;
