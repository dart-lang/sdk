dart_library.library('corelib/regexp/non-character_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__non$45character_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const non$45character_test = Object.create(null);
  ...
  non$45character_test.main = function() {
    v8_regexp_utils.description('Test for regular expressions with non-character values in them, specifically in character classes.');
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("F", core.RegExp.new("[\\uD7FF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("0", core.RegExp.new("[\\uD800]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("F", core.RegExp.new("[\\uDFFF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("E", core.RegExp.new("[\\uE000]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFDBF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFDD0]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFDEF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFDF0]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFEFF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFEFF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFFFE]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\uFFFF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\u10FFFF]")));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch("y", core.RegExp.new("[\\u110000]")));
  };
  dart.fn(non$45character_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.non$45character_test = non$45character_test;
