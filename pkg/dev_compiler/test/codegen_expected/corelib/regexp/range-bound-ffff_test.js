dart_library.library('corelib/regexp/range-bound-ffff_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__range$45bound$45ffff_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const range$45bound$45ffff_test = Object.create(null);
  ...
  range$45bound$45ffff_test.main = function() {
    v8_regexp_utils.description('Test for rdar:/68455379, a case-insensitive regex containing a character class containing a range with an upper bound of ￿ can lead to an infinite-loop.');
    v8_regexp_utils.shouldBe(v8_regexp_utils.firstMatch("A", core.RegExp.new("[\\u0001-\\uFFFF]", {caseSensitive: false})), JSArrayOfString().of(["A"]));
  };
  dart.fn(range$45bound$45ffff_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.range$45bound$45ffff_test = range$45bound$45ffff_test;
