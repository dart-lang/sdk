dart_library.library('corelib/regexp/range-out-of-order_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__range$45out$45of$45order_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const range$45out$45of$45order_test = Object.create(null);
  ...
  range$45out$45of$45order_test.main = function() {
    v8_regexp_utils.description('Test for <a href="http://bugs.webkit.org/show_bug.cgi?id=16129">bug 16129</a>: REGRESSION (r27761-r27811): malloc error while visiting http://mysit.es (crashes release build).');
    v8_regexp_utils.assertThrows(dart.fn(() => core.RegExp.new("^[\\s{-.\\[\\]\\(\\)]$"), VoidToRegExp()));
  };
  dart.fn(range$45out$45of$45order_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.range$45out$45of$45order_test = range$45out$45of$45order_test;
