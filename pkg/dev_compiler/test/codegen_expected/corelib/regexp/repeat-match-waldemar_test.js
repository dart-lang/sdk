dart_library.library('corelib/regexp/repeat-match-waldemar_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__repeat$45match$45waldemar_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const repeat$45match$45waldemar_test = Object.create(null);
  ...
  repeat$45match$45waldemar_test.main = function() {
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2,}").firstMatch("aa"), JSArrayOfString().of(["aa"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2,}").firstMatch("a"), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2,}").firstMatch(""), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)").firstMatch("aa"), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)").firstMatch("a"), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)").firstMatch(""), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)(?:a*?)(?:a*?)").firstMatch("aa"), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)(?:a*?)(?:a*?)").firstMatch("a"), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)(?:a*?)(?:a*?)").firstMatch(""), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2}").firstMatch("aa"), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2}").firstMatch("a"), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2}").firstMatch(""), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2,3}").firstMatch("aa"), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2,3}").firstMatch("a"), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?){2,3}").firstMatch(""), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)?").firstMatch("aa"), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)?").firstMatch("a"), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)?").firstMatch(""), JSArrayOfString().of([""]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)*").firstMatch("aa"), JSArrayOfString().of(["aa"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)*").firstMatch("a"), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(core.RegExp.new("(?:a*?)*").firstMatch(""), JSArrayOfString().of([""]));
  };
  dart.fn(repeat$45match$45waldemar_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.repeat$45match$45waldemar_test = repeat$45match$45waldemar_test;
