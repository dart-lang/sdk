dart_library.library('corelib/regexp/look-ahead_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__look$45ahead_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const look$45ahead_test = Object.create(null);
  ...
  look$45ahead_test.main = function() {
    v8_regexp_utils.description('Test for regression against <a href="https://bugs.webkit.org/show_bug.cgi?id=41458">Yarr Interpreter is crashing in some cases of look-ahead regex patterns</a>');
    v8_regexp_utils.shouldBe(v8_regexp_utils.firstMatch("ab", core.RegExp.new("a(?=b|c)")), JSArrayOfString().of(["a"]));
    v8_regexp_utils.shouldBe(v8_regexp_utils.firstMatch("abd", core.RegExp.new("a(?=c|b)|d")), JSArrayOfString().of(["a"]));
  };
  dart.fn(look$45ahead_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.look$45ahead_test = look$45ahead_test;
