dart_library.library('corelib/regexp/compile-crash_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__compile$45crash_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const compile$45crash_test = Object.create(null);
  ...
  compile$45crash_test.main = function() {
    v8_regexp_utils.description('Test regexp compiling to make sure it doens\'t crash like bug <a href="https://bugs.webkit.org/show_bug.cgi?id=16127">16127</a>');
    v8_regexp_utils.shouldBeTrue(core.RegExp.new("\\)[;\\s]+") != null);
    v8_regexp_utils.assertThrows(dart.fn(() => core.RegExp.new("["), VoidToRegExp()));
    v8_regexp_utils.assertThrows(dart.fn(() => core.RegExp.new("[a"), VoidToRegExp()));
    v8_regexp_utils.assertThrows(dart.fn(() => core.RegExp.new("[-"), VoidToRegExp()));
    v8_regexp_utils.shouldBeTrue(core.RegExp.new("(a)\\1") != null);
    v8_regexp_utils.shouldBeTrue(core.RegExp.new("(a)\\1{1,3}") != null);
  };
  dart.fn(compile$45crash_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.compile$45crash_test = compile$45crash_test;
