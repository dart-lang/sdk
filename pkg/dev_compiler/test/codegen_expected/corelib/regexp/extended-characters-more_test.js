dart_library.library('corelib/regexp/extended-characters-more_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__extended$45characters$45more_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const extended$45characters$45more_test = Object.create(null);
  ...
  extended$45characters$45more_test.main = function() {
    v8_regexp_utils.description("This test checks a few cases of extended (> 127) characters in repeat regular expressions.");
    v8_regexp_utils.assertEquals("foo   "[dartx.replaceFirst](core.RegExp.new(core.String.fromCharCode(160) + "*"), ""), "foo   ");
    v8_regexp_utils.assertEquals("foo   "[dartx.replaceFirst](core.RegExp.new("\\u00a0+"), ""), "foo");
    v8_regexp_utils.assertEquals("foo   "[dartx.replaceFirst](core.RegExp.new("\\u00a0*$"), ""), "foo");
  };
  dart.fn(extended$45characters$45more_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.extended$45characters$45more_test = extended$45characters$45more_test;
