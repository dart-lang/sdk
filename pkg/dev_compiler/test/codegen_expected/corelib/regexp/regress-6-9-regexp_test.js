dart_library.library('corelib/regexp/regress-6-9-regexp_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__regress$456$459$45regexp_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const regress$456$459$45regexp_test = Object.create(null);
  ...
  regress$456$459$45regexp_test.main = function() {
    v8_regexp_utils.assertFalse(core.RegExp.new("[6-9]").hasMatch('2'));
  };
  dart.fn(regress$456$459$45regexp_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.regress$456$459$45regexp_test = regress$456$459$45regexp_test;
