dart_library.library('corelib/regexp/alternative-length-miscalculation_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__alternative$45length$45miscalculation_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const alternative$45length$45miscalculation_test = Object.create(null);
  ...
  alternative$45length$45miscalculation_test.main = function() {
    v8_regexp_utils.description("This page tests for length miscalculations in regular expression processing.");
    let re = core.RegExp.new("b|[^b]");
    v8_regexp_utils.assertEquals('a'[dartx.indexOf](re, 1), -1);
    let re2 = core.RegExp.new("[^a]|ab");
    v8_regexp_utils.shouldBeFalse(re2.hasMatch(''));
  };
  dart.fn(alternative$45length$45miscalculation_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.alternative$45length$45miscalculation_test = alternative$45length$45miscalculation_test;
