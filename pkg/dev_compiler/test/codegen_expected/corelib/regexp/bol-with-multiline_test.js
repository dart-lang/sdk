dart_library.library('corelib/regexp/bol-with-multiline_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__bol$45with$45multiline_test(exports, dart_sdk, expect) {
  'use strict';
  ...
  const bol$45with$45multiline_test = Object.create(null);
  ...
  bol$45with$45multiline_test.main = function() {
    v8_regexp_utils.description('Test for beginning of line (BOL or ^) matching in a multiline string</a>');
    let s = "aced\nabc";
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch(s, core.RegExp.new("^abc")));
    v8_regexp_utils.shouldBe(v8_regexp_utils.firstMatch(s, core.RegExp.new("^abc", {multiLine: true})), JSArrayOfString().of(["abc"]));
    v8_regexp_utils.shouldBeNull(v8_regexp_utils.firstMatch(s, core.RegExp.new("(^|X)abc")));
    v8_regexp_utils.shouldBe(v8_regexp_utils.firstMatch(s, core.RegExp.new("(^|X)abc", {multiLine: true})), JSArrayOfString().of(["abc", ""]));
    v8_regexp_utils.shouldBe(v8_regexp_utils.firstMatch(s, core.RegExp.new("(^a|Xa)bc", {multiLine: true})), JSArrayOfString().of(["abc", "a"]));
  };
  dart.fn(bol$45with$45multiline_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.bol$45with$45multiline_test = bol$45with$45multiline_test;
