dart_library.library('corelib/regexp/constructor_test', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__constructor_test(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const constructor_test = Object.create(null);
  ...
  constructor_test.main = function() {
    v8_regexp_utils.description("This test checks use of the regexp constructor.");
    let re = core.RegExp.new("abc");
    v8_regexp_utils.shouldBeFalse(core.identical(re, core.RegExp.new("abc", {caseSensitive: false, multiLine: true})));
    v8_regexp_utils.shouldBeFalse(core.identical(re, core.RegExp.new("abc", {caseSensitive: true, multiLine: true})));
    v8_regexp_utils.shouldBeFalse(core.identical(re, core.RegExp.new("abc", {caseSensitive: false, multiLine: false})));
  };
  dart.fn(constructor_test.main, VoidTovoid$());
  ...
  // Exports:
  exports.constructor_test = constructor_test;
