dart_library.library('corelib/int_parse_radix_test_none_multi', null, /* Imports */[
  'dart_sdk',
  'expect'
], function load__int_parse_radix_test_none_multi(exports, dart_sdk, expect) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const expect$ = expect.expect;
  const int_parse_radix_test_none_multi = Object.create(null);
  ...
  int_parse_radix_test_none_multi.main = function() {
    ...
    function testFails(source, radix) {
      ...
      }, VoidTovoid()), int_parse_radix_test_none_multi.isFail, dart.str`${source}/${radix}`);
  ...
  dart.fn(int_parse_radix_test_none_multi.main, VoidTovoid());
  int_parse_radix_test_none_multi.isFail = function(e) {
    return dart.equals(e, "FAIL");
  };
  dart.fn(int_parse_radix_test_none_multi.isFail, dynamicTobool());
  // Exports:
  exports.int_parse_radix_test_none_multi = int_parse_radix_test_none_multi;
});
