dart_library.library('corelib/list_replace_range_test', null, /* Imports */[
  ...
  list_replace_range_test.main = function() {
    ...
    list_replace_range_test.test(JSArrayOfint().of([1, 2, 3]), 0, 1, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(JSArrayOfint().of([1, 2, 3]), 1, 1, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(JSArrayOfint().of([1, 2, 3]), 2, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(JSArrayOfint().of([1, 2, 3]), 3, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(JSArrayOfint().of([1, 2, 3]), 0, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(JSArrayOfint().of([1, 2, 3]), 2, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    ...
    list_replace_range_test.test(new list_replace_range_test.MyList(JSArrayOfint().of([1, 2, 3])), 0, 1, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(new list_replace_range_test.MyList(JSArrayOfint().of([1, 2, 3])), 1, 1, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(new list_replace_range_test.MyList(JSArrayOfint().of([1, 2, 3])), 2, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(new list_replace_range_test.MyList(JSArrayOfint().of([1, 2, 3])), 3, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(new list_replace_range_test.MyList(JSArrayOfint().of([1, 2, 3])), 0, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
    list_replace_range_test.test(new list_replace_range_test.MyList(JSArrayOfint().of([1, 2, 3])), 2, 3, core.Iterable.generate(2, dart.fn(x => dart.notNull(x) + 4, intToint())));
