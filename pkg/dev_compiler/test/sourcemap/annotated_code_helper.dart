...
// sdk/tests/compiler/dart2js/annotated_code_helper.dart
// and these two files should be merged again at some point.
...
class AnnotatedCode {
  ...
  factory AnnotatedCode.fromText(
      String annotatedCode, Pattern start, Pattern end) {
