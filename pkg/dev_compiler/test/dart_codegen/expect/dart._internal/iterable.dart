...
class SubListIterable<E> extends ListIterable<E> {
  ...
  List<E> toList({bool growable: true}) {
    ...
    return DDC$RT.cast(result, DDC$RT.type((List<dynamic> _) {}),
        ...
        """line 310, column 12 of dart:_internal/iterable.dart: """,
...
class EfficientLengthMappedIterable<S, T> extends MappedIterable<S, T>
  ...
  EfficientLengthMappedIterable(Iterable iterable, T function(S value))
      : super._(DDC$RT.cast(iterable, DDC$RT.type((Iterable<dynamic> _) {}),
          DDC$RT.type((Iterable<S> _) {}), "CastDynamic",
          """line 378, column 17 of dart:_internal/iterable.dart: """,
...
class IterableMixinWorkaround<T> {
  ...
  static dynamic reduce(
      Iterable iterable, dynamic combine(previousValue, element)) {
  ...
  static dynamic fold(Iterable iterable, dynamic initialValue,
  ...
  static dynamic firstWhere(
      Iterable iterable, bool test(dynamic value), dynamic orElse()) {
  ...
  static dynamic lastWhereList(
      List list, bool test(dynamic value), dynamic orElse()) {
  ...
  static void sortList(List list, int compare(a, b)) {
    if (compare == null) compare = DDC$RT.wrap(
      ...
      int c(Comparable<dynamic> x0, Comparable<dynamic> x1) => f(DDC$RT.cast(x0,
          ...
          x0 is Comparable<dynamic>, true), DDC$RT.cast(x1, dynamic,
          DDC$RT.type((Comparable<dynamic> _) {}), "CastParam",
          """line 1001, column 36 of dart:_internal/iterable.dart: """,
