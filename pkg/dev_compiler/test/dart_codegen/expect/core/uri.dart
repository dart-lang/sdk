part of dart.core;
 ...
 factory Uri.file(String path, {
  ...
  windows = windows == null ? Uri._isWindows : windows;
   return ((__x10) => DDC$RT.cast(__x10, dynamic, Uri, "CastGeneral", """line 698, column 12 of dart:core/uri.dart: """, __x10 is Uri, true))(windows ? _makeWindowsFileUrl(path) : _makeFileUri(path));
  }
...
bool schemeChanged = false;
 ...
 if (port != null) {
  ...
  port = ((__x11) => DDC$RT.cast(__x11, num, int, "CastGeneral", """line 889, column 14 of dart:core/uri.dart: """, __x11 is int, true))(this._port);
   if (schemeChanged) {
    port = _makePort(port, scheme);
    }
  }
...
if (_pathSegments == null) {
  var pathToSplit = !path.isEmpty && path.codeUnitAt(0) == _SLASH ? path.substring(1) : path;
   _pathSegments = ((__x12) => DDC$RT.cast(__x12, DDC$RT.type((DDC$collection$.UnmodifiableListView<dynamic> _) {
    }
  ), DDC$RT.type((List<String> _) {
    }
  ), "CastExact", """line 945, column 23 of dart:core/uri.dart: """, __x12 is List<String>, false))(new UnmodifiableListView(pathToSplit == "" ? const <String> [] : pathToSplit.split("/").map(Uri.decodeComponent).toList(growable: false)));
  }
 return _pathSegments;
}
 Map<String, String> get queryParameters {
if (_queryParameters == null) {
  _queryParameters = ((__x13) => DDC$RT.cast(__x13, DDC$RT.type((DDC$collection$.UnmodifiableMapView<dynamic, dynamic> _) {
    }
  ), DDC$RT.type((Map<String, String> _) {
    }
  ), "CastExact", """line 969, column 26 of dart:core/uri.dart: """, __x13 is Map<String, String>, false))(new UnmodifiableMapView(splitQueryString(query)));
  }
 return _queryParameters;
}
 static int _makePort(int port, String scheme) {
if (port != null && port == _defaultPort(scheme)) return ((__x14) => DDC$RT.cast(__x14, Null, int, "CastLiteral", """line 976, column 62 of dart:core/uri.dart: """, __x14 is int, true))(null);
 return port;
}
...
assert (char <= 0x10ffff); const hexDigits = "0123456789ABCDEF";
 ...
 if (char < 0x80) {
  codeUnits = new List(3);
   ...
   codeUnits[1] = hexDigits.codeUnitAt(((__x15) => DDC$RT.cast(__x15, dynamic, int, "CastGeneral", """line 1248, column 43 of dart:core/uri.dart: """, __x15 is int, true))(char >> 4));
   codeUnits[2] = hexDigits.codeUnitAt(((__x16) => DDC$RT.cast(__x16, dynamic, int, "CastGeneral", """line 1249, column 43 of dart:core/uri.dart: """, __x16 is int, true))(char & 0xf));
  }
 else {
  int flag = 0xc0;
   int encodedBytes = 2;
   ...
   while (--encodedBytes >= 0) {
    int byte = ((__x17) => DDC$RT.cast(__x17, dynamic, int, "CastGeneral", """line 1265, column 20 of dart:core/uri.dart: """, __x17 is int, true))(((char >> (6 * encodedBytes)) & 0x3f) | flag);
...
if (!_hasDotSegments(path)) return path;
 List<String> output = ((__x18) => DDC$RT.cast(__x18, DDC$RT.type((List<dynamic> _) {
  }
), DDC$RT.type((List<String> _) {
  }
), "CastLiteral", """line 1402, column 27 of dart:core/uri.dart: """, __x18 is List<String>, false))([]);
 ...
 if (reference.scheme.isNotEmpty) {
  targetScheme = reference.scheme;
   if (reference.hasAuthority) {
    targetUserInfo = reference.userInfo;
     ...
     targetPort = ((__x19) => DDC$RT.cast(__x19, dynamic, int, "CastGeneral", """line 1456, column 22 of dart:core/uri.dart: """, __x19 is int, true))(reference.hasPort ? reference.port : null);
    }
  ...
  targetScheme = this.scheme;
   if (reference.hasAuthority) {
    targetUserInfo = reference.userInfo;
     targetHost = reference.host;
     targetPort = _makePort(((__x20) => DDC$RT.cast(__x20, dynamic, int, "CastGeneral", """line 1467, column 32 of dart:core/uri.dart: """, __x20 is int, true))(reference.hasPort ? reference.port : null), targetScheme);
     targetPath = _removeDotSegments(reference.path);
    ...
    if (reference.path == "") {
     ...
     targetPort = ((__x21) => DDC$RT.cast(__x21, num, int, "CastGeneral", """line 1489, column 22 of dart:core/uri.dart: """, __x21 is int, true))(this._port);
    }
  }
 String fragment = ((__x22) => DDC$RT.cast(__x22, dynamic, String, "CastGeneral", """line 1492, column 23 of dart:core/uri.dart: """, __x22 is String, true))(reference.hasFragment ? reference.fragment : null);
...
int combine(part, current) {
  return ((__x23) => DDC$RT.cast(__x23, dynamic, int, "CastGeneral", """line 1714, column 14 of dart:core/uri.dart: """, __x23 is int, true))((current * 31 + part.hashCode) & 0x3FFFFFFF);
  }
...
return ((__x24) => DDC$RT.cast(__x24, dynamic, DDC$RT.type((Map<String, String> _) {
  }
), "CastGeneral", """line 1864, column 12 of dart:core/uri.dart: """, __x24 is Map<String, String>, false))(query.split("&").fold({
  }
, (map, element) {
  int index = ((__x25) => DDC$RT.cast(__x25, dynamic, int, "CastGeneral", """line 1865, column 19 of dart:core/uri.dart: """, __x25 is int, true))(element.indexOf("="));
   if (index == -1) {
    if (element != "") {
...
), "CastDynamic", """line 1896, column 12 of dart:core/uri.dart: """, __x26 is List<int>, false))(bytes.map((byteString) {
...
if (end == null) end = host.length;
 ...
 List<int> parts = ((__x27) => DDC$RT.cast(__x27, DDC$RT.type((List<dynamic> _) {
  }
), DDC$RT.type((List<int> _) {
  }
), "CastLiteral", """line 1946, column 23 of dart:core/uri.dart: """, __x27 is List<int>, false))([]);
...
byteToHex(byte, buffer) {
  const String hex = '0123456789ABCDEF';
   buffer.writeCharCode(hex.codeUnitAt(((__x28) => DDC$RT.cast(__x28, dynamic, int, "CastGeneral", """line 2059, column 43 of dart:core/uri.dart: """, __x28 is int, true))(byte >> 4)));
   buffer.writeCharCode(hex.codeUnitAt(((__x29) => DDC$RT.cast(__x29, dynamic, int, "CastGeneral", """line 2060, column 43 of dart:core/uri.dart: """, __x29 is int, true))(byte & 0x0f)));
  }
...
bool simple = true;
 ...
 if (simple) {
  ...
  ), "CastExact", """line 2134, column 15 of dart:core/uri.dart: """, __x30 is List<int>, false))(new List());
   for (int i = 0;
   i < text.length;
   i++) {
    var codeUnit = text.codeUnitAt(i);
