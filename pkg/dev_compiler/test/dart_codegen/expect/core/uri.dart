part of dart.core;
 ...
 int get port {
  if (_port == null) return _defaultPort(scheme);
   return DDC$RT.cast(_port, num, int, "CastGeneral", """line 94, column 12 of dart:core/uri.dart: """, _port is int, true);
  }
 ...
 static Uri parse(String uri) {
  bool isRegName(int ch) {
   ...
   assert (state == IN_PATH || state == NOT_IN_PATH); if (state == IN_PATH) {
    while (++index < uri.length) {
      char = uri.codeUnitAt(index);
       if (char == _QUESTION || char == _NUMBER_SIGN) {
        break;
   ...
   assert (state == NOT_IN_PATH); bool isFile = (scheme == "file");
 ...
 static Uri _makeHttpUri(String scheme, String authority, String unencodedPath, Map<String, String> queryParameters) {
  var userInfo = "";
   ...
   return new Uri(scheme: scheme, userInfo: userInfo, host: DDC$RT.cast(host, dynamic, String, "CastGeneral", """line 609, column 26 of dart:core/uri.dart: """, host is String, true), port: DDC$RT.cast(port, dynamic, int, "CastGeneral", """line 610, column 26 of dart:core/uri.dart: """, port is int, true), pathSegments: unencodedPath.split("/"), queryParameters: queryParameters);
  }
 factory Uri.file(String path, {
  bool windows}
) {
  windows = windows == null ? Uri._isWindows : windows;
   return ((__x15) => DDC$RT.cast(__x15, dynamic, Uri, "CastGeneral", """line 698, column 12 of dart:core/uri.dart: """, __x15 is Uri, true))(windows ? _makeWindowsFileUrl(path) : _makeFileUri(path));
  }
 ...
 Uri replace({
  ...
  bool schemeChanged = false;
   ...
   if (port != null) {
    ...
    port = ((__x16) => DDC$RT.cast(__x16, num, int, "CastGeneral", """line 889, column 14 of dart:core/uri.dart: """, __x16 is int, true))(this._port);
     if (schemeChanged) {
      port = _makePort(port, scheme);
      }
    }
 ...
 List<String> get pathSegments {
  if (_pathSegments == null) {
    var pathToSplit = !path.isEmpty && path.codeUnitAt(0) == _SLASH ? path.substring(1) : path;
     _pathSegments = ((__x17) => DDC$RT.cast(__x17, DDC$RT.type((DDC$collection$.UnmodifiableListView<dynamic> _) {
      }
    ), DDC$RT.type((List<String> _) {
      }
    ), "CastExact", """line 945, column 23 of dart:core/uri.dart: """, __x17 is List<String>, false))(new UnmodifiableListView(pathToSplit == "" ? const <String> [] : pathToSplit.split("/").map(Uri.decodeComponent).toList(growable: false)));
    }
   return _pathSegments;
  }
 Map<String, String> get queryParameters {
  if (_queryParameters == null) {
    _queryParameters = ((__x18) => DDC$RT.cast(__x18, DDC$RT.type((DDC$collection$.UnmodifiableMapView<dynamic, dynamic> _) {
      }
    ), DDC$RT.type((Map<String, String> _) {
      }
    ), "CastExact", """line 969, column 26 of dart:core/uri.dart: """, __x18 is Map<String, String>, false))(new UnmodifiableMapView(splitQueryString(query)));
    }
   return _queryParameters;
  }
 static int _makePort(int port, String scheme) {
  if (port != null && port == _defaultPort(scheme)) return ((__x19) => DDC$RT.cast(__x19, Null, int, "CastLiteral", """line 976, column 62 of dart:core/uri.dart: """, __x19 is int, true))(null);
   return port;
  }
 ...
 static String _makeUserInfo(String userInfo, int start, int end) {
  if (userInfo == null) return "";
   return _normalize(userInfo, start, end, DDC$RT.cast(_userinfoTable, dynamic, DDC$RT.type((List<int> _) {
    }
 ...
 static String _makePath(String path, int start, int end, Iterable<String> pathSegments, bool ensureLeadingSlash, bool isFile) {
  if (path == null && pathSegments == null) return isFile ? "/" : "";
   ...
   var result;
   if (path != null) {
    result = _normalize(path, start, end, DDC$RT.cast(_pathCharOrSlashTable, dynamic, DDC$RT.type((List<int> _) {
      }
    ), "CastGeneral", """line 1139, column 45 of dart:core/uri.dart: """, _pathCharOrSlashTable is List<int>, false));
    }
   else {
    result = pathSegments.map((s) => _uriEncode(DDC$RT.cast(_pathCharTable, dynamic, DDC$RT.type((List<int> _) {
      }
    ), "CastGeneral", """line 1141, column 51 of dart:core/uri.dart: """, _pathCharTable is List<int>, false), DDC$RT.cast(s, dynamic, String, "CastGeneral", """line 1141, column 67 of dart:core/uri.dart: """, s is String, true))).join("/");
    }
   if (result.isEmpty) {
    if (isFile) return "/";
    }
   ...
   return DDC$RT.cast(result, dynamic, String, "CastGeneral", """line 1149, column 12 of dart:core/uri.dart: """, result is String, true);
  }
 static String _makeQuery(String query, int start, int end, Map<String, String> queryParameters) {
  if (query == null && queryParameters == null) return null;
   ...
   if (query != null) return _normalize(query, start, end, DDC$RT.cast(_queryCharTable, dynamic, DDC$RT.type((List<int> _) {
    }
   ...
   queryParameters.forEach((key, value) {
    if (!first) {
     ...
     first = false;
     result.write(Uri.encodeQueryComponent(DDC$RT.cast(key, dynamic, String, "CastGeneral", """line 1167, column 45 of dart:core/uri.dart: """, key is String, true)));
     if (value != null && !value.isEmpty) {
      result.write("=");
       result.write(Uri.encodeQueryComponent(DDC$RT.cast(value, dynamic, String, "CastGeneral", """line 1170, column 47 of dart:core/uri.dart: """, value is String, true)));
      }
    }
  );
 ...
 static String _makeFragment(String fragment, int start, int end) {
  if (fragment == null) return null;
   return _normalize(fragment, start, end, DDC$RT.cast(_queryCharTable, dynamic, DDC$RT.type((List<int> _) {
    }
 ...
 static int _hexValue(int char) {
  assert (_isHexDigit(char)); if (_NINE >= char) return char - _ZERO;
   char |= 0x20;
   return char - (_LOWER_CASE_A - 10);
  }
 static String _normalizeEscape(String source, int index, bool lowerCase) {
  assert (source.codeUnitAt(index) == _PERCENT); if (index + 2 >= source.length) {
    return "%";
    }
  ...
  assert (char <= 0x10ffff); const hexDigits = "0123456789ABCDEF";
   ...
   if (char < 0x80) {
    codeUnits = new List(3);
     ...
     codeUnits[1] = hexDigits.codeUnitAt(((__x20) => DDC$RT.cast(__x20, dynamic, int, "CastGeneral", """line 1248, column 43 of dart:core/uri.dart: """, __x20 is int, true))(char >> 4));
     codeUnits[2] = hexDigits.codeUnitAt(((__x21) => DDC$RT.cast(__x21, dynamic, int, "CastGeneral", """line 1249, column 43 of dart:core/uri.dart: """, __x21 is int, true))(char & 0xf));
    }
   else {
    int flag = 0xc0;
     int encodedBytes = 2;
     ...
     while (--encodedBytes >= 0) {
      int byte = ((__x22) => DDC$RT.cast(__x22, dynamic, int, "CastGeneral", """line 1265, column 20 of dart:core/uri.dart: """, __x22 is int, true))(((char >> (6 * encodedBytes)) & 0x3f) | flag);
   ...
   return new String.fromCharCodes(DDC$RT.cast(codeUnits, DDC$RT.type((List<dynamic> _) {
    }
  ), DDC$RT.type((Iterable<int> _) {
    }
 ...
 String _removeDotSegments(String path) {
  if (!_hasDotSegments(path)) return path;
   List<String> output = ((__x23) => DDC$RT.cast(__x23, DDC$RT.type((List<dynamic> _) {
    }
  ), DDC$RT.type((List<String> _) {
    }
  ), "CastLiteral", """line 1402, column 27 of dart:core/uri.dart: """, __x23 is List<String>, false))([]);
   ...
   if (reference.scheme.isNotEmpty) {
    targetScheme = reference.scheme;
     if (reference.hasAuthority) {
      targetUserInfo = reference.userInfo;
       ...
       targetPort = ((__x24) => DDC$RT.cast(__x24, dynamic, int, "CastGeneral", """line 1456, column 22 of dart:core/uri.dart: """, __x24 is int, true))(reference.hasPort ? reference.port : null);
      }
    ...
    targetScheme = this.scheme;
     if (reference.hasAuthority) {
      targetUserInfo = reference.userInfo;
       targetHost = reference.host;
       targetPort = _makePort(((__x25) => DDC$RT.cast(__x25, dynamic, int, "CastGeneral", """line 1467, column 32 of dart:core/uri.dart: """, __x25 is int, true))(reference.hasPort ? reference.port : null), targetScheme);
       targetPath = _removeDotSegments(reference.path);
      ...
      if (reference.path == "") {
       ...
       targetPort = ((__x26) => DDC$RT.cast(__x26, num, int, "CastGeneral", """line 1489, column 22 of dart:core/uri.dart: """, __x26 is int, true))(this._port);
      }
    }
   String fragment = ((__x27) => DDC$RT.cast(__x27, dynamic, String, "CastGeneral", """line 1492, column 23 of dart:core/uri.dart: """, __x27 is String, true))(reference.hasFragment ? reference.fragment : null);
 ...
 bool operator ==(other) {
  if (other is! Uri) return false;
   Uri uri = DDC$RT.cast(other, dynamic, Uri, "CastGeneral", """line 1698, column 15 of dart:core/uri.dart: """, other is Uri, true);
 ...
 int get hashCode {
  int combine(part, current) {
    return ((__x28) => DDC$RT.cast(__x28, dynamic, int, "CastGeneral", """line 1714, column 14 of dart:core/uri.dart: """, __x28 is int, true))((current * 31 + part.hashCode) & 0x3FFFFFFF);
    }
 ...
 static String encodeComponent(String component) {
  return _uriEncode(DDC$RT.cast(_unreserved2396Table, dynamic, DDC$RT.type((List<int> _) {
    }
 ...
 static String encodeQueryComponent(String component, {
  ...
  return _uriEncode(DDC$RT.cast(_unreservedTable, dynamic, DDC$RT.type((List<int> _) {
    }
 ...
 static String encodeFull(String uri) {
  return _uriEncode(DDC$RT.cast(_encodeFullTable, dynamic, DDC$RT.type((List<int> _) {
    }
 ...
 static Map<String, String> splitQueryString(String query, {
  ...
  return ((__x29) => DDC$RT.cast(__x29, dynamic, DDC$RT.type((Map<String, String> _) {
    }
  ), "CastGeneral", """line 1864, column 12 of dart:core/uri.dart: """, __x29 is Map<String, String>, false))(query.split("&").fold({
    }
  , (map, element) {
    int index = ((__x30) => DDC$RT.cast(__x30, dynamic, int, "CastGeneral", """line 1865, column 19 of dart:core/uri.dart: """, __x30 is int, true))(element.indexOf("="));
     if (index == -1) {
      if (element != "") {
        map[decodeQueryComponent(DDC$RT.cast(element, dynamic, String, "CastGeneral", """line 1868, column 36 of dart:core/uri.dart: """, element is String, true), encoding: encoding)] = "";
        }
      }
     else if (index != 0) {
      var key = element.substring(0, index);
       var value = element.substring(index + 1);
       map[Uri.decodeQueryComponent(DDC$RT.cast(key, dynamic, String, "CastGeneral", """line 1873, column 38 of dart:core/uri.dart: """, key is String, true), encoding: encoding)] = decodeQueryComponent(DDC$RT.cast(value, dynamic, String, "CastGeneral", """line 1874, column 34 of dart:core/uri.dart: """, value is String, true), encoding: encoding);
      }
     return map;
    }
  ));
 ...
 static List<int> parseIPv4Address(String host) {
  ...
  ), "CastDynamic", """line 1896, column 12 of dart:core/uri.dart: """, __x31 is List<int>, false))(bytes.map((byteString) {
    int byte = int.parse(DDC$RT.cast(byteString, dynamic, String, "CastGeneral", """line 1898, column 32 of dart:core/uri.dart: """, byteString is String, true));
     if (byte < 0 || byte > 255) {
 ...
 static List<int> parseIPv6Address(String host, [int start = 0, int end]) {
  if (end == null) end = host.length;
   void error(String msg, [position]) {
    throw new FormatException('Illegal IPv6 address, $msg', host, DDC$RT.cast(position, dynamic, int, "CastGeneral", """line 1933, column 69 of dart:core/uri.dart: """, position is int, true));
    }
   ...
   List<int> parts = ((__x32) => DDC$RT.cast(__x32, DDC$RT.type((List<dynamic> _) {
    }
  ), DDC$RT.type((List<int> _) {
    }
  ), "CastLiteral", """line 1946, column 23 of dart:core/uri.dart: """, __x32 is List<int>, false))([]);
 ...
 static String _uriEncode(List<int> canonicalTable, String text, {
  ...
  byteToHex(byte, buffer) {
    const String hex = '0123456789ABCDEF';
     buffer.writeCharCode(hex.codeUnitAt(((__x33) => DDC$RT.cast(__x33, dynamic, int, "CastGeneral", """line 2059, column 43 of dart:core/uri.dart: """, __x33 is int, true))(byte >> 4)));
     buffer.writeCharCode(hex.codeUnitAt(((__x34) => DDC$RT.cast(__x34, dynamic, int, "CastGeneral", """line 2060, column 43 of dart:core/uri.dart: """, __x34 is int, true))(byte & 0x0f)));
    }
 ...
 static String _uriDecode(String text, {
  ...
  bool simple = true;
   ...
   if (simple) {
    ...
    ), "CastExact", """line 2134, column 15 of dart:core/uri.dart: """, __x35 is List<int>, false))(new List());
