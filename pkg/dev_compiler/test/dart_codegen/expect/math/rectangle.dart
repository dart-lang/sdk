part of dart.math;
 ...
 T get width;
 T get height;
 T get right => ((__x7) => DEVC$RT.cast(__x7, num, T, "CastGeneral", """line 33, column 18 of dart:math/rectangle.dart: """, __x7 is T, false))(left + width);
 T get bottom => ((__x8) => DEVC$RT.cast(__x8, num, T, "CastGeneral", """line 35, column 19 of dart:math/rectangle.dart: """, __x8 is T, false))(top + height);
 String toString() {
 ...
 Point<T> get topRight => new Point<T>(((__x13) => DEVC$RT.cast(__x13, num, T, "CastGeneral", """line 119, column 41 of dart:math/rectangle.dart: """, __x13 is T, false))(this.left + this.width), this.top);
 Point<T> get bottomRight => new Point<T>(((__x14) => DEVC$RT.cast(__x14, num, T, "CastGeneral", """line 120, column 44 of dart:math/rectangle.dart: """, __x14 is T, false))(this.left + this.width), ((__x15) => DEVC$RT.cast(__x15, num, T, "CastGeneral", """line 121, column 7 of dart:math/rectangle.dart: """, __x15 is T, false))(this.top + this.height));
 Point<T> get bottomLeft => new Point<T>(this.left, ((__x16) => DEVC$RT.cast(__x16, num, T, "CastGeneral", """line 123, column 7 of dart:math/rectangle.dart: """, __x16 is T, false))(this.top + this.height));
}
...
T left = ((__x17) => DEVC$RT.cast(__x17, num, T, "CastGeneral", """line 167, column 14 of dart:math/rectangle.dart: """, __x17 is T, false))(min(a.x, b.x));
 T width = ((__x18) => DEVC$RT.cast(__x18, num, T, "CastGeneral", """line 168, column 15 of dart:math/rectangle.dart: """, __x18 is T, false))(max(a.x, b.x) - left);
 T top = ((__x19) => DEVC$RT.cast(__x19, num, T, "CastGeneral", """line 169, column 13 of dart:math/rectangle.dart: """, __x19 is T, false))(min(a.y, b.y));
 T height = ((__x20) => DEVC$RT.cast(__x20, num, T, "CastGeneral", """line 170, column 16 of dart:math/rectangle.dart: """, __x20 is T, false))(max(a.y, b.y) - top);
...
T left = ((__x23) => DEVC$RT.cast(__x23, num, T, "CastGeneral", """line 228, column 14 of dart:math/rectangle.dart: """, __x23 is T, false))(min(a.x, b.x));
 T width = ((__x24) => DEVC$RT.cast(__x24, num, T, "CastGeneral", """line 229, column 15 of dart:math/rectangle.dart: """, __x24 is T, false))(max(a.x, b.x) - left);
 T top = ((__x25) => DEVC$RT.cast(__x25, num, T, "CastGeneral", """line 230, column 13 of dart:math/rectangle.dart: """, __x25 is T, false))(min(a.y, b.y));
 T height = ((__x26) => DEVC$RT.cast(__x26, num, T, "CastGeneral", """line 231, column 16 of dart:math/rectangle.dart: """, __x26 is T, false))(max(a.y, b.y) - top);
 return new MutableRectangle<T>(left, top, width, height);
}
 T get width => _width;
 void set width(T width) {
if (width < 0) width = ((__x27) => DEVC$RT.cast(__x27, num, T, "CastGeneral", """line 247, column 28 of dart:math/rectangle.dart: """, __x27 is T, false))(_clampToZero(width));
 _width = width;
}
 T get height => _height;
 void set height(T height) {
if (height < 0) height = ((__x28) => DEVC$RT.cast(__x28, num, T, "CastGeneral", """line 263, column 30 of dart:math/rectangle.dart: """, __x28 is T, false))(_clampToZero(height));
 _height = height;
}
}
