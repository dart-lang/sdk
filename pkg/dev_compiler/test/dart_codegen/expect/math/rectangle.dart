part of dart.math;
 ...
 T get width;
 T get height;
 T get right => ((__x1) => DDC$RT.cast(__x1, num, T, "CastGeneral", """line 33, column 18 of dart:math/rectangle.dart: """, __x1 is T, false))(left + width);
 T get bottom => ((__x2) => DDC$RT.cast(__x2, num, T, "CastGeneral", """line 35, column 19 of dart:math/rectangle.dart: """, __x2 is T, false))(top + height);
 String toString() {
...
T left = ((__x3) => DDC$RT.cast(__x3, num, T, "CastGeneral", """line 167, column 14 of dart:math/rectangle.dart: """, __x3 is T, false))(min(a.x, b.x));
 T width = ((__x4) => DDC$RT.cast(__x4, num, T, "CastGeneral", """line 168, column 15 of dart:math/rectangle.dart: """, __x4 is T, false))(max(a.x, b.x) - left);
 T top = ((__x5) => DDC$RT.cast(__x5, num, T, "CastGeneral", """line 169, column 13 of dart:math/rectangle.dart: """, __x5 is T, false))(min(a.y, b.y));
 T height = ((__x6) => DDC$RT.cast(__x6, num, T, "CastGeneral", """line 170, column 16 of dart:math/rectangle.dart: """, __x6 is T, false))(max(a.y, b.y) - top);
