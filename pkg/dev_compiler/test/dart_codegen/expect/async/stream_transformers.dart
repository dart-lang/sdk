...
class _BoundSinkStream<S, T> extends Stream<T> {
  ...
  StreamSubscription<T> listen(void onData(T event),
    ...
    StreamSubscription<T> subscription = ((__x118) => DDC$RT.cast(__x118,
            DDC$RT.type(
            ...
            __x118 is StreamSubscription<T>, false))(
...
class _StreamHandlerTransformer<S, T> extends _StreamSinkTransformer<S, T> {
  _StreamHandlerTransformer({void handleData(S data, EventSink<T> sink),
      ...
      : super(((__x125) => DDC$RT.wrap((dynamic f(EventSink<T> __u120)) {
        dynamic c(EventSink<T> x0) => ((__x119) => DDC$RT.cast(__x119, dynamic,
            DDC$RT.type((EventSink<S> _) {}), "CastResult",
            """line 233, column 15 of dart:async/stream_transformers.dart: """,
            __x119 is EventSink<S>, false))(f(x0));
        return f == null ? null : c;
      }, __x125, DDC$RT.type((__t123<T> _) {}),
          DDC$RT.type((__t121<T, S> _) {}), "WrapLiteral",
          """line 233, column 15 of dart:async/stream_transformers.dart: """,
          __x125 is __t121<T, S>))((EventSink<T> outputSink) {
