...
class _BroadcastStream<T> extends _ControllerStream<T> {
  _BroadcastStream(_StreamControllerLifecycle controller) : super(DDC$RT.cast(
          controller, DDC$RT.type((_StreamControllerLifecycle<dynamic> _) {}),
          DDC$RT.type((_StreamControllerLifecycle<T> _) {}), "CastDynamic",
          """line 8, column 67 of dart:async/broadcast_stream_controller.dart: """,
          controller is _StreamControllerLifecycle<T>, false));
...
class _BroadcastSubscription<T> extends _ControllerSubscription<T>
  ...
  _BroadcastSubscription(_StreamControllerLifecycle controller,
      ...
      : super(DDC$RT.cast(controller,
          DDC$RT.type((_StreamControllerLifecycle<dynamic> _) {}),
          DDC$RT.type((_StreamControllerLifecycle<T> _) {}), "CastDynamic",
          """line 36, column 15 of dart:async/broadcast_stream_controller.dart: """,
          controller is _StreamControllerLifecycle<T>,
...
abstract class _BroadcastStreamController<T>
    implements StreamController<T>, _StreamControllerLifecycle<T>, _BroadcastSubscriptionLink, _EventSink<T>, _EventDispatch<T> {
  ...
  StreamSubscription<T> _subscribe(void onData(T data), Function onError,
    ...
    _addListener(DDC$RT.cast(subscription,
        DDC$RT.type((StreamSubscription<dynamic> _) {}),
        DDC$RT.type((_BroadcastSubscription<T> _) {}), "CastGeneral",
        """line 196, column 18 of dart:async/broadcast_stream_controller.dart: """,
        subscription is _BroadcastSubscription<T>, false));
    ...
    return DDC$RT.cast(subscription,
        ...
        """line 201, column 12 of dart:async/broadcast_stream_controller.dart: """,
  ...
  void _forEachListener(
    ...
    while (!identical(link, this)) {
      _BroadcastSubscription<T> subscription = DDC$RT.cast(link,
          _BroadcastSubscriptionLink,
          DDC$RT.type((_BroadcastSubscription<T> _) {}), "CastGeneral",
          """line 309, column 48 of dart:async/broadcast_stream_controller.dart: """,
          link is _BroadcastSubscription<T>, false);
...
class _SyncBroadcastStreamController<T> extends _BroadcastStreamController<T> {
  ...
  void _sendData(T data) {
    ...
    if (_hasOneListener) {
      ...
      _BroadcastSubscription subscription = DDC$RT.cast(_next,
          _BroadcastSubscriptionLink,
          DDC$RT.type((_BroadcastSubscription<dynamic> _) {}), "CastGeneral",
          """line 350, column 45 of dart:async/broadcast_stream_controller.dart: """,
          _next is _BroadcastSubscription<dynamic>, true);
  ...
  void _sendData(T data) {
    for (_BroadcastSubscriptionLink link = _next;
      ...
      _BroadcastSubscription<T> subscription = DDC$RT.cast(link,
          _BroadcastSubscriptionLink,
          DDC$RT.type((_BroadcastSubscription<T> _) {}), "CastGeneral",
          """line 393, column 48 of dart:async/broadcast_stream_controller.dart: """,
          link is _BroadcastSubscription<T>, false);
  ...
  void _sendError(Object error, StackTrace stackTrace) {
    for (_BroadcastSubscriptionLink link = _next;
      ...
      _BroadcastSubscription<T> subscription = DDC$RT.cast(link,
          _BroadcastSubscriptionLink,
          DDC$RT.type((_BroadcastSubscription<T> _) {}), "CastGeneral",
          """line 402, column 48 of dart:async/broadcast_stream_controller.dart: """,
          link is _BroadcastSubscription<T>, false);
    ...
    if (!_isEmpty) {
      for (_BroadcastSubscriptionLink link = _next;
        ...
        _BroadcastSubscription<T> subscription = DDC$RT.cast(link,
            _BroadcastSubscriptionLink,
            DDC$RT.type((_BroadcastSubscription<T> _) {}), "CastGeneral",
            """line 412, column 50 of dart:async/broadcast_stream_controller.dart: """,
            link is _BroadcastSubscription<T>, false);
