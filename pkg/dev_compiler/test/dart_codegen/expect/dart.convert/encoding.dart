...
abstract class Encoding extends Codec<String, List<int>> {
  ...
  Future<String> decodeStream(Stream<List<int>> byteStream) {
    return ((__x5) => DDC$RT.cast(__x5,
            DDC$RT.type((DDC$dartDOTasync$.Future<dynamic> _) {}),
            DDC$RT.type((DDC$dartDOTasync$.Future<String> _) {}), "CastDynamic",
            """line 14, column 12 of dart:convert/encoding.dart: """,
            __x5 is DDC$dartDOTasync$.Future<String>, false))(byteStream
        .transform(DDC$RT.cast(decoder,
            DDC$RT.type((Converter<List<int>, String> _) {}), DDC$RT.type(
                (DDC$dartDOTasync$.StreamTransformer<List<int>, dynamic> _) {}),
            "CastDynamic",
            """line 15, column 18 of dart:convert/encoding.dart: """,
            decoder is DDC$dartDOTasync$.StreamTransformer<List<int>, dynamic>,
            false))
