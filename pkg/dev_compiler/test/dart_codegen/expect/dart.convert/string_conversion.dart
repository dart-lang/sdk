...
abstract class StringConversionSink extends ChunkedConversionSink<String> {
  ...
  factory StringConversionSink.withCallback(
      void callback(String accumulated)) = _StringCallbackSink;
  factory StringConversionSink.from(Sink<String> sink) = _StringAdapterSink;
  factory StringConversionSink.fromStringSink(
      StringSink sink) = _StringSinkConversionSink;
...
abstract class ClosableStringSink extends StringSink {
  factory ClosableStringSink.fromStringSink(
      StringSink sink, void onClose()) = _ClosableStringSink;
  void close();
}
...
class _StringConversionSinkAsStringSinkAdapter implements ClosableStringSink {
  ...
  void writeAll(Iterable objects, [String separator = ""]) {
    ...
    if (separator.isEmpty) {
      do {
        _chunkedSink.add(((__x27) => DDC$RT.cast(__x27, dynamic, String,
            "CastGeneral",
            """line 147, column 26 of dart:convert/string_conversion.dart: """,
            __x27 is String, true))(iterator.current.toString()));
      } while (iterator.moveNext());
    } else {
      _chunkedSink.add(((__x28) => DDC$RT.cast(__x28, dynamic, String,
          "CastGeneral",
          """line 150, column 24 of dart:convert/string_conversion.dart: """,
          __x28 is String, true))(iterator.current.toString()));
      while (iterator.moveNext()) {
        write(separator);
        _chunkedSink.add(((__x29) => DDC$RT.cast(__x29, dynamic, String,
            "CastGeneral",
            """line 153, column 26 of dart:convert/string_conversion.dart: """,
            __x29 is String, true))(iterator.current.toString()));
      }
    }
  }
  void _flush() {
...
class _StringCallbackSink extends _StringSinkConversionSink {
  ...
  void close() {
    StringBuffer buffer = DDC$RT.cast(_stringSink, StringSink, StringBuffer,
        "CastGeneral",
        """line 233, column 27 of dart:convert/string_conversion.dart: """,
