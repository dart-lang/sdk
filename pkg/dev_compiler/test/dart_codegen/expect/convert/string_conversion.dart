...
do {
_chunkedSink.add(((__x26) => DEVC$RT.cast(__x26, dynamic, String, "DynamicCast", """line 147, column 26 of dart:convert/string_conversion.dart: """, __x26 is String, true))(iterator.current.toString()));
}
 while (iterator.moveNext());}
 else {
_chunkedSink.add(((__x27) => DEVC$RT.cast(__x27, dynamic, String, "DynamicCast", """line 150, column 24 of dart:convert/string_conversion.dart: """, __x27 is String, true))(iterator.current.toString()));
 while (iterator.moveNext()) {
write(separator);
 _chunkedSink.add(((__x28) => DEVC$RT.cast(__x28, dynamic, String, "DynamicCast", """line 153, column 26 of dart:convert/string_conversion.dart: """, __x28 is String, true))(iterator.current.toString()));
}
}
}
 void _flush() {
