...
if (sink is! ByteConversionSink) {
 ...
 Stream<List<int>> bind(Stream<String> stream) => ((__x29) => DEVC$RT.cast(__x29, DEVC$RT.type((DDC$async$.Stream<dynamic> _) {
}
), DEVC$RT.type((DDC$async$.Stream<List<int>> _) {
}
), "CompositeCast", """line 129, column 52 of dart:convert/utf.dart: """, __x29 is DDC$async$.Stream<List<int>>, false))(super.bind(stream));
}
...
stringSink = new StringConversionSink.from(sink);
 ...
 Stream<String> bind(Stream<List<int>> stream) => ((__x30) => DEVC$RT.cast(__x30, DEVC$RT.type((DDC$async$.Stream<dynamic> _) {
}
), DEVC$RT.type((DDC$async$.Stream<String> _) {
}
), "CompositeCast", """line 361, column 52 of dart:convert/utf.dart: """, __x30 is DDC$async$.Stream<String>, false))(super.bind(stream));
