...
abstract class IterableMixin<E> implements Iterable<E> {
  ...
  E get first {
    ...
    return DDC$RT.cast(it.current, dynamic, E, "CastGeneral",
        """line 127, column 12 of dart:collection/iterable.dart: """,
  ...
  E get last {
    ...
    do {
      result = DDC$RT.cast(it.current, dynamic, E, "CastGeneral",
          """line 137, column 16 of dart:collection/iterable.dart: """,
          it.current is E, false);
    } while (it.moveNext());
    return result;
  }
  E get single {
    ...
    E result = DDC$RT.cast(it.current, dynamic, E, "CastGeneral",
        """line 145, column 16 of dart:collection/iterable.dart: """,
        it.current is E, false);
...
abstract class IterableBase<E> implements Iterable<E> {
  ...
  E get first {
    ...
    return DDC$RT.cast(it.current, dynamic, E, "CastGeneral",
        """line 323, column 12 of dart:collection/iterable.dart: """,
        it.current is E, false);
  }
  E get last {
    Iterator it = iterator;
    ...
    do {
      result = DDC$RT.cast(it.current, dynamic, E, "CastGeneral",
          """line 333, column 16 of dart:collection/iterable.dart: """,
          it.current is E, false);
    } while (it.moveNext());
    return result;
  }
  E get single {
    ...
    if (!it.moveNext()) throw IterableElementError.noElement();
    E result = DDC$RT.cast(it.current, dynamic, E, "CastGeneral",
        """line 341, column 16 of dart:collection/iterable.dart: """,
        it.current is E, false);
    if (it.moveNext()) throw IterableElementError.tooMany();
    return result;
  }
