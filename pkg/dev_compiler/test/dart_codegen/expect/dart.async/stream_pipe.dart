...
void _addErrorWithReplacement(_EventSink sink, error, stackTrace) {
  AsyncError replacement = Zone.current.errorCallback(error, DDC$RT.cast(
      ...
      """line 191, column 62 of dart:async/stream_pipe.dart: """,
      stackTrace is StackTrace, true));
  if (replacement != null) {
    error = _nonNullError(replacement.error);
    stackTrace = replacement.stackTrace;
  }
  sink._addError(error, DDC$RT.cast(stackTrace, dynamic, StackTrace,
      "CastGeneral", """line 196, column 25 of dart:async/stream_pipe.dart: """,
      stackTrace is StackTrace, true));
}
...
class _MapStream<S, T> extends _ForwardingStream<S, T> {
  ...
  void _handleData(S inputEvent, _EventSink<T> sink) {
    T outputEvent;
    try {
      outputEvent = ((__x109) => DDC$RT.cast(__x109, dynamic, T, "CastGeneral",
          """line 235, column 21 of dart:async/stream_pipe.dart: """,
          __x109 is T, false))(_transform(inputEvent));
    } catch (e, s) {
      _addErrorWithReplacement(sink, e, s);
      return;
    }
    ...
    if (identical(_previous, _SENTINEL)) {
      ...
      try {
        if (_equals == null) {
          ...
          isEqual = _equals(DDC$RT.cast(_previous, dynamic, T, "CastGeneral",
              """line 426, column 29 of dart:async/stream_pipe.dart: """,
              _previous is T, false), inputEvent);
        }
      } catch (e, s) {
        _addErrorWithReplacement(sink, e, s);
        return null;
