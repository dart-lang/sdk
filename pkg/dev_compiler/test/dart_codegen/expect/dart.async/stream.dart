...
abstract class Stream<T> {
  ...
  factory Stream.eventTransformed(
    ...
    return ((__x42) => DDC$RT.cast(__x42,
        ...
        __x42 is Stream<T>, false))(new _BoundSinkStream(source, mapSink));
  }
  ...
  Future<T> reduce(T combine(T previous, T element)) {
    ...
    subscription = this.listen((T element) {
      if (seenFirst) {
        _runUserCode(() => combine(value, element), ((__x48) => DDC$RT.wrap(
            (dynamic f(T __u43)) {
          dynamic c(T x0) => f(DDC$RT.cast(x0, dynamic, T, "CastParam",
              """line 500, column 24 of dart:async/stream.dart: """, x0 is T,
              false));
          return f == null ? null : c;
        }, __x48, DDC$RT.type((__t46<T> _) {}), __t44, "WrapLiteral",
            """line 500, column 24 of dart:async/stream.dart: """,
            __x48 is __t44))((T newValue) {
          value = newValue;
        }), ((__x52) => DDC$RT.cast(__x52, dynamic, __t49, "CastGeneral",
  ...
  Future fold(var initialValue, combine(var previous, T element)) {
    ...
    subscription = this.listen((T element) {
      _runUserCode(() => combine(value, element), (newValue) {
        value = newValue;
      }, ((__x53) => DDC$RT.cast(__x53, dynamic, __t49, "CastGeneral",
          """line 534, column 11 of dart:async/stream.dart: """, __x53 is __t49,
          false))(_cancelAndErrorClosure(subscription, result)));
    }, onError: (e, st) {
  ...
  Future<bool> contains(Object needle) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T element) {
      _runUserCode(() => (element == needle), ((__x57) => DDC$RT.wrap(
          (dynamic f(bool __u54)) {
        dynamic c(bool x0) => f(DDC$RT.cast(x0, dynamic, bool, "CastParam",
            """line 597, column 13 of dart:async/stream.dart: """, x0 is bool,
            true));
        return f == null ? null : c;
      }, __x57, __t55, __t44, "WrapLiteral",
          """line 597, column 13 of dart:async/stream.dart: """,
          __x57 is __t44))((bool isMatch) {
        if (isMatch) {
          _cancelAndValue(subscription, future, true);
        }
      }), ((__x58) => DDC$RT.cast(__x58, dynamic, __t49, "CastGeneral",
          """line 602, column 13 of dart:async/stream.dart: """, __x58 is __t49,
  ...
  Future forEach(void action(T element)) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T element) {
      _runUserCode(() => action(element), (_) {}, ((__x59) => DDC$RT.cast(__x59,
          dynamic, __t49, "CastGeneral",
          """line 628, column 13 of dart:async/stream.dart: """, __x59 is __t49,
          false))(_cancelAndErrorClosure(subscription, future)));
    }, onError: future._completeError, onDone: () {
  ...
  Future<bool> every(bool test(T element)) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T element) {
      _runUserCode(() => test(element), ((__x61) => DDC$RT.wrap(
          (dynamic f(bool __u60)) {
        dynamic c(bool x0) => f(DDC$RT.cast(x0, dynamic, bool, "CastParam",
            """line 652, column 13 of dart:async/stream.dart: """, x0 is bool,
            true));
        return f == null ? null : c;
      }, __x61, __t55, __t44, "WrapLiteral",
          """line 652, column 13 of dart:async/stream.dart: """,
          __x61 is __t44))((bool isMatch) {
        if (!isMatch) {
          _cancelAndValue(subscription, future, false);
        }
      }), ((__x62) => DDC$RT.cast(__x62, dynamic, __t49, "CastGeneral",
          """line 657, column 13 of dart:async/stream.dart: """, __x62 is __t49,
          false))(_cancelAndErrorClosure(subscription, future)));
    }, onError: future._completeError, onDone: () {
  ...
  Future<bool> any(bool test(T element)) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T element) {
      _runUserCode(() => test(element), ((__x64) => DDC$RT.wrap(
          (dynamic f(bool __u63)) {
        dynamic c(bool x0) => f(DDC$RT.cast(x0, dynamic, bool, "CastParam",
            """line 689, column 13 of dart:async/stream.dart: """, x0 is bool,
            true));
        return f == null ? null : c;
      }, __x64, __t55, __t44, "WrapLiteral",
          """line 689, column 13 of dart:async/stream.dart: """,
          __x64 is __t44))((bool isMatch) {
        if (isMatch) {
          _cancelAndValue(subscription, future, true);
        }
      }), ((__x65) => DDC$RT.cast(__x65, dynamic, __t49, "CastGeneral",
          """line 694, column 13 of dart:async/stream.dart: """, __x65 is __t49,
          false))(_cancelAndErrorClosure(subscription, future)));
    }, onError: future._completeError, onDone: () {
      future._complete(false);
    }, cancelOnError: true);
  ...
  Stream<T> takeWhile(bool test(T element)) {
    return ((__x67) => DDC$RT.cast(__x67,
        ...
        __x67 is Stream<T>, false))(new _TakeWhileStream(this, test));
  }
  Stream<T> skip(int count) {
    return ((__x68) => DDC$RT.cast(__x68,
        ...
        __x68 is Stream<T>, false))(new _SkipStream(this, count));
  }
  Stream<T> skipWhile(bool test(T element)) {
    return ((__x69) => DDC$RT.cast(__x69,
        ...
        __x69 is Stream<T>, false))(new _SkipWhileStream(this, test));
  }
  Stream<T> distinct([bool equals(T previous, T next)]) {
    return ((__x70) => DDC$RT.cast(__x70,
        ...
        __x70 is Stream<T>, false))(new _DistinctStream(this, equals));
  }
  Future<T> get first {
  ...
  Future<dynamic> firstWhere(bool test(T element), {Object defaultValue()}) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T value) {
      _runUserCode(() => test(value), ((__x72) => DDC$RT.wrap(
          (dynamic f(bool __u71)) {
        dynamic c(bool x0) => f(DDC$RT.cast(x0, dynamic, bool, "CastParam",
            """line 1031, column 11 of dart:async/stream.dart: """, x0 is bool,
            true));
        return f == null ? null : c;
      }, __x72, __t55, __t44, "WrapLiteral",
          """line 1031, column 11 of dart:async/stream.dart: """,
          __x72 is __t44))((bool isMatch) {
        if (isMatch) {
          _cancelAndValue(subscription, future, value);
        }
      }), ((__x73) => DDC$RT.cast(__x73, dynamic, __t49, "CastGeneral",
  ...
  Future<dynamic> lastWhere(bool test(T element), {Object defaultValue()}) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T value) {
      _runUserCode(() => true == test(value), ((__x75) => DDC$RT.wrap(
          (dynamic f(bool __u74)) {
        dynamic c(bool x0) => f(DDC$RT.cast(x0, dynamic, bool, "CastParam",
            """line 1071, column 11 of dart:async/stream.dart: """, x0 is bool,
            true));
        return f == null ? null : c;
      }, __x75, __t55, __t44, "WrapLiteral",
          """line 1071, column 11 of dart:async/stream.dart: """,
          __x75 is __t44))((bool isMatch) {
        if (isMatch) {
          foundResult = true;
          result = value;
        }
      }), ((__x76) => DDC$RT.cast(__x76, dynamic, __t49, "CastGeneral",
  ...
  Future<T> singleWhere(bool test(T element)) {
    ...
    StreamSubscription subscription;
    subscription = this.listen((T value) {
      _runUserCode(() => true == test(value), ((__x78) => DDC$RT.wrap(
          (dynamic f(bool __u77)) {
        dynamic c(bool x0) => f(DDC$RT.cast(x0, dynamic, bool, "CastParam",
            """line 1115, column 11 of dart:async/stream.dart: """, x0 is bool,
            true));
        return f == null ? null : c;
      }, __x78, __t55, __t44, "WrapLiteral",
          """line 1115, column 11 of dart:async/stream.dart: """,
          __x78 is __t44))((bool isMatch) {
        if (isMatch) {
          if (foundResult) {
            try {
              throw IterableElementError.tooMany();
      ...
      }), ((__x79) => DDC$RT.cast(__x79, dynamic, __t49, "CastGeneral",
  ...
  Stream timeout(Duration timeLimit, {void onTimeout(EventSink sink)}) {
    ...
    void onData(T event) {
      ...
      timer = zone.createTimer(timeLimit, DDC$RT.cast(timeout, Function, __t80,
          "CastGeneral", """line 1219, column 43 of dart:async/stream.dart: """,
          timeout is __t80, false));
    }
    ...
    void onListen() {
      ...
      if (onTimeout == null) {
        ...
        onTimeout = zone.registerUnaryCallback(DDC$RT.wrap(
            (void f(EventSink<dynamic> __u81)) {
        ...
        timeout = () {
          ...
          zone.runUnaryGuarded(DDC$RT.wrap((void f(EventSink<dynamic> __u84)) {
            void c(EventSink<dynamic> x0) => f(DDC$RT.cast(x0, dynamic,
                DDC$RT.type((EventSink<dynamic> _) {}), "CastParam",
