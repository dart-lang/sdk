...
Set<String> linkedIdentitySet = new LinkedHashSet<String>(equals: identical, hashCode: identityHashCode);
Set<String> linkedCustomSet = new LinkedHashSet<String>(equals: (a, b) => a == b, hashCode: (o) => o.hashCode, isValidKey: (o) => true);
