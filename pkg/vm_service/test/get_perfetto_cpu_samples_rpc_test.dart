...
import 'get_perfetto_cpu_samples_rpc_lib.dart' as testee_lib;

void main([args = const <String>[]]) => IsolateTestHarness(
      'get_perfetto_cpu_samples_rpc_lib.dart',
      args,
    )
        .hasStoppedAtExit()
          ...
          expect(
            packet.sequenceFlags &
                    TracePacket_SequenceFlags
                        .SEQ_NEEDS_INCREMENTAL_STATE.value !=
                0,
            isTrue,
          );
          expect(
            packet.perfSample.callstackIid.toInt(),
            isIn(seenCallstacks),
          );
        }
      }
