...
import 'get_flag_list_rpc_lib.dart' as testee_lib;
...
void main([args = const <String>[]]) =>
    VMTestHarness('get_flag_list_rpc_lib.dart', args).addTest(
      ...
      (VmService service) async {
        final Error result =
            (await service.setFlag('random_seed', '42')) as Error;
      ...
      (VmService service) async {
        ...
        expect(
          await getFlagValue(service, kProfilePeriod),
          kValue.toString(),
        );
