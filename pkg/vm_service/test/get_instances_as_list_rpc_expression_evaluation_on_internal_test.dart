...
import 'get_instances_as_list_rpc_expression_evaluation_on_internal_lib.dart'
    as testee_lib;

void main([args = const <String>[]]) => IsolateTestHarness(
      'get_instances_as_list_rpc_expression_evaluation_on_internal_lib.dart',
      args,
      ...
      Future<void> getInstancesAndExecuteExpression(
        ...
        await service
            .evaluate(isolateId, result.id!, 'this')
            .catchError((error) {
          if (error.code == 113 &&
