...
import 'coverage_closure_call_after_optimization_lib.dart' as testee_lib;

const optimizationCounterThreshold = 10;

void main(List<String> args) => IsolateTestHarness(
      'coverage_closure_call_after_optimization_lib.dart',
      args,
    )
        ...
        .addCustomTest((VmService service, IsolateRef isolateRef) async {
          ...
          final rootLib = await service.getObject(
            ...
            isolate.libraries!
                .firstWhere((l) => l.uri!
                    .contains('coverage_closure_call_after_optimization_lib'))
                .id!,
          ) as Library;
          final funcRef =
          ...
          expect(
            scripts[0].uri,
            endsWith('coverage_closure_call_after_optimization_lib.dart'),
          );
        })
        .resumeIsolate()
        .hasStoppedAtBreakpoint()
