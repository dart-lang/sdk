...
import 'pause_on_unhandled_async_exceptions2_lib.dart' as testee_lib;

void main([args = const <String>[]]) =>
    IsolateTestHarness('pause_on_unhandled_async_exceptions2_lib.dart', args)
      ...
      expect(asyncStack[3].location!.line, lineA);
    }).run(
