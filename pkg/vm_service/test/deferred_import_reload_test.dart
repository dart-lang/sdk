...
import 'deferred_import_reload_lib.dart' as testee_lib;
...
void main([args = const <String>[]]) =>
    IsolateTestHarness('deferred_import_reload_lib.dart', args)
        ...
        .addCustomTest((VmService service, IsolateRef mainIsolate) async {
      // Grab the VM.
