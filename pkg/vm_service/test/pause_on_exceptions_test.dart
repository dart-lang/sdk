...
import 'pause_on_exceptions_lib.dart' as testee_lib;

void main([args = const <String>[]]) =>
    IsolateTestHarness('pause_on_exceptions_lib.dart', args)
        .addCustomTest((VmService service, IsolateRef isolateRef) async {
      final isolate = await service.getIsolate(isolateRef.id!);
      final lib = await service.getObject(
          isolateRef.id!,
          isolate.libraries!
              .firstWhere((l) => l.uri!.contains('pause_on_exceptions_lib'))
              .id!);
