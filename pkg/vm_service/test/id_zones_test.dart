...
import 'id_zones_lib.dart' as testee_lib;
...
void main([args = const <String>[]]) => IsolateTestHarness(
      ...
      args,
        ...
        .addCustomTest((VmService service, IsolateRef isolateRef) async {
          ...
          expect(
              idZone1.idAssignmentPolicy, IdAssignmentPolicy.kAlwaysAllocate);
        ...
        .addCustomTest((VmService service, IsolateRef isolateRef) async {
          ...
          expect(
              idZone2.idAssignmentPolicy, IdAssignmentPolicy.kAlwaysAllocate);
        ...
        .addCustomTest((VmService service, IsolateRef isolateRef) async {
          ...
          expect(
              idZone4.idAssignmentPolicy, IdAssignmentPolicy.kAlwaysAllocate);
        ...
        .addCustomTest((VmService service, IsolateRef isolateRef) async {
          ...
          expect(
              idZone5.idAssignmentPolicy, IdAssignmentPolicy.kAlwaysAllocate);
          ...
          final dLiteralInstanceRef = await service.evaluate(
            isolateId,
            isolate.libraries!
                .firstWhere((l) => l.uri!.contains('id_zones_lib'))
                .id!,
            'getDLiteral()',
            idZoneId: idZone5.id,
          ) as InstanceRef;
          ...
          expect(
              (boundVariables.first.value as InstanceRef).id, 'objects/11/5');
