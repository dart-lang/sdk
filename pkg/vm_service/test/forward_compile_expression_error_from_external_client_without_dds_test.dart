...
import 'forward_compile_expression_error_from_external_client_without_dds_lib.dart'
    as testee_lib;

void main([args = const <String>[]]) => IsolateTestHarness(
      'forward_compile_expression_error_from_external_client_without_dds_lib.dart',
      args,
    )
        .hasStoppedAtExit()
        ...
        await primaryClient.evaluate(
          ...
          isolate.libraries!
              .firstWhere((l) => l.uri!.contains(
                  'forward_compile_expression_error_from_external_client_without_dds_lib'))
              .id!,
          '123',
        );
