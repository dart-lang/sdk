...
import 'get_object_rpc_lib.dart' as testee_lib;

void main([args = const <String>[]]) => IsolateTestHarness(
      'get_object_rpc_lib.dart',
      args,
    )
      ...
      final evalResult = await service.invoke(
        isolateId,
        isolate.libraries!
            .firstWhere((l) => l.uri!.contains('get_object_rpc_lib'))
            .id!,
        'getChattanooga',
        [],
      ) as InstanceRef;
      ...
      expect(result.name, equals('get_object_rpc'));
      expect(result.uri, startsWith('file:'));
      expect(result.uri, endsWith('get_object_rpc_lib.dart'));
      ...
      final libResult = await service.getObject(
          isolateId,
          isolate.libraries!
              .firstWhere((l) => l.uri!.contains('get_object_rpc_lib'))
              .id!) as Library;
      ...
      expect(
        (fieldsMap['dummyList'] as InstanceRef).kind,
        InstanceKind.kList,
      );
      ...
      final derivedClass = await service.getObject(
        isolateId,
        invokeResult.classRef!.id!,
      ) as Class;
      ...
      final dummyClassWithTwoMixinsApplied = await service.getObject(
        isolateId,
        dummyClass.superClass!.id!,
      ) as Class;
      ...
      expect(
        dummyBaseMixinClassJson['_vmName'],
        startsWith('_DummyBaseMixin@'),
      );
      ...
      final funcId = superClass.functions!
          .firstWhere((f) => f.name == 'dummyFunction')
          .id!;
      ...
      final objectId =
          '${evalResult.classRef!.id!}/field_inits/dummyVarWithInit';
      final result = await service.getObject(isolateId, objectId) as Func;
      expect(result.id, equals(objectId));
