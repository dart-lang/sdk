...
//
// dart pkg/vm_service/test/update_line_numbers.dart pkg/vm_service/test/step_through_mixin_from_sdk_test.dart
//
const LINE_A = 22;
// AUTOGENERATED END
...
const expected = <String>[
  ...
  'list.dart:87:25', // on parameter to 'contains'
  'list.dart:88:16',
  'list.dart:88:23', // on 'length' in 'this.length'
  'list.dart:89:16', // on '=' in 'i = 0'
  'list.dart:89:23', // on '<' in 'i < length'
  'list.dart:90:15', // on '[' in 'this[i]'
  '$file:${LINE_A + 13}:23', // on parameter in 'operator []'
  '$file:${LINE_A + 14}:5', // on 'return'
  'list.dart:90:19', // on '=='
  'list.dart:91:26', // on 'length' in 'this.length'
  'list.dart:91:18', // on '!='
  'list.dart:89:34', // on '++' in 'i++'
  'list.dart:89:23', // on '<' in 'i < length'
  'list.dart:95:5', // on 'return'
