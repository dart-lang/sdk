...
import 'set_reload_and_reset_breakpoints_lib.dart' as testee_lib;

void main([args = const <String>[]]) => IsolateTestHarness(
      'set_reload_and_reset_breakpoints_lib.dart',
      args,
    )
...
''');
        ...
        for (int i = numberOfBreakpoints + 1;
            i <= numberOfBreakpoints * 2;
            i++) {
          await service.removeBreakpoint(spawnedIsolateId, 'breakpoints/$i');
        }
