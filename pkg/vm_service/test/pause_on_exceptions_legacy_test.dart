...
import 'pause_on_exceptions_legacy_lib.dart' as testee_lib;

void main([args = const <String>[]]) =>
    IsolateTestHarness('pause_on_exceptions_legacy_lib.dart', args)
        .addCustomTest((service, isolateRef) async {
      final isolate = await service.getIsolate(isolateRef.id!);
      final lib = await service.getObject(
          isolateRef.id!,
          isolate.libraries!
              .firstWhere(
                  (l) => l.uri!.contains('pause_on_exceptions_legacy_lib'))
              .id!);
