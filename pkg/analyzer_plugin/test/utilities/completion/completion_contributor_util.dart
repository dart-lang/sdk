...
abstract class DartCompletionContributorTest extends AbstractContextTest {
  ...
  void assertHasParameterInfo(CompletionSuggestion suggestion) {
    ...
    expect(
      suggestion.parameterNames!.length,
      suggestion.parameterTypes!.length,
    );
    expect(
  ...
  CompletionSuggestion assertSuggest(
    String completion, {
  ...
  CompletionSuggestion assertSuggestClass(
    String name, {
    int relevance = DART_RELEVANCE_DEFAULT,
  ...
  CompletionSuggestion assertSuggestClassTypeAlias(
    String name, {
    int relevance = DART_RELEVANCE_DEFAULT,
    CompletionSuggestionKind kind = CompletionSuggestionKind.INVOCATION,
  }) {
  ...
  CompletionSuggestion assertSuggestConstructor(
    String name, {
    int relevance = DART_RELEVANCE_DEFAULT,
    int? elemOffset,
    String defaultArgListString = _UNCHECKED,
  ...
  CompletionSuggestion assertSuggestEnum(
    String completion, {
    bool isDeprecated = false,
  }) {
  ...
  CompletionSuggestion assertSuggestEnumConst(
    String completion, {
    int relevance = DART_RELEVANCE_DEFAULT,
    bool isDeprecated = false,
  }) {
  ...
  CompletionSuggestion assertSuggestField(
    String name,
    String? type, {
    int relevance = DART_RELEVANCE_DEFAULT,
    CompletionSuggestionKind kind = CompletionSuggestionKind.INVOCATION,
  ...
  CompletionSuggestion assertSuggestFunction(
    String name,
    String? returnType, {
    CompletionSuggestionKind kind = CompletionSuggestionKind.INVOCATION,
    bool isDeprecated = false,
  ...
  CompletionSuggestion assertSuggestGetter(
    String name,
    String? returnType, {
    int relevance = DART_RELEVANCE_DEFAULT,
    CompletionSuggestionKind kind = CompletionSuggestionKind.INVOCATION,
  ...
  CompletionSuggestion assertSuggestSetter(
    String name, {
    int relevance = DART_RELEVANCE_DEFAULT,
    CompletionSuggestionKind kind = CompletionSuggestionKind.INVOCATION,
  }) {
  ...
  Future computeSuggestions() async {
    ...
    request = DartCompletionRequestImpl(
      resourceProvider,
      completionOffset!,
      result,
    );
  ...
  Future<E> performAnalysis<E>(int times, Completer<E> completer) {
    ...
    return Future.delayed(
      Duration.zero,
      () => performAnalysis(times - 1, completer),
    );
  }
