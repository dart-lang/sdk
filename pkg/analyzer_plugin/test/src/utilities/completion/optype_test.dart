...
abstract class AbstractOpTypeTest extends AbstractContextTest {
  ...
  Future<void> assertOpType({
    ...
    var completionTarget = CompletionTarget.forOffset(
      resolvedUnit.unit,
      completionOffset,
    );
    ...
    //
    var isValid =
        opType.includeCaseLabelSuggestions == caseLabel &&
...
''');
  ...
  Future<void> test_asExpression_rightHandSide() async {
    ...
    await assertOpType(
      completionLocation: 'AsExpression_type',
      typeNames: true,
    );
  }
  ...
  Future<void> test_block_final() async {
    ...
    await assertOpType(
      completionLocation: 'VariableDeclarationList_type',
      typeNames: true,
    );
  }
  ...
  Future<void> test_constructorDeclaration_factory_named() async {
    // ConstructorDeclaration
    addTestSource('class A { factory A^.b() {} }');
    await assertOpType(
      completionLocation: 'ConstructorDeclaration_returnType',
      typeNames: true,
    );
...
''');
  ...
  Future<void> test_expressionStatement_name() async {
    ...
    await assertOpType(
      completionLocation: 'ExpressionStatement_expression',
      varNames: true,
    );
  }
  ...
  Future<void> test_extendsClause_beginning() async {
    ...
    await assertOpType(
      completionLocation: 'ExtendsClause_superclass',
      typeNames: true,
    );
  }
  ...
  Future<void> test_extensionDeclaration_body_atBeginning() async {
    ...
    await assertOpType(
      completionLocation: 'ExtensionDeclaration_member',
      typeNames: true,
    );
  }
  ...
  Future<void> test_extensionOnClause_extendedType() async {
    ...
    await assertOpType(
      completionLocation: 'ExtensionOnClause_extendedType',
      typeNames: true,
    );
  }
...
''');
  ...
  Future<void> test_forEachStatement_loopVariable() async {
    ...
    await assertOpType(
      completionLocation: 'ForStatement_forLoopParts',
      typeNames: true,
    );
  }
  ...
  Future<void> test_forElement_forEachParts_type() async {
    ...
    await assertOpType(
      completionLocation: 'ForElement_forLoopParts',
      typeNames: true,
    );
  }
  ...
  Future<void> test_formalParameterList_empty() async {
    ...
    addTestSource('class A {a(^) { }}');
    await assertOpType(
      completionLocation: 'FormalParameterList_parameter',
      typeNames: true,
    );
  }
  ...
  Future<void> test_functionDeclaration_name1() async {
    ...
    await assertOpType(
      completionLocation: 'CompilationUnit_directive',
      typeNames: true,
    );
  }
...
^ zoo(z) {} String name;''');
  ...
  Future<void> test_functionDeclaration_returnType_afterLineDocComment() async {
    ...
    addTestSource('''
      ...
      ^ zoo(z) { } String name;''');
    await assertOpType(
      completionLocation: 'FunctionDeclaration_returnType',
      typeNames: true,
    );
  }
...
''');
  ...
  Future<void> test_implementsClause_beginning() async {
    ...
    await assertOpType(
      completionLocation: 'ImplementsClause_interface',
      typeNames: true,
    );
  }
  ...
  Future<void> test_isExpression_type_empty() async {
    ...
    await assertOpType(
      completionLocation: 'IsExpression_type',
      typeNames: true,
    );
  }
...
''');
    ...
    //  'ClassDeclaration_member'.
    await assertOpType(
      completionLocation: 'MethodDeclaration_returnType',
      typeNames: true,
    );
  }
...
''');
  ...
  Future<void> test_methodDeclaration_inMixin1() async {
    ...
    await assertOpType(
      completionLocation: 'MixinDeclaration_member',
      typeNames: true,
    );
  }
...
''');
  ...
  Future<void> test_recordLiteral_fieldName() async {
    ...
    await assertOpType(completionLocation: 'RecordLiteral_fields');
  }
...
''');
  ...
  Future<void> test_tryStatement_catch_5a() async {
    ...
    await assertOpType(
      completionLocation: 'CatchClause_exceptionType',
      typeNames: true,
    );
  }
  ...
  Future<void> test_typeArgumentList_empty() async {
    ...
    await assertOpType(
      completionLocation: 'TypeArgumentList_argument',
      typeNames: true,
    );
  }
  ...
  Future<void> test_withClause_empty() async {
    ...
    await assertOpType(
      completionLocation: 'WithClause_mixinType',
      typeNames: true,
    );
  }
}
