...
void main() {
  ...
  test("'mode' is parsed from builder name", () {
    expectTestedConfigurations(
      ...
      ["foo-x64-none-debug-d8-linux", "foo-x64-none-release-d8-linux"],
    );
  });
  ...
  test("'runtime' is parsed from builder name", () {
    expectTestedConfigurations(
      ...
      ["foo-x64-none-debug-d8-linux", "foo-x64-none-debug-vm-linux"],
    );
  });
  ...
  test("'runtime' is not implied by builder name", () {
    expectFormatError(r"Undefined value for 'runtime' in "
...
void expectTestedConfigurations(
  ...
  expect(
    builders.map((b) => b.steps[0].testedConfiguration!.name).toList(),
