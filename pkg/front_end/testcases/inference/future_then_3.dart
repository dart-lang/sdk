...
void test(MyFuture f) {
  MyFuture<int> t1 = f.then((_) async => await new Future<int>.value(3));
  ...
  MyFuture<int> t5 = f.then((_) => new Future<int>.value(3));
  MyFuture<int> t6 = f.then((_) {
    return new Future<int>.value(3);
  });
  MyFuture<int> t7 = f.then((_) async => new Future<int>.value(3));
