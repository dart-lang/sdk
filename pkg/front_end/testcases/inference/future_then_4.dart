...
void test(MyFuture f) {
  MyFuture<int> t1 = f.then((_) async => await new MyFuture<int>.value(3));
  ...
  MyFuture<int> t5 = f.then((_) => new MyFuture<int>.value(3));
  MyFuture<int> t6 = f.then((_) {
    return new MyFuture<int>.value(3);
  });
  MyFuture<int> t7 = f.then((_) async => new MyFuture<int>.value(3));
