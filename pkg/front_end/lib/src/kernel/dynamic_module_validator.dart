...
class _DynamicModuleValidator extends RecursiveVisitor {
    ...
    if (!_isFromDynamicModule(target) &&
      ...
      switch (target) {
        ...
        case Member():
          ...
          loader.addProblem(
            codeMemberShouldBeListedAsCallableInDynamicInterface.withArguments(
              name,
            ),
            node.fileOffset,
            noLength,
        ...
        case Class():
          loader.addProblem(
            codeClassShouldBeListedAsCallableInDynamicInterface.withArguments(
              target.name,
            ),
            node.fileOffset,
            noLength,
  ...
  void _verifyExtendable(Supertype base, Class node) {
    ...
    if (!_isFromDynamicModule(baseClass) &&
      ...
      loader.addProblem(
        codeClassShouldBeListedAsExtendableInDynamicInterface.withArguments(
          baseClass.name,
        ),
        node.fileOffset,
        noLength,
