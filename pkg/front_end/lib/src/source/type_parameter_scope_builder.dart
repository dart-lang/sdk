...
void _computeBuildersFromFragment(Fragment fragment,
  ...
  switch (fragment) {
    ...
    case FieldFragment():
      ...
      builders.add(new _AddBuilder(
          fragment.name, fieldBuilder, fragment.fileUri, fragment.charOffset));
    ...
    case GetterFragment():
      ...
      bool isAugmentation =
          enclosingLibraryBuilder.isAugmenting && fragment.modifiers.isAugment;
...
class LibraryNameSpaceBuilder {
  ...
  NameSpace toNameSpace({
    ...
    for (Fragment fragment in _fragments) {
      ...
      _computeBuildersFromFragment(fragment,
