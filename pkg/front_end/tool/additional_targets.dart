...
import 'package:vm/modular/target/install.dart'
    as vm_target_install
...
void installAdditionalTargets() {
  ...
  // ../../messages.yaml.
  targets["dart2js"] = (TargetFlags flags) =>
      new Dart2jsTarget("dart2js", flags);
  targets["dart2js_server"] = (TargetFlags flags) =>
      new Dart2jsTarget("dart2js_server", flags);
