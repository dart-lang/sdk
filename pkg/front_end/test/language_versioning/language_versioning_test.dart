...
Future<void> main(List<String> args) async {
  ...
  TestConfigWithLanguageVersion cfeConfig = new TestConfigWithLanguageVersion(
    cfeMarker,
    "cfe",
  );
...
class LanguageVersioningDataComputer extends CfeDataComputer<Features> {
  ...
  Future<void> inspectTestResultData(CfeTestResultData testResultData) async {
    ...
    for (Library library in component.libraries) {
      ...
      Version lvFile = (await lv.languageVersionForUri(
        library.fileUri,
        options,
      )).version;
      Version lvImportUri = (await lv.languageVersionForUri(
        library.importUri,
        options,
      )).version;
...
class LanguageVersioningDataExtractor extends CfeDataExtractor<Features> {
  ...
  Features computeLibraryValue(Id id, Library library) {
    ...
    if (libraryBuilder is SourceLibraryBuilder &&
      ...
      features[Tags.packageUri] = libraryBuilder.packageUriForTesting
          .toString();
    }
    return features;
  }
