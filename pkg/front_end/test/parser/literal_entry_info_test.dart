...
class CollectionElementTest {
  ...
  void test_expression() {
    parseEntry('[ x', [
      ...
      'handleSendWithoutArguments x x ]',
      'handleLiteralList 1, [, null, ]',
    ]);
  }
  ...
  void test_for() {
    parseEntry('[ for (var i = 0; i < 10; ++i) 2', [
      ...
      'handleSendWithoutArguments i i <',
  ...
  void test_ifForElseIfFor() {
    parseEntry('[ if (true) for (a in b) 2 else if (c) for (d in e) 5', [
      ...
      'beginForControlFlow null for',
      'handleIdentifier a expression',
      'handleSendWithoutArguments a a in',
      'handleForInitializerExpressionStatement a',
      'beginForInExpression b',
      'handleIdentifier b expression',
      'handleSendWithoutArguments b b )',
      'endForInExpression )',
      'handleForInLoopParts null for ( in',
      // if-for-entry
      'handleLiteralInt 2',
...
class TestInfoListener implements Listener {
  ...
  void handleSendWithoutArguments(
    ...
    calls.add('handleSendWithoutArguments $beginToken $endToken $nextToken');
  }

  @override
  void handleInvocationWithoutTypeArguments(Token beginToken, Token endToken) {
    calls.add('handleInvocationWithoutTypeArguments $beginToken $endToken');
  }
