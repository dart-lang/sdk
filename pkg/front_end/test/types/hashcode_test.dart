...
void test1() {
  ...
  Expect.equals(
    voidToR1.hashCode,
    voidToR2.hashCode,
    "Hash code mismatch for voidToR1 vs voidToR2.",
  ); // true
  Expect.equals(voidToR3, voidToR2); // true
  Expect.equals(
    voidToR2.hashCode,
    voidToR3.hashCode,
    "Hash code mismatch for voidToR2 vs voidToR3.",
  ); // true, good!
  ...
  Expect.equals(
    voidToR2.hashCode,
    voidToR4.hashCode,
    "Hash code mismatch for voidToR2 vs voidToR4.",
  ); // false, oh no!
}
...
void test2() {
  ...
  Expect.equals(
    outer1.hashCode,
    outer2.hashCode,
    "Hash code mismatch for outer1 vs outer2.",
  ); // false, on no!
}
