...
void main() {
  ...
  Class objectClass = new Class(name: "Object", fileUri: dartCoreUri)
    ..parent = dartCoreLib;
  Supertype objectSuper = new Supertype(objectClass, DartTypeList.empty);
  Class boolClass = new Class(
    name: "bool",
    supertype: objectSuper,
    fileUri: dartCoreUri,
  )..parent = dartCoreLib;
  Class numClass = new Class(
    name: "num",
    supertype: objectSuper,
    fileUri: dartCoreUri,
  )..parent = dartCoreLib;
  Supertype numSuper = new Supertype(numClass, DartTypeList.empty);
  Class intClass = new Class(
    name: "int",
    supertype: numSuper,
    fileUri: dartCoreUri,
  )..parent = dartCoreLib;
  Class fooClass = new Class(
    name: "Foo",
    supertype: objectSuper,
    fileUri: myUri,
  )..parent = myLib;
  Class foo2Class = new Class(
    name: "Foo",
    supertype: objectSuper,
    fileUri: myUri,
  )..parent = myLib;
  ...
  DartType barVoid = new InterfaceType(
    barClass,
    Nullability.nonNullable,
    new DartTypeList(voidType),
  );
  check({barVoid: "Bar<void>"}, 1);

  DartType barObject = new InterfaceType(
    barClass,
    Nullability.nonNullable,
    new DartTypeList(object),
  );
  check({barObject: "Bar<Object>"}, 2);

  DartType barBarDynamic = new InterfaceType(
    barClass,
    Nullability.nonNullable,
    new DartTypeList(
      new InterfaceType(
  ...
  DartType parameterY = new TypeParameterType(
    new TypeParameter("Y"),
    Nullability.nonNullable,
  );
  DartType barY = new InterfaceType(
    barClass,
    Nullability.nonNullable,
    new DartTypeList(parameterY),
  );
  check({parameterY: "Y", barY: "Bar<Y>"}, 1);

  DartType bazFooBarBazDynamicVoid = new InterfaceType(
    bazClass,
    Nullability.nonNullable,
    new DartTypeList(
      foo,
      new InterfaceType(
        ...
        new DartTypeList(
          new InterfaceType(
            bazClass,
            Nullability.nonNullable,
            new DartTypeList(dynamicType, voidType),
          ),
        ),
      ),
    ),
  ...
  DartType bazFooFoo2 = new InterfaceType(
    bazClass,
    Nullability.nonNullable,
    new DartTypeList(foo, foo2),
  );
  check({bazFooFoo2: "Baz<Foo/*1*/, Foo/*2*/>"}, 3);

  DartType funVoid = new FunctionType(
    DartTypeList.empty,
    voidType,
    Nullability.nonNullable,
  );
  ...
  DartType funFooBarVoid = new FunctionType(
    new DartTypeList(foo),
    barVoid,
    Nullability.nonNullable,
  );
  check({funFooBarVoid: "Bar<void> Function(Foo)"}, 2);

  DartType funFooFoo2 = new FunctionType(
    new DartTypeList(foo),
    foo2,
    Nullability.nonNullable,
  );
  ...
  DartType funNamedObjectVoid = new FunctionType(
    ...
    voidType,
    Nullability.nonNullable,
    namedParameters: new NamedDartTypeList(new NamedType("obj", object)),
  );
  ...
  DartType funGeneric = new FunctionType(
    new DartTypeList(new StructuralParameterType(t, Nullability.nonNullable)),
  ...
  DartType funGenericObject = new FunctionType(
    ...
    new StructuralParameterType(tObject, Nullability.nonNullable),
    Nullability.nonNullable,
    typeParameters: new StructuralParameterList(tObject),
  );
  ...
  DartType funGenericFoo = new FunctionType(
    ...
    new StructuralParameterType(tFoo, Nullability.nonNullable),
    Nullability.nonNullable,
    typeParameters: new StructuralParameterList(tFoo),
  );
  check({funGenericFoo: "T Function<T extends Foo>(T)"}, 1);

  StructuralParameter tBar = new StructuralParameter(
    "T",
    dynamicType,
    dynamicType,
  );
  tBar.bound = new InterfaceType(
    barClass,
    Nullability.nonNullable,
    new DartTypeList(
  ...
  DartType funGenericBar = new FunctionType(
    ...
    new StructuralParameterType(tBar, Nullability.nonNullable),
    Nullability.nonNullable,
    typeParameters: new StructuralParameterList(tBar),
  );
  check({funGenericBar: "T Function<T extends Bar<T>>(T)"}, 1);

  // Add some members for testing instance constants
  Field booField = new Field.immutable(
    new Name("boo"),
    type: boolType,
    fileUri: fooClass.fileUri,
  );
  fooClass.fields.add(booField);
  Field valueField = new Field.immutable(
    new Name("value"),
    type: intType,
    fileUri: foo2Class.fileUri,
  );
  foo2Class.fields.add(valueField);
  Field nextField = new Field.immutable(
    new Name("next"),
    type: foo2,
    fileUri: foo2Class.fileUri,
  );
  foo2Class.fields.add(nextField);
  Field xField = new Field.immutable(
    new Name("x"),
    type: new TypeParameterType(
      bazClass.typeParameters[0],
      Nullability.nonNullable,
    ),
    fileUri: bazClass.fileUri,
  );
  bazClass.fields.add(xField);
  Field yField = new Field.immutable(
    new Name("y"),
    type: new TypeParameterType(
      bazClass.typeParameters[1],
      Nullability.nonNullable,
    ),
    fileUri: bazClass.fileUri,
  );
  ...
  Constant fooConst = new InstanceConstant(
    fooClass.reference,
    DartTypeList.empty,
    {booField.fieldReference: trueConst},
  );
  check({fooConst: "Foo {boo: true}"}, 1);

  Constant foo2Const = new InstanceConstant(
    foo2Class.reference,
    DartTypeList.empty,
    {nextField.fieldReference: nullConst, valueField.fieldReference: intConst},
  );
  check({foo2Const: "Foo {value: 2, next: null}"}, 1);

  Constant foo2nConst = new InstanceConstant(
    foo2Class.reference,
    DartTypeList.empty,
    {
      valueField.fieldReference: intConst,
      nextField.fieldReference: new InstanceConstant(
        foo2Class.reference,
        DartTypeList.empty,
        {
          valueField.fieldReference: intConst,
  ...
  Constant partialInstantiationConst = new InstantiationConstant(
    tearOffConst,
    new DartTypeList(intType),
  );
