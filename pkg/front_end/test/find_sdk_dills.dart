...
// This is a copy of pkg/kernel/test/binary/find_sdk_dills.dart - currently I
// don't think there's a good way of sharing it.
...
List<File> findSdkDills() {
  ...
  File exe = new File(resolvedExecutable ?? Platform.resolvedExecutable)
      .absolute;
  int steps = 0;
