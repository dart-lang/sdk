(module $module0
  ...
  (global $"stringValueNullable initialized" (mut i32) (i32.const 0))
  (global $stringValueNullable (mut (ref null $JSStringImpl)) (ref.null none))
  (global $"ktrue initialized" (mut i32) (i32.const 0))
  (global $ktrue (mut i32) (i32.const 0))
  (global $stringValue (mut (ref null $JSStringImpl)) (ref.null none))
  (global $"C358 \"a\"" (ref $JSStringImpl) (i32.const 4) (global.get $S.a) (struct.new $JSStringImpl))
