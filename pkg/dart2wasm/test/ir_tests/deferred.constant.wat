(module $module0
  ...
  (global $global26 (ref $#DummyStruct) <...>)
  (global $"C419 H0" (mut (ref null $H0))
    (ref.null none))
  (global $"C369 _FunctionType" (ref $_FunctionType) <...>)
  (global $"C374 globalH1Foo tear-off" (mut (ref null $#Closure-1-1))
    (ref.null none))
  (global $"C375 InstantiationConstant(globalH1Foo<int>)" (mut (ref null $#Closure-0-1))
    (ref.null none))
  (global $"C418 globalH0Foo tear-off" (mut (ref null $#Closure-0-1))
    (ref.null none))
  (global $global29 (ref $#Vtable-1-1) <...>)
  (global $"C373 _FunctionType" (ref $_FunctionType) <...>)
  (global $"C376 H1" (mut (ref null $H1))
    (ref.null none))
  (global $global32 (ref $#Vtable-0-1) <...>)
  (global $"C383 \"globalH1Bar<\"" (ref $JSStringImpl)
    (i32.const 4)
    (i32.const 0)
    (global.get $S.globalH1Bar<)
    (struct.new $JSStringImpl))
  (global $"C420 \"globalH0Foo\"" (ref $JSStringImpl)
    (i32.const 4)
    (i32.const 0)
    (global.get $S.globalH0Foo)
    (struct.new $JSStringImpl))
  (table $static1-0 (export "static1-0") 1 (ref null $type251))
  (table $static2-0 (export "static2-0") 1 (ref null $type248))
  ...
  (func $"C376 H1 (lazy initializer)}" (export "func0") (result (ref $H1))
    ...
    block $label0 (result (ref $#Closure-0-1))
      global.get $"C375 InstantiationConstant(globalH1Foo<int>)"
      br_on_non_null $label0
      i32.const 37
      i32.const 0
      block $label1 (result (ref $#Closure-1-1))
        global.get $"C374 globalH1Foo tear-off"
        br_on_non_null $label1
        i32.const 37
        i32.const 0
        global.get $global26
        ...
        local.tee $var0
        global.set $"C374 globalH1Foo tear-off"
        local.get $var0
      end $label1
      ...
      global.get $"C369 _FunctionType"
      struct.new $#Closure-0-1
      local.tee $var1
      global.set $"C375 InstantiationConstant(globalH1Foo<int>)"
      local.get $var1
    end $label0
    struct.new $H1
    local.tee $var2
  ...
  (func $"C419 H0 (lazy initializer)}" (result (ref $H0))
    (local $var0 (ref $#Closure-0-1))
    (local $var1 (ref $H0))
    i32.const 106
    i32.const 0
    block $label0 (result (ref $#Closure-0-1))
      global.get $"C418 globalH0Foo tear-off"
      br_on_non_null $label0
      i32.const 37
      i32.const 0
      global.get $global26
      ...
      struct.new $#Closure-0-1
      local.tee $var0
      global.set $"C418 globalH0Foo tear-off"
      local.get $var0
    end $label0
    struct.new $H0
    local.tee $var1
