(module $module2
  ...
  (global $"C476 globalH1Foo tear-off" (mut (ref null $#Closure-1-1))
    (ref.null none))
  (global $"C477 InstantiationConstant(globalH1Foo<int>)" (mut (ref null $#Closure-0-1))
    (ref.null none))
  (global $"C478 H1" (mut (ref null $H1))
    (ref.null none))
  (global $"C479 \"globalH1Bar<\"" (ref $JSStringImpl)
    (i32.const 4)
    (i32.const 0)
  ...
  (func $"C478 H1 (lazy initializer)}" (result (ref $H1))
    ...
    block $label0 (result (ref $#Closure-0-1))
      global.get $"C477 InstantiationConstant(globalH1Foo<int>)"
      br_on_non_null $label0
      i32.const 32
      i32.const 0
      block $label1 (result (ref $#Closure-1-1))
        global.get $"C476 globalH1Foo tear-off"
        br_on_non_null $label1
        i32.const 32
        i32.const 0
        global.get $global0
        global.get $global2
        global.get $"C475 _FunctionType"
        struct.new $#Closure-1-1
        local.tee $var0
        global.set $"C476 globalH1Foo tear-off"
        local.get $var0
      end $label1
      ...
      local.tee $var2
      global.set $"C477 InstantiationConstant(globalH1Foo<int>)"
      local.get $var2
    end $label0
    struct.new $H1
    local.tee $var3
