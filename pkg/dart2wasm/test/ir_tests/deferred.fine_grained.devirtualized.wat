(module $M
  ...
  (elem $cross-module-funcs-0
    ...
    (set 13 (ref.func $"wasm:js-string.concat (import)"))
    (set 14 (ref.func $JSStringImpl.fromRefUnchecked))
    (set 15 (ref.func $_throwIndexError))
    (set 16 (ref.func $JSStringImpl._interpolate))
    (set 17 (ref.func $JSStringImpl.*)))
  (func $Error._throwWithCurrentStackTrace (param $var0 (ref $#Top)) <...>)
  (func $IntegerDivisionByZeroException (result (ref $Object)) <...>)
  (func $JSStringImpl.* (param $var0 (ref $JSExternWrapper)) (param $var1 i64) (result (ref $JSExternWrapper)) <...>)
