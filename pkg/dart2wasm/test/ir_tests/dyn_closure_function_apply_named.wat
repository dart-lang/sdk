(module $module0
  ...
  (global $"bar tear-off" (ref $#Closure-0-2)
    ...
    (global.get $"WasmArray<_Type>[0]")
    (global.get $_TopType_294)
    (global.get $_InterfaceType_14)
    (global.get $_InterfaceType_301)
  ...
  (global $"foo tear-off" (ref $#Closure-0-2)
    ...
    (struct.new $_FunctionType)
    (struct.new $#Closure-0-2))
  (global $_InterfaceType_14 (ref $_InterfaceType) <...>)
  (global $_InterfaceType_301 (ref $_InterfaceType) <...>)
  (global $_TopType_294 (ref $_TopType) <...>)
