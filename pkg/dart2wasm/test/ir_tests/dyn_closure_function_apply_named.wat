(module $module0
  ...
  (global $"bar tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"bar tear-off trampoline_298")
    ...
    (global.get $"WasmArray<_Type>[0]")
    (global.get $_TopType_346)
    (global.get $_InterfaceType_30)
    (global.get $_InterfaceType_352)
  ...
  (global $"foo tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"foo tear-off trampoline_292")
    (struct.new $#Vtable-0-2)
    (i32.const 11)
    (i32.const 0)
    (i32.const 0)
  ...
  (global $_InterfaceType_352 (ref $_InterfaceType) <...>)
  (global $_TopType_346 (ref $_TopType) <...>)
  ...
  (func $bar tear-off trampoline_298 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
  ...
  (func $foo tear-off trampoline_292 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
)