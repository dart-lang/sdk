(module $module0
  ...
  (global $"bar tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"bar tear-off trampoline_151")
  ...
  (global $"foo tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"foo tear-off trampoline_145")
    (struct.new $#Vtable-0-2)
    (i32.const 11)
    (i32.const 0)
    (i32.const 0)
  ...
  (func $bar tear-off trampoline_151 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
  ...
  (func $foo tear-off trampoline_145 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
)