(module $module0
  ...
  (global $"bar tear-off" (ref $#Closure-0-2)
    ...
    (global.get $"WasmArray<_Type>[0]")
    (global.get $_TopType_353)
    (global.get $_InterfaceType_30)
    (global.get $_InterfaceType_359)
  ...
  (global $"foo tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"foo tear-off trampoline_327")
    (struct.new $#Vtable-0-2)
    (i32.const 12)
    (i32.const 0)
    (i32.const 0)
  ...
  (global $_InterfaceType_359 (ref $_InterfaceType) <...>)
  (global $_TopType_353 (ref $_TopType) <...>)
  ...
  (func $foo tear-off trampoline_327 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
)