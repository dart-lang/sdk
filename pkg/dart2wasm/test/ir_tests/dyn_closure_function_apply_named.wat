(module $module0
  ...
  (global $"C341 foo tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"foo tear-off trampoline_315")
  ...
  (func $foo tear-off trampoline_315 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
)