(module $module0
  ...
  (func $Bar (param $value (ref $JSStringImpl)) (result (ref $Bar)) <...>)
  (func $Baz (param $value (ref $JSStringImpl)) (result (ref $Baz)) <...>)
  (func $Foo (param $value (ref $JSStringImpl)) (result (ref $Foo)) <...>)
)