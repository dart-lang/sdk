(module $module0
  ...
  (type $Object <...>)
  (func $"dart2wasm._315 (import)" (import "dart2wasm" "_315") (param i32 i32) (result externref))
  (func $"dart2wasm._316 (import)" (import "dart2wasm" "_316") (param i64 i32) (result externref))
  ...
  (elem $cross-module-funcs-0
    ...
    (set 14 (ref.func $"dart2wasm._315 (import)"))
    (set 15 (ref.func $"dart2wasm._316 (import)"))
