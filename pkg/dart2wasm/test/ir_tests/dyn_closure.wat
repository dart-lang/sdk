(module $module0
  ...
  (global $"bar tear-off" (ref $#Closure-0-2)
    ...
    (ref.func $"bar tear-off trampoline_287")
  ...
  (func $bar tear-off trampoline_287 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
