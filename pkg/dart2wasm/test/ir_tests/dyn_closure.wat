(module $module0
  ...
  (global $"C353 bar tear-off" (ref $#Closure-0-2)
    (i32.const 32)
    (i32.const 0)
    (global.get $global0)
    (ref.func $"bar tear-off trampoline")
    (ref.func $"bar tear-off trampoline_322")
    (struct.new $#Vtable-0-2)
    (i32.const 12)
    (i32.const 0)
    (i32.const 0)
  ...
  (func $bar tear-off trampoline_322 (param $var0 (ref struct)) (param $var1 (ref null $#Top)) (param $var2 (ref null $#Top)) (result (ref null $#Top)) <...>)
