...
final List<Option> options = [
  ...
  StringOption("dump-cfg", (o, value) => o.translatorOptions.dumpCfg = value),
  ...
  StringMultiOption(
    "phases",
    (o, values) =>
        o.phases = [...values.map(CompilerPhase.parse)]
  ...
  Flag(
    "print-kernel",
    (o, value) => o.translatorOptions.printKernel = value,
    defaultsTo: _d.translatorOptions.printKernel,
  ),
  Flag(
    "print-wasm",
    (o, value) => o.translatorOptions.printWasm = value,
  ...
  Flag(
    "enable-asserts",
    (o, value) => o.translatorOptions.enableAsserts = value,
  ...
  IntOption(
    "inlining-limit",
    (o, value) => o.translatorOptions.inliningLimit = value,
  ...
  IntMultiOption(
    "watch",
    (o, values) => o.translatorOptions.watchPoints = values,
  ),
  StringMultiOption(
    "define",
    (o, values) => o.environment.addAll(processEnvironment(values)),
    abbr: "D",
    splitCommas: false,
  ),
  StringMultiOption(
  ...
  StringOption(
    ...
    (o, value) => o.dumpKernelAfterCfe = value,
    hide: true,
  ),
  StringOption(
    "dump-kernel-before-tfa",
    (o, value) => o.dumpKernelBeforeTfa = value,
    hide: true,
  ),
  StringOption(
    "dump-kernel-after-tfa",
    (o, value) => o.dumpKernelAfterTfa = value,
    hide: true,
  ),
  Flag(
...
WasmCompilerOptions parseArguments(List<String> arguments) {
  ...
  try {
    ...
    WasmCompilerOptions compilerOptions = WasmCompilerOptions(
      mainUri: resolveInputUri(rest[0]),
      outputFile: rest[1],
    );
    for (Option arg in options) {
