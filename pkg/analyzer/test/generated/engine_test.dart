...
//    JUnitTestCase.assertNotNullMsg("performAnalysisTask failed to compute an element model", _context.getLibraryElement(source));
  ...
  static dartSuite() {
    _ut.group('AnalysisContextImplTest', () {
      ...
      _ut.test(
          'test_computeDocumentationComment_singleLine_multiple_EOL_n',
          () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_computeDocumentationComment_singleLine_multiple_EOL_n);
      });
      _ut.test(
          'test_computeDocumentationComment_singleLine_multiple_EOL_rn',
          () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_computeDocumentationComment_singleLine_multiple_EOL_rn);
      });
      ...
      _ut.test('test_computeResolvableCompilationUnit_dart_exception', () {
        ...
        runJUnitTest(
            __test,
            __test.test_computeResolvableCompilationUnit_dart_exception);
      });
      _ut.test('test_computeResolvableCompilationUnit_html_exception', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_computeResolvableCompilationUnit_html_exception);
      });
      _ut.test('test_computeResolvableCompilationUnit_valid', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_computeResolvableCompilationUnit_valid);
      });
      ...
      _ut.test('test_getResolvedCompilationUnit_library_null', () {
        ...
        runJUnitTest(
            __test,
            __test.test_getResolvedCompilationUnit_library_null);
      });
      _ut.test('test_getResolvedCompilationUnit_source_dart', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_getResolvedCompilationUnit_source_dart);
      });
      _ut.test('test_getResolvedCompilationUnit_source_html', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_getResolvedCompilationUnit_source_html);
      });
      ...
      _ut.test('test_parseCompilationUnit_nonExistentSource', () {
        ...
        runJUnitTest(
            __test,
            __test.test_parseCompilationUnit_nonExistentSource);
      });
      ...
      _ut.test('test_performAnalysisTask_changeLibraryContents', () {
        ...
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_changeLibraryContents);
      });
      _ut.test('test_performAnalysisTask_changeLibraryThenPartContents', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_changeLibraryThenPartContents);
      });
      _ut.test('test_performAnalysisTask_changePartContents_makeItAPart', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_changePartContents_makeItAPart);
      });
      _ut.test('test_performAnalysisTask_changePartContents_makeItNotPart', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_changePartContents_makeItNotPart);
      });
      _ut.test(
          'test_performAnalysisTask_changePartContents_noSemanticChanges',
          () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_changePartContents_noSemanticChanges);
      });
      _ut.test('test_performAnalysisTask_importedLibraryAdd', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_importedLibraryAdd);
      });
      _ut.test('test_performAnalysisTask_importedLibraryAdd_html', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_importedLibraryAdd_html);
      });
      _ut.test('test_performAnalysisTask_importedLibraryDelete', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_importedLibraryDelete);
      });
      ...
      _ut.test('test_performAnalysisTask_modifiedAfterParse', () {
        ...
        runJUnitTest(
            __test,
            __test.test_performAnalysisTask_modifiedAfterParse);
      });
      _ut.test('test_resolveCompilationUnit_import_relative', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_resolveCompilationUnit_import_relative);
      });
      _ut.test('test_resolveCompilationUnit_import_relative_cyclic', () {
        final __test = new AnalysisContextImplTest();
        runJUnitTest(
            __test,
            __test.test_resolveCompilationUnit_import_relative_cyclic);
      });
      ...
      _ut.test('test_resolveCompilationUnit_sourceChangeDuringResolution', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveCompilationUnit_sourceChangeDuringResolution);
      });
      ...
      _ut.test('test_setAnalysisOptions_reduceAnalysisPriorityOrder', () {
        ...
        runJUnitTest(
            __test,
            __test.test_setAnalysisOptions_reduceAnalysisPriorityOrder);
      });
      ...
      _ut.test('test_setAnalysisPriorityOrder_lessThanCacheSize', () {
        ...
        runJUnitTest(
            __test,
            __test.test_setAnalysisPriorityOrder_lessThanCacheSize);
      });
  ...
  static dartSuite() {
    _ut.group('IncrementalAnalysisCacheTest', () {
      ...
      _ut.test('test_update_noCache_entry_noOldSource_append', () {
        ...
        runJUnitTest(
            __test,
            __test.test_update_noCache_entry_noOldSource_append);
      });
      _ut.test('test_update_noCache_entry_noOldSource_delete', () {
        final __test = new IncrementalAnalysisCacheTest();
        runJUnitTest(
            __test,
            __test.test_update_noCache_entry_noOldSource_delete);
      });
      _ut.test('test_update_noCache_entry_noOldSource_replace', () {
        final __test = new IncrementalAnalysisCacheTest();
        runJUnitTest(
            __test,
            __test.test_update_noCache_entry_noOldSource_replace);
      });
