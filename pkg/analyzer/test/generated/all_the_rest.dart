...
main() {
  AngularCompilationUnitBuilderTest.dartSuite();
  AngularHtmlUnitResolverTest.dartSuite();
  AngularHtmlUnitUtilsTest.dartSuite();
  ConstantEvaluatorTest.dartSuite();
  ConstantFinderTest.dartSuite();
  ConstantValueComputerTest.dartSuite();
  ConstantVisitorTest.dartSuite();
  ContentCacheTest.dartSuite();
  DartObjectImplTest.dartSuite();
  DartUriResolverTest.dartSuite();
  DeclaredVariablesTest.dartSuite();
  DirectoryBasedDartSdkTest.dartSuite();
  DirectoryBasedSourceContainerTest.dartSuite();
  ElementBuilderTest.dartSuite();
  ElementLocatorTest.dartSuite();
  EnumMemberBuilderTest.dartSuite();
  ErrorReporterTest.dartSuite();
  ErrorSeverityTest.dartSuite();
  ExitDetectorTest.dartSuite();
  FileBasedSourceTest.dartSuite();
  FileUriResolverTest.dartSuite();
  HtmlParserTest.dartSuite();
  HtmlTagInfoBuilderTest.dartSuite();
  HtmlUnitBuilderTest.dartSuite();
  HtmlWarningCodeTest.dartSuite();
  ReferenceFinderTest.dartSuite();
  SDKLibrariesReaderTest.dartSuite();
  SourceFactoryTest.dartSuite();
  ToSourceVisitorTest.dartSuite();
  UriKindTest.dartSuite();
  ...
  static dartSuite() {
    _ut.group('AngularCompilationUnitBuilderTest', () {
      ...
      _ut.test('test_NgComponent_bad_properties_invalidBinding', () {
        ...
        runJUnitTest(
            __test,
            __test.test_NgComponent_bad_properties_invalidBinding);
      });
      _ut.test('test_NgComponent_bad_properties_nameNotStringLiteral', () {
        final __test = new AngularCompilationUnitBuilderTest();
        runJUnitTest(
            __test,
            __test.test_NgComponent_bad_properties_nameNotStringLiteral);
      });
      _ut.test('test_NgComponent_bad_properties_noSuchField', () {
        final __test = new AngularCompilationUnitBuilderTest();
        runJUnitTest(
            __test,
            __test.test_NgComponent_bad_properties_noSuchField);
      });
      _ut.test('test_NgComponent_bad_properties_notMapLiteral', () {
        final __test = new AngularCompilationUnitBuilderTest();
        runJUnitTest(
            __test,
            __test.test_NgComponent_bad_properties_notMapLiteral);
      });
      _ut.test('test_NgComponent_bad_properties_specNotStringLiteral', () {
        final __test = new AngularCompilationUnitBuilderTest();
        runJUnitTest(
            __test,
            __test.test_NgComponent_bad_properties_specNotStringLiteral);
      });
      ...
      _ut.test('test_getElement_SimpleStringLiteral_withToolkitElement', () {
        ...
        runJUnitTest(
            __test,
            __test.test_getElement_SimpleStringLiteral_withToolkitElement);
      });
      ...
      _ut.test('test_getElement_component_property_fromFieldAnnotation', () {
        ...
        runJUnitTest(
            __test,
            __test.test_getElement_component_property_fromFieldAnnotation);
      });
  ...
  static dartSuite() {
    _ut.group('AngularHtmlUnitResolverTest', () {
      ...
      _ut.test('test_NgDirective_resolvedExpression_attrString', () {
        ...
        runJUnitTest(
            __test,
            __test.test_NgDirective_resolvedExpression_attrString);
      });
      _ut.test('test_NgDirective_resolvedExpression_dotAsName', () {
        final __test = new AngularHtmlUnitResolverTest();
        runJUnitTest(
            __test,
            __test.test_NgDirective_resolvedExpression_dotAsName);
      });
...
//        runJUnitTest(
//            __test,
//            __test.test_analysisContext_changeDart_invalidateApplication);
//      });
      _ut.test(
          'test_analysisContext_changeEntryPoint_clearAngularErrors_inDart',
          () {
        final __test = new AngularHtmlUnitResolverTest();
        runJUnitTest(
            __test,
            __test.test_analysisContext_changeEntryPoint_clearAngularErrors_inDart);
      });
      _ut.test(
          'test_analysisContext_changeEntryPoint_clearAngularErrors_inTemplate',
          () {
        final __test = new AngularHtmlUnitResolverTest();
        runJUnitTest(
            __test,
            __test.test_analysisContext_changeEntryPoint_clearAngularErrors_inTemplate);
      });
      _ut.test(
          'test_analysisContext_removeEntryPoint_clearAngularErrors_inDart',
          () {
        final __test = new AngularHtmlUnitResolverTest();
        runJUnitTest(
            __test,
            __test.test_analysisContext_removeEntryPoint_clearAngularErrors_inDart);
      });
...
//      });
      ...
      _ut.test('test_resolveExpression_evenWithout_ngBootstrap', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveExpression_evenWithout_ngBootstrap);
      });
      ...
      _ut.test('test_resolveExpression_withFilter_notSimpleIdentifier', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveExpression_withFilter_notSimpleIdentifier);
      });
  ...
  static dartSuite() {
    _ut.group('ConstantFinderTest', () {
      ...
      _ut.test('test_visitInstanceCreationExpression_nonConst', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitInstanceCreationExpression_nonConst);
      });
      ...
      _ut.test('test_visitVariableDeclaration_noInitializer', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitVariableDeclaration_noInitializer);
      });
...
class ConstantValueComputerTest extends ResolverTestCase {
  ...
  static dartSuite() {
    _ut.group('ConstantValueComputerTest', () {
      ...
      _ut.test(
          'test_dependencyOnConstructorArgument_unresolvedConstructor',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_dependencyOnConstructorArgument_unresolvedConstructor);
      });
      ...
      _ut.test('test_dependencyOnExplicitSuperConstructorParameters', () {
        ...
        runJUnitTest(
            __test,
            __test.test_dependencyOnExplicitSuperConstructorParameters);
      });
      ...
      _ut.test('test_dependencyOnFactoryRedirectWithTypeParams', () {
        ...
        runJUnitTest(
            __test,
            __test.test_dependencyOnFactoryRedirectWithTypeParams);
      });
      ...
      _ut.test('test_fromEnvironment_bool_default_overridden', () {
        ...
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_bool_default_overridden);
      });
      _ut.test('test_fromEnvironment_bool_default_parseError', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_bool_default_parseError);
      });
      ...
      _ut.test('test_fromEnvironment_int_default_overridden', () {
        ...
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_int_default_overridden);
      });
      _ut.test('test_fromEnvironment_int_default_parseError', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_int_default_parseError);
      });
      _ut.test('test_fromEnvironment_int_default_undeclared', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_int_default_undeclared);
      });
      ...
      _ut.test('test_fromEnvironment_int_parseError_nullDefault', () {
        ...
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_int_parseError_nullDefault);
      });
      ...
      _ut.test('test_fromEnvironment_int_undeclared_nullDefault', () {
        ...
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_int_undeclared_nullDefault);
      });
      _ut.test('test_fromEnvironment_string_default_overridden', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_string_default_overridden);
      });
      _ut.test('test_fromEnvironment_string_default_undeclared', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_string_default_undeclared);
      });
      ...
      _ut.test('test_fromEnvironment_string_undeclared_nullDefault', () {
        ...
        runJUnitTest(
            __test,
            __test.test_fromEnvironment_string_undeclared_nullDefault);
      });
      _ut.test('test_instanceCreationExpression_computedField', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_namedOptionalWithDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_namedOptionalWithDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_namedOptionalWithoutDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_namedOptionalWithoutDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_unnamedOptionalWithDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_unnamedOptionalWithDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_unnamedOptionalWithoutDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_unnamedOptionalWithoutDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_usesConstConstructor',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_usesConstConstructor);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_usesStaticConst',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_usesStaticConst);
      });
      _ut.test(
          'test_instanceCreationExpression_computedField_usesToplevelConst',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_computedField_usesToplevelConst);
      });
      _ut.test('test_instanceCreationExpression_explicitSuper', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_explicitSuper);
      });
      _ut.test('test_instanceCreationExpression_fieldFormalParameter', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_fieldFormalParameter);
      });
      _ut.test(
          'test_instanceCreationExpression_fieldFormalParameter_namedOptionalWithDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_fieldFormalParameter_namedOptionalWithDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_fieldFormalParameter_namedOptionalWithoutDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_fieldFormalParameter_namedOptionalWithoutDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_fieldFormalParameter_unnamedOptionalWithDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_fieldFormalParameter_unnamedOptionalWithDefault);
      });
      _ut.test(
          'test_instanceCreationExpression_fieldFormalParameter_unnamedOptionalWithoutDefault',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_fieldFormalParameter_unnamedOptionalWithoutDefault);
      });
      _ut.test('test_instanceCreationExpression_implicitSuper', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_implicitSuper);
      });
      ...
      _ut.test('test_instanceCreationExpression_redirectWithTypeParams', () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_redirectWithTypeParams);
      });
      _ut.test(
          'test_instanceCreationExpression_redirectWithTypeSubstitution',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_redirectWithTypeSubstitution);
      });
      _ut.test('test_instanceCreationExpression_redirect_cycle', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_redirect_cycle);
      });
      _ut.test('test_instanceCreationExpression_redirect_extern', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_redirect_extern);
      });
      _ut.test('test_instanceCreationExpression_redirect_nonConst', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_redirect_nonConst);
      });
      ...
      _ut.test(
          'test_instanceCreationExpression_withSupertypeParams_explicit',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_withSupertypeParams_explicit);
      });
      _ut.test(
          'test_instanceCreationExpression_withSupertypeParams_implicit',
          () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_withSupertypeParams_implicit);
      });
      _ut.test('test_instanceCreationExpression_withTypeParams', () {
        final __test = new ConstantValueComputerTest();
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_withTypeParams);
      });
  ...
  static dartSuite() {
    _ut.group('ConstantVisitorTest', () {
      ...
      _ut.test(
        ...
        runJUnitTest(
            __test,
            __test.test_visitConditionalExpression_instanceCreation_invalidFieldInitializer);
      });
      _ut.test('test_visitConditionalExpression_nonBooleanCondition', () {
        final __test = new ConstantVisitorTest();
        runJUnitTest(
            __test,
            __test.test_visitConditionalExpression_nonBooleanCondition);
      });
      _ut.test('test_visitConditionalExpression_nonConstantElse', () {
        final __test = new ConstantVisitorTest();
        runJUnitTest(
            __test,
            __test.test_visitConditionalExpression_nonConstantElse);
      });
      _ut.test('test_visitConditionalExpression_nonConstantThen', () {
        final __test = new ConstantVisitorTest();
        runJUnitTest(
            __test,
            __test.test_visitConditionalExpression_nonConstantThen);
      });
      ...
      _ut.test('test_visitSimpleIdentifier_notInEnvironment', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitSimpleIdentifier_notInEnvironment);
      });
      _ut.test('test_visitSimpleIdentifier_withoutEnvironment', () {
        final __test = new ConstantVisitorTest();
        runJUnitTest(
            __test,
            __test.test_visitSimpleIdentifier_withoutEnvironment);
      });
    });
  }
}
  ...
  static dartSuite() {
    _ut.group('DartObjectImplTest', () {
      ...
      _ut.test('test_greaterThanOrEqual_knownDouble_knownDouble_false', () {
        ...
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownDouble_knownDouble_false);
      });
      _ut.test('test_greaterThanOrEqual_knownDouble_knownDouble_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownDouble_knownDouble_true);
      });
      _ut.test('test_greaterThanOrEqual_knownDouble_knownInt_false', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownDouble_knownInt_false);
      });
      _ut.test('test_greaterThanOrEqual_knownDouble_knownInt_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownDouble_knownInt_true);
      });
      _ut.test('test_greaterThanOrEqual_knownDouble_unknownDouble', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownDouble_unknownDouble);
      });
      _ut.test('test_greaterThanOrEqual_knownDouble_unknownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownDouble_unknownInt);
      });
      _ut.test('test_greaterThanOrEqual_knownInt_knownInt_false', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownInt_knownInt_false);
      });
      _ut.test('test_greaterThanOrEqual_knownInt_knownInt_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownInt_knownInt_true);
      });
      _ut.test('test_greaterThanOrEqual_knownInt_knownString', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownInt_knownString);
      });
      _ut.test('test_greaterThanOrEqual_knownInt_unknownDouble', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownInt_unknownDouble);
      });
      _ut.test('test_greaterThanOrEqual_knownInt_unknownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownInt_unknownInt);
      });
      _ut.test('test_greaterThanOrEqual_knownString_knownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_knownString_knownInt);
      });
      _ut.test('test_greaterThanOrEqual_unknownDouble_knownDouble', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_unknownDouble_knownDouble);
      });
      _ut.test('test_greaterThanOrEqual_unknownDouble_knownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_unknownDouble_knownInt);
      });
      _ut.test('test_greaterThanOrEqual_unknownInt_knownDouble', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_unknownInt_knownDouble);
      });
      _ut.test('test_greaterThanOrEqual_unknownInt_knownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThanOrEqual_unknownInt_knownInt);
      });
      _ut.test('test_greaterThan_knownDouble_knownDouble_false', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThan_knownDouble_knownDouble_false);
      });
      _ut.test('test_greaterThan_knownDouble_knownDouble_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThan_knownDouble_knownDouble_true);
      });
      _ut.test('test_greaterThan_knownDouble_knownInt_false', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_greaterThan_knownDouble_knownInt_false);
      });
      ...
      _ut.test('test_integerDivide_knownDouble_unknownDouble', () {
        ...
        runJUnitTest(
            __test,
            __test.test_integerDivide_knownDouble_unknownDouble);
      });
      ...
      _ut.test('test_integerDivide_unknownDouble_knownDouble', () {
        ...
        runJUnitTest(
            __test,
            __test.test_integerDivide_unknownDouble_knownDouble);
      });
      ...
      _ut.test('test_lessThanOrEqual_knownDouble_knownDouble_false', () {
        ...
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownDouble_knownDouble_false);
      });
      _ut.test('test_lessThanOrEqual_knownDouble_knownDouble_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownDouble_knownDouble_true);
      });
      _ut.test('test_lessThanOrEqual_knownDouble_knownInt_false', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownDouble_knownInt_false);
      });
      _ut.test('test_lessThanOrEqual_knownDouble_knownInt_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownDouble_knownInt_true);
      });
      _ut.test('test_lessThanOrEqual_knownDouble_unknownDouble', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownDouble_unknownDouble);
      });
      _ut.test('test_lessThanOrEqual_knownDouble_unknownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownDouble_unknownInt);
      });
      _ut.test('test_lessThanOrEqual_knownInt_knownInt_false', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownInt_knownInt_false);
      });
      _ut.test('test_lessThanOrEqual_knownInt_knownInt_true', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownInt_knownInt_true);
      });
      ...
      _ut.test('test_lessThanOrEqual_knownInt_unknownDouble', () {
        ...
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_knownInt_unknownDouble);
      });
      ...
      _ut.test('test_lessThanOrEqual_unknownDouble_knownDouble', () {
        ...
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_unknownDouble_knownDouble);
      });
      _ut.test('test_lessThanOrEqual_unknownDouble_knownInt', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_unknownDouble_knownInt);
      });
      _ut.test('test_lessThanOrEqual_unknownInt_knownDouble', () {
        final __test = new DartObjectImplTest();
        runJUnitTest(
            __test,
            __test.test_lessThanOrEqual_unknownInt_knownDouble);
      });
      ...
      _ut.test('test_lessThan_knownDouble_knownDouble_false', () {
        ...
        runJUnitTest(
            __test,
            __test.test_lessThan_knownDouble_knownDouble_false);
      });
  ...
  static dartSuite() {
    _ut.group('ElementBuilderTest', () {
      ...
      _ut.test('test_visitFieldFormalParameter_funtionTyped', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitFieldFormalParameter_funtionTyped);
      });
      ...
      _ut.test('test_visitMethodDeclaration_getter_abstract', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitMethodDeclaration_getter_abstract);
      });
      _ut.test('test_visitMethodDeclaration_getter_external', () {
        final __test = new ElementBuilderTest();
        runJUnitTest(
            __test,
            __test.test_visitMethodDeclaration_getter_external);
      });
      ...
      _ut.test('test_visitMethodDeclaration_setter_abstract', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitMethodDeclaration_setter_abstract);
      });
      _ut.test('test_visitMethodDeclaration_setter_external', () {
        final __test = new ElementBuilderTest();
        runJUnitTest(
            __test,
            __test.test_visitMethodDeclaration_setter_external);
      });
      ...
      _ut.test('test_visitVariableDeclaration_inConstructor', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitVariableDeclaration_inConstructor);
      });
      ...
      _ut.test('test_visitVariableDeclaration_localNestedInField', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitVariableDeclaration_localNestedInField);
      });
      _ut.test('test_visitVariableDeclaration_noInitializer', () {
        final __test = new ElementBuilderTest();
        runJUnitTest(
  ...
  static dartSuite() {
    _ut.group('ElementLocatorTest', () {
      ...
      _ut.test(
        ...
        runJUnitTest(
            __test,
            __test.test_locate_Identifier_annotationClass_namedConstructor_forSimpleFormalParameter);
      });
      _ut.test(
          'test_locate_Identifier_annotationClass_unnamedConstructor_forSimpleFormalParameter',
          () {
        ...
        runJUnitTest(
            __test,
            __test.test_locate_Identifier_annotationClass_unnamedConstructor_forSimpleFormalParameter);
      });
      ...
      _ut.test(
          'test_locate_InstanceCreationExpression_type_prefixedIdentifier',
          () {
        final __test = new ElementLocatorTest();
        runJUnitTest(
            __test,
            __test.test_locate_InstanceCreationExpression_type_prefixedIdentifier);
      });
      _ut.test(
          'test_locate_InstanceCreationExpression_type_simpleIdentifier',
          () {
        final __test = new ElementLocatorTest();
        runJUnitTest(
            __test,
            __test.test_locate_InstanceCreationExpression_type_simpleIdentifier);
      });
  ...
  static dartSuite() {
    _ut.group('ExitDetectorTest', () {
      ...
      _ut.test('test_functionExpressionInvocation_argumentThrows', () {
        ...
        runJUnitTest(
            __test,
            __test.test_functionExpressionInvocation_argumentThrows);
      });
      _ut.test('test_functionExpressionInvocation_targetThrows', () {
        final __test = new ExitDetectorTest();
        runJUnitTest(
            __test,
            __test.test_functionExpressionInvocation_targetThrows);
      });
      ...
      _ut.test('test_instanceCreationExpression_argumentThrows', () {
        ...
        runJUnitTest(
            __test,
            __test.test_instanceCreationExpression_argumentThrows);
      });
      ...
      _ut.test('test_variableDeclarationStatement_noInitializer', () {
        ...
        runJUnitTest(
            __test,
            __test.test_variableDeclarationStatement_noInitializer);
      });
  ...
  static dartSuite() {
    _ut.group('FileBasedSourceTest', () {
      ...
      _ut.test('test_resolveRelative_dart_filePathWithParent', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveRelative_dart_filePathWithParent);
      });
      ...
      _ut.test('test_resolveRelative_file_filePathWithParent', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveRelative_file_filePathWithParent);
      });
      ...
      _ut.test('test_resolveRelative_package_fileNameWithoutPackageName', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveRelative_package_fileNameWithoutPackageName);
      });
      ...
      _ut.test('test_resolveRelative_package_filePathWithParent', () {
        ...
        runJUnitTest(
            __test,
            __test.test_resolveRelative_package_filePathWithParent);
      });
  ...
  static dartSuite() {
    _ut.group('HtmlTagInfoBuilderTest', () {
      _ut.test('test_buider', () {
        ...
        runJUnitTest(__test, __test.test_builder);
      });
      _ut.test('test_parse_attribute', () {
        final __test = new HtmlTagInfoBuilderTest();
        runJUnitTest(__test, __test.test_parse_attribute);
  ...
  static dartSuite() {
    _ut.group('ReferenceFinderTest', () {
      ...
      _ut.test('test_visitInstanceCreationExpression_nonConstDeclaration', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitInstanceCreationExpression_nonConstDeclaration);
      });
      _ut.test('test_visitInstanceCreationExpression_nonConstUsage', () {
        final __test = new ReferenceFinderTest();
        runJUnitTest(
            __test,
            __test.test_visitInstanceCreationExpression_nonConstUsage);
      });
      _ut.test('test_visitInstanceCreationExpression_notInMap', () {
        final __test = new ReferenceFinderTest();
        runJUnitTest(
            __test,
            __test.test_visitInstanceCreationExpression_notInMap);
      });
      ...
      _ut.test('test_visitSuperConstructorInvocation_nonConst', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitSuperConstructorInvocation_nonConst);
      });
      _ut.test('test_visitSuperConstructorInvocation_notInMap', () {
        final __test = new ReferenceFinderTest();
        runJUnitTest(
            __test,
            __test.test_visitSuperConstructorInvocation_notInMap);
      });
      _ut.test('test_visitSuperConstructorInvocation_unresolved', () {
        final __test = new ReferenceFinderTest();
        runJUnitTest(
            __test,
            __test.test_visitSuperConstructorInvocation_unresolved);
      });
    });
  }
}
  ...
  static dartSuite() {
    _ut.group('StringScannerTest', () {
      ...
      _ut.test('test_tokenize_directives_incomplete_with_newline', () {
        ...
        runJUnitTest(
            __test,
            __test.test_tokenize_directives_incomplete_with_newline);
      });
      ...
      _ut.test('test_tokenize_tag_incomplete_with_special_characters', () {
        ...
        runJUnitTest(
            __test,
            __test.test_tokenize_tag_incomplete_with_special_characters);
      });
  ...
  static dartSuite() {
    _ut.group('ToSourceVisitorTest', () {
      _ut.test('test_visitHtmlScriptTagNode_attributes_noContent', () {
        ...
        runJUnitTest(
            __test,
            __test.test_visitHtmlScriptTagNode_attributes_noContent);
      });
      _ut.test('test_visitHtmlScriptTagNode_noAttributes_noContent', () {
        final __test = new ToSourceVisitorTest();
        runJUnitTest(
            __test,
            __test.test_visitHtmlScriptTagNode_noAttributes_noContent);
      });
