...
export 'lib1.dart';
''', [
      error(StaticWarningCode.DUPLICATE_EXPORT, 27, 11),
    ]);
  }
...
export 'lib1.dart' show A;
''', [
      error(StaticWarningCode.DUPLICATE_EXPORT, 34, 11),
    ]);
  }
}
...
final a = A();
''', [
      error(StaticWarningCode.DUPLICATE_IMPORT, 37, 21),
    ]);
  }
...
final a = A();
''', [
      error(StaticWarningCode.DUPLICATE_IMPORT, 24, 21),
    ]);
  }
...
final a = A();
''', [
      error(StaticWarningCode.DUPLICATE_IMPORT, 24, 8),
    ]);
  }
...
''');
    ...
    await _resolveFile('$testPackageLibPath/lib2.dart', [
      error(StaticWarningCode.DUPLICATE_IMPORT, 57, 11),
    ]);
  }
...
''');
    ...
    await _resolveFile('$testPackageLibPath/lib1.dart');
    await _resolveFile('$testPackageLibPath/lib2.dart', [
      error(StaticWarningCode.DUPLICATE_IMPORT, 38, 11),
      error(StaticWarningCode.DUPLICATE_IMPORT, 58, 11),
    ]);
  }
