...
FormalParameterList
  ...
  parameter: FieldFormalParameter
    ...
    period: .
    name: it
    declaredElement: <thisLibrary>::<definingUnit>::@extensionType::E::@constructor::named::@parameter::it
      type: int
  leftDelimiter: {
  parameter: DefaultFormalParameter
    parameter: SuperFormalParameter
      ...
      period: .
      name: foo
      declaredElement: <thisLibrary>::<definingUnit>::@extensionType::E::@constructor::named::@parameter::foo
        type: dynamic
    declaredElement: <thisLibrary>::<definingUnit>::@extensionType::E::@constructor::named::@parameter::foo
      type: dynamic
  rightDelimiter: }
