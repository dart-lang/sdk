...
MethodInvocation
  ...
  methodName: SimpleIdentifier
    token: foo
    staticElement: <thisLibrary>::<definingUnit>::@mixin::A::@method::foo
    staticType: void Function()
  argumentList: ArgumentList
    leftParenthesis: (
    rightParenthesis: )
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: foo
    staticElement: <thisLibrary>::<definingUnit>::@mixin::A::@getter::foo
    staticType: int
  staticType: int
''');
  }
...
AssignmentExpression
  ...
  rightHandSide: SimpleIdentifier
    token: a
    parameter: <thisLibrary>::<definingUnit>::@mixin::A::@setter::foo::@parameter::a
    staticElement: <thisLibrary>::<definingUnit>::@class::B::@setter::foo::@parameter::a
    staticType: int
  readElement: <null>
  readType: null
  writeElement: <thisLibrary>::<definingUnit>::@mixin::A::@setter::foo
  writeType: int
  staticElement: <null>
  staticType: int
''');
...
AssignmentExpression
  ...
  rightHandSide: SimpleIdentifier
    token: a
    parameter: <thisLibrary>::<definingUnit>::@class::A::@setter::foo::@parameter::a
    staticElement: <thisLibrary>::<definingUnit>::@class::B::@setter::foo::@parameter::a
    staticType: int
  readElement: <null>
  readType: null
