...
''', [
      error(StaticWarningCode.DUPLICATE_IGNORE, 43, 21),
    ]);
  }
...
''', [
      error(StaticWarningCode.DUPLICATE_IGNORE, 47, 21),
    ]);
  }
...
''', [
      error(StaticWarningCode.DUPLICATE_IGNORE, 66, 21),
    ]);
  }
...
''', [
      error(StaticWarningCode.DUPLICATE_IGNORE, 31, 10),
    ]);
  }
...
''', [
      error(StaticWarningCode.DUPLICATE_IGNORE, 34, 10),
    ]);
  }
...
void g(arg1(int)) {} // AVOID_TYPES_AS_PARAMETER_NAMES
''', [
      error(StaticWarningCode.DUPLICATE_IGNORE, 53, 10),
    ]);
  }
}
