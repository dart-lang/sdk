...
AssignmentExpression
  ...
  rightHandSide: IntegerLiteral
    literal: 0
    parameter: package:test/a.dart::<definingUnit>::@class::A::@setter::_foo::@parameter::__foo
    staticType: int
  readElement: <null>
  readType: null
  writeElement: package:test/a.dart::<definingUnit>::@class::A::@setter::_foo
  writeType: int
  staticElement: <null>
  staticType: int
''');
...
AssignmentExpression
  ...
  rightHandSide: IntegerLiteral
    literal: 0
    parameter: package:test/a.dart::<definingUnit>::@class::A::@setter::_foo::@parameter::_
    staticType: int
  readElement: <null>
  readType: null
  writeElement: package:test/a.dart::<definingUnit>::@class::A::@setter::_foo
