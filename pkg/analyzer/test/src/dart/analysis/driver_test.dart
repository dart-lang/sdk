...
''';
    ...
    var resolvedLibrary = await driver.getResolvedLibrary(a);
    expect(resolvedLibrary.session, same(driver.currentSession));
    ...
    LibraryElement libraryElement = resolvedLibrary.element;
    ...
    ClassDeclaration aNode = resolvedLibrary.getElementDeclaration(aClass);
    expect(
      aContent.substring(aNode.offset, aNode.end),
      'class A /*a*/ {}',
    );

    ClassDeclaration bNode = resolvedLibrary.getElementDeclaration(bClass);
    expect(
      bContent.substring(bNode.offset, bNode.end),
      'class B /*b*/ {}',
    );
  }
...
''';
    ...
    var fooNode = resolvedLibrary.getElementDeclaration(fooElement);
    expect(
      aContent.substring(fooNode.offset, fooNode.end),
      'foo = 0',
    );
