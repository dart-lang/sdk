...
''');
  ...
  test_getMember_topMerge_getter() async {
    newFile('/test/lib/a.dart', content: r'''
// @dart = 2.6
class A {
  int get foo => 0;
...
''');
    ...
    _assertGetMember(
      className: 'C',
      name: 'foo',
      expected: 'C.foo: int? Function()',
    );
  }

  test_getMember_topMerge_method() async {
    newFile('/test/lib/a.dart', content: r'''
// @dart = 2.6
class A {
  int foo(int x) {}
...
''');
    ...
    _assertGetMember(
      className: 'C',
      name: 'foo',
      expected: 'C.foo: int? Function(int?)',
    );
  }

  test_getMember_topMerge_setter() async {
    newFile('/test/lib/a.dart', content: r'''
// @dart = 2.6
class A {
  set foo(int _) {}
