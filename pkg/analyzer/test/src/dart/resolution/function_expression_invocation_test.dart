    ...
    arguments
      IntegerLiteral
        ...
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@method::call::@parameter::t
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::call
...
FunctionExpressionInvocation
  function: SimpleIdentifier
    token: a
    staticElement: <thisLibrary>::<definingUnit>::@function::main::@parameter::a
    staticType: A
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      ListLiteral
        ...
        rightBracket: ]
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@method::call::@parameter::_
          substitution: {T: int}
        staticType: List<int>
    rightParenthesis: )
  staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::call
  ...
  function: ParenthesizedExpression
    ...
    expression: AsExpression
      expression: SimpleIdentifier
        token: main
        staticElement: <thisLibrary>::<definingUnit>::@function::main
...
FunctionExpressionInvocation
  ...
  argumentList: ArgumentList
    leftParenthesis: (
    rightParenthesis: )
  staticElement: <thisLibrary>::<definingUnit>::@extension::0::@method::call
  staticInvokeType: int Function()
  staticType: int
''');
  }
...
FunctionExpressionInvocation
  function: SimpleIdentifier
    token: g
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::g
...
FunctionExpressionInvocation
  function: SimpleIdentifier
    token: id
    staticElement: <thisLibrary>::<definingUnit>::@getter::id
  ...
  argumentList: ArgumentList
    ...
    arguments
      SimpleIdentifier
        token: a
        parameter: dart:core::<definingUnit>::@function::identical::@parameter::a
        staticElement: <thisLibrary>::<definingUnit>::@getter::a
        staticType: int
      SimpleIdentifier
        token: b
        parameter: dart:core::<definingUnit>::@function::identical::@parameter::b
        staticElement: <thisLibrary>::<definingUnit>::@getter::b
        staticType: int
    rightParenthesis: )
  staticElement: <null>
...
FunctionExpressionInvocation
  function: PropertyAccess
    target: SimpleIdentifier
      token: a
      staticElement: <thisLibrary>::<definingUnit>::@class::B::@method::bar::@parameter::a
      staticType: A?
    operator: ?.
  ...
  function: SwitchExpression
    ...
    cases
      SwitchExpressionCase
        ...
        expression: SimpleIdentifier
          token: foo
          staticElement: <thisLibrary>::<definingUnit>::@function::foo
...
FunctionExpressionInvocation
  function: PropertyAccess
    target: SimpleIdentifier
      token: r
      staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::r
