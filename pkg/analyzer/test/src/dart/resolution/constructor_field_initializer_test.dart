...
ConstructorFieldInitializer
  fieldName: SimpleIdentifier
    token: f
    staticElement: <thisLibrary>::<definingUnit>::@class::A::@field::f
    staticType: null
  equals: =
  expression: SimpleIdentifier
    token: a
    staticElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::a
    staticType: int
''');
  }
...
ConstructorFieldInitializer
  fieldName: SimpleIdentifier
    token: x
    staticElement: <thisLibrary>::<definingUnit>::@class::A::@field::x
    staticType: null
  equals: =
