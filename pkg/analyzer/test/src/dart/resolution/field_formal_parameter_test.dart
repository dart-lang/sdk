  ...
  parameters: FormalParameterList
    ...
    parameter: SimpleFormalParameter
      type: NamedType
        ...
        type: int
      name: a
      declaredElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::f::@parameter::a
        type: int
    rightParenthesis: )
  declaredElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::f
  ...
  parameters: FormalParameterList
    ...
    parameter: SimpleFormalParameter
      type: NamedType
        ...
        type: V
      name: b
      declaredElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::f::@parameter::b
        type: V
    rightParenthesis: )
  declaredElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::f
...
FieldFormalParameter
  ...
  period: .
  name: f
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@constructor::new::@parameter::f
    type: int
''');
  }
}
