...
ForStatement
  ...
  forLoopParts: ForEachPartsWithDeclaration
    ...
    iterable: SimpleIdentifier
      token: values
      staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::values
      staticType: dynamic
  rightParenthesis: )
  body: Block
    leftBracket: {
    ...
    iterable: PrefixedIdentifier
      ...
      identifier: SimpleIdentifier
        ...
        staticElement: PropertyAccessorMember
          base: dart:core::<definingUnit>::@class::Iterable::@getter::first
...
ForStatement
  ...
  forLoopParts: ForEachPartsWithIdentifier
    identifier: SimpleIdentifier
      token: v
      staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::v
      staticType: dynamic
    inKeyword: in
    iterable: SimpleIdentifier
      token: values
...
ForStatement
  ...
  forLoopParts: ForEachPartsWithIdentifier
    identifier: SimpleIdentifier
      token: v
      staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::f::@parameter::v
      staticType: dynamic
    inKeyword: in
    iterable: SuperExpression
      superKeyword: super
