...
ConditionalExpression
  condition: SimpleIdentifier
    token: c
    staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::f::@parameter::c
    staticType: bool
  question: ?
  thenExpression: IntegerLiteral
    literal: 0
...
ConditionalExpression
  ...
  thenExpression: SimpleIdentifier
    token: c1
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::c1
    staticType: C1
  colon: :
...
ConditionalExpression
  ...
  thenExpression: SimpleIdentifier
    token: r1
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::r1
    staticType: (int, String)
  colon: :
  elseExpression: SimpleIdentifier
    token: r2
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::r2
    staticType: ({int a})
  staticType: Record
''');
  }
...
''');
  ...
  thenExpression: SimpleIdentifier
    token: b2
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::b2
    staticType: B2
  colon: :
  elseExpression: SimpleIdentifier
    token: c1
