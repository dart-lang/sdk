      ...
      NamedExpression
        name: Label
          label: SimpleIdentifier
            token: b
            staticElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::b
            staticType: null
          colon: :
        expression: BooleanLiteral
          literal: true
          staticType: bool
        parameter: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::b
      NamedExpression
        name: Label
          label: SimpleIdentifier
            token: c
            staticElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::c
            staticType: null
          colon: :
        expression: DoubleLiteral
          literal: 1.2
          staticType: double
        parameter: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::c
    rightParenthesis: )
  staticType: A
''');
  }
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@constructor::named::@parameter::t
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticType: A<int>
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::t
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticType: A<int>
...
InstanceCreationExpression
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: <thisLibrary>::<definingUnit>::@class::A::@constructor::named::@parameter::a
        staticType: int
    rightParenthesis: )
  staticType: A
''');
...
InstanceCreationExpression
  constructorName: ConstructorName
    ...
    staticElement: ConstructorMember
      base: dart:core::<definingUnit>::@class::Map::@constructor::new
...
InstanceCreationExpression
  ...
  constructorName: ConstructorName
    type: NamedType
      name: Foo
      element: <thisLibrary>::<definingUnit>::@class::Foo
      type: Foo<dynamic>
    period: .
    name: SimpleIdentifier
      token: bar
      staticElement: ConstructorMember
        base: <thisLibrary>::<definingUnit>::@class::Foo::@constructor::bar
...
InstanceCreationExpression
  ...
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: new
      staticElement: ConstructorMember
        base: <thisLibrary>::<definingUnit>::@class::Foo::@constructor::new
        substitution: {X: dynamic}
      staticType: null
    staticElement: ConstructorMember
      base: <thisLibrary>::<definingUnit>::@class::Foo::@constructor::new
...
InstanceCreationExpression
  ...
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: bar
      staticElement: ConstructorMember
        base: package:test/a.dart::<definingUnit>::@class::Foo::@constructor::bar
        substitution: {X: dynamic}
      staticType: null
    staticElement: ConstructorMember
      base: package:test/a.dart::<definingUnit>::@class::Foo::@constructor::bar
...
InstanceCreationExpression
  constructorName: ConstructorName
    type: NamedType
      ...
      type: A<int>
    staticElement: ConstructorMember
      base: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::new
      substitution: {T: int}
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      IntegerLiteral
        ...
        parameter: FieldFormalParameterMember
          base: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::new::@parameter::it
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticType: A<int>
...
InstanceCreationExpression
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: named
      staticElement: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::named
      staticType: null
    staticElement: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::named
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      IntegerLiteral
        literal: 0
        parameter: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::named::@parameter::it
        staticType: int
    rightParenthesis: )
  staticType: A
''');
...
InstanceCreationExpression
  constructorName: ConstructorName
    type: NamedType
      ...
      element: <thisLibrary>::<definingUnit>::@extensionType::A
      type: A
    staticElement: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::new
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      IntegerLiteral
        literal: 0
        parameter: <thisLibrary>::<definingUnit>::@extensionType::A::@constructor::new::@parameter::it
        staticType: int
    rightParenthesis: )
  staticType: A
''');
...
InstanceCreationExpression
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: named
      staticElement: package:test/a.dart::<definingUnit>::@class::A::@constructor::named
      staticType: null
    staticElement: package:test/a.dart::<definingUnit>::@class::A::@constructor::named
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      IntegerLiteral
        literal: 0
        parameter: package:test/a.dart::<definingUnit>::@class::A::@constructor::named::@parameter::a
        staticType: int
    rightParenthesis: )
  staticType: A
''');
...
InstanceCreationExpression
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: package:test/a.dart::<definingUnit>::@class::A::@constructor::new::@parameter::a
        staticType: int
    rightParenthesis: )
  staticType: A
''');
...
InstanceCreationExpression
  constructorName: ConstructorName
    type: NamedType
      name: X
      element: <thisLibrary>::<definingUnit>::@class::X
      type: X
    staticElement: <thisLibrary>::<definingUnit>::@class::X::@constructor::new
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      MethodInvocation
        ...
        argumentList: ArgumentList
          leftParenthesis: (
          rightParenthesis: )
        parameter: <thisLibrary>::<definingUnit>::@class::X::@constructor::new::@parameter::a
      ...
      NamedExpression
        name: Label
          label: SimpleIdentifier
            token: c
            staticElement: <thisLibrary>::<definingUnit>::@class::X::@constructor::new::@parameter::c
            staticType: null
          colon: :
        expression: MethodInvocation
          ...
          typeArgumentTypes
            C?
        parameter: <thisLibrary>::<definingUnit>::@class::X::@constructor::new::@parameter::c
      MethodInvocation
        methodName: SimpleIdentifier
          token: g2
        ...
        argumentList: ArgumentList
          leftParenthesis: (
          rightParenthesis: )
        parameter: <thisLibrary>::<definingUnit>::@class::X::@constructor::new::@parameter::b
      ...
      NamedExpression
        name: Label
          label: SimpleIdentifier
            token: d
            staticElement: <thisLibrary>::<definingUnit>::@class::X::@constructor::new::@parameter::d
            staticType: null
          colon: :
        expression: MethodInvocation
          methodName: SimpleIdentifier
          ...
          typeArgumentTypes
            D?
        parameter: <thisLibrary>::<definingUnit>::@class::X::@constructor::new::@parameter::d
    rightParenthesis: )
  staticType: X
''');
  }
