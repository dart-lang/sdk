...
ListLiteral
  leftBracket: [
  rightBracket: ]
  parameter: <thisLibrary>::<definingUnit>::@enum::E::@constructor::new::@parameter::a
  staticType: List<int>
''');
  }
      ...
      arguments
        IntegerLiteral
          ...
          parameter: ParameterMember
            base: <thisLibrary>::<definingUnit>::@enum::E::@constructor::named::@parameter::a
            substitution: {T: int}
          staticType: int
      rightParenthesis: )
  constructorElement: ConstructorMember
    base: <thisLibrary>::<definingUnit>::@enum::E::@constructor::named
    substitution: {T: int}
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@field::v
''');
  }
    ...
    argumentList: ArgumentList
      ...
      arguments
        IntegerLiteral
          literal: 42
          parameter: ParameterMember
            base: <thisLibrary>::<definingUnit>::@enum::E::@constructor::new::@parameter::a
            substitution: {T: int}
          staticType: int
      rightParenthesis: )
  constructorElement: ConstructorMember
    base: <thisLibrary>::<definingUnit>::@enum::E::@constructor::new
    substitution: {T: int}
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@field::v
''');
  }
  ...
  arguments: EnumConstantArguments
    ...
    argumentList: ArgumentList
      ...
      arguments
        IntegerLiteral
          literal: 42
          parameter: <thisLibrary>::<definingUnit>::@enum::E::@constructor::named::@parameter::a
          staticType: int
      rightParenthesis: )
  constructorElement: <thisLibrary>::<definingUnit>::@enum::E::@constructor::named
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@field::v
''');
  }
    ...
    argumentList: ArgumentList
      ...
      arguments
        IntegerLiteral
          ...
          staticType: int
      rightParenthesis: )
  constructorElement: <thisLibrary>::<definingUnit>::@enum::E::@constructor::new
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@field::v
''');
  }
    ...
    variables
      VariableDeclaration
        ...
        initializer: IntegerLiteral
          literal: 42
          staticType: int
        declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@field::foo
  semicolon: ;
...
MethodDeclaration
  ...
  body: ExpressionFunctionBody
    ...
    expression: ThrowExpression
      ...
      staticType: Never
    semicolon: ;
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@getter::foo
    type: T Function()
''');
  }
...
ImplementsClause
  ...
  interfaces
    NamedType
      name: I
      element: <thisLibrary>::<definingUnit>::@class::I
      type: I
''');
  }
  ...
  parameters: FormalParameterList
    ...
    parameter: SimpleFormalParameter
      type: NamedType
        ...
        type: T
      name: t
      declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@method::foo::@parameter::t
        type: T
    parameter: SimpleFormalParameter
      type: NamedType
        name: U
        ...
        type: U
      name: u
      declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@method::foo::@parameter::u
        type: U
    rightParenthesis: )
  body: ExpressionFunctionBody
    functionDefinition: =>
    expression: IntegerLiteral
      ...
      staticType: int
    semicolon: ;
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@method::foo
...
MethodDeclaration
  ...
  body: ExpressionFunctionBody
    ...
    expression: SimpleStringLiteral
      literal: 'E'
    semicolon: ;
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@method::toString
      ...
      typeArguments: TypeArgumentList
        ...
        arguments
          NamedType
            ...
            type: int
        rightBracket: >
      element: <thisLibrary>::<definingUnit>::@mixin::M1
      type: M1<int>
    NamedType
      name: M2
      element: <thisLibrary>::<definingUnit>::@mixin::M2
      type: M2<int>
''');
  }
...
MethodDeclaration
  ...
  parameters: FormalParameterList
    ...
    parameter: SimpleFormalParameter
      type: NamedType
        ...
        type: T
      name: a
      declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@setter::foo::@parameter::a
        type: T
    rightParenthesis: )
  body: BlockFunctionBody
    block: Block
      leftBracket: {
      rightBracket: }
  declaredElement: <thisLibrary>::<definingUnit>::@enum::E::@setter::foo
...
PropertyAccess
  target: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: _
      staticElement: <thisLibrary>::<definingUnit>::@enum::E::@getter::_
      staticType: E
    staticElement: <thisLibrary>::<definingUnit>::@enum::E::@getter::_
    staticType: E
  operator: .
  propertyName: SimpleIdentifier
    token: index
    staticElement: dart:core::<definingUnit>::@class::Enum::@getter::index
    staticType: int
  staticType: int
''');
  }
