...
ConstructorReference
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: foo
      staticElement: <thisLibrary>::<definingUnit>::@class::A::@constructor::foo
      staticType: null
...
ConstructorReference
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: foo
      staticElement: package:test/a.dart::<definingUnit>::@class::A::@constructor::foo
      staticType: null
    staticElement: package:test/a.dart::<definingUnit>::@class::A::@constructor::foo
  staticType: A Function()
''');
...
ConstructorReference
  constructorName: ConstructorName
    type: NamedType
      name: TA
      element: <thisLibrary>::<definingUnit>::@typeAlias::TA
      type: null
    period: .
    name: SimpleIdentifier
      token: new
...
ConstructorReference
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: foo
      staticElement: ConstructorMember
        base: <thisLibrary>::<definingUnit>::@class::A::@constructor::foo
        substitution: {T: int}
      staticType: null
    staticElement: ConstructorMember
      base: <thisLibrary>::<definingUnit>::@class::A::@constructor::foo
...
ConstructorReference
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: foo
      staticElement: ConstructorMember
        base: package:test/a.dart::<definingUnit>::@class::A::@constructor::foo
        substitution: {T: int}
      staticType: null
    staticElement: ConstructorMember
      base: package:test/a.dart::<definingUnit>::@class::A::@constructor::foo
