...
ImplicitCallReference
  expression: AssignmentExpression
    leftHandSide: IndexExpression
      ...
      index: IntegerLiteral
        ...
        parameter: ParameterMember
          base: dart:core::<definingUnit>::@class::Map::@method::[]=::@parameter::key
    ...
    rightHandSide: SimpleIdentifier
      token: c
      parameter: ParameterMember
        base: dart:core::<definingUnit>::@class::Map::@method::[]=::@parameter::value
        substitution: {K: int, V: C}
      staticElement: <thisLibrary>::<definingUnit>::@function::foo::@parameter::c
      staticType: C
    readElement: <null>
    readType: null
    writeElement: MethodMember
      base: dart:core::<definingUnit>::@class::Map::@method::[]=
      substitution: {K: int, V: C}
    writeType: C
    staticElement: <null>
    staticType: C
  staticElement: <thisLibrary>::<definingUnit>::@class::C::@method::call
...
ImplicitCallReference
  expression: BinaryExpression
    leftOperand: SimpleIdentifier
      token: c1
      staticElement: <thisLibrary>::<definingUnit>::@function::foo::@parameter::c1
      staticType: C?
    operator: ??
    rightOperand: SimpleIdentifier
      token: c2
      parameter: <null>
      staticElement: <thisLibrary>::<definingUnit>::@function::foo::@parameter::c2
      staticType: C
    staticElement: <null>
    staticInvokeType: null
    staticType: C
...
ImplicitCallReference
  expression: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: c
      staticElement: <thisLibrary>::<definingUnit>::@class::C::@getter::c
      staticType: C
    staticElement: <thisLibrary>::<definingUnit>::@class::C::@getter::c
    staticType: C
  staticElement: <thisLibrary>::<definingUnit>::@class::C::@method::call
...
ImplicitCallReference
  expression: SimpleIdentifier
    token: y
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::y
    staticType: Y
  staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::call
  staticType: void Function()
''');
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::a
          substitution: {T: int, U: String}
        staticType: int
    rightParenthesis: )
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@function::A::@parameter::a
          substitution: {T: int, U: String}
        staticType: int
    rightParenthesis: )
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@constructor::new::@parameter::_
          substitution: {T: int, U: String}
        staticType: int
    rightParenthesis: )
  staticType: A<int, String>
...
InstanceCreationExpression
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: named
      staticElement: ConstructorMember
        base: package:test/a.dart::<definingUnit>::@class::A::@constructor::named
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: package:test/a.dart::<definingUnit>::@class::A::@constructor::named::@parameter::a
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticType: A<int>
...
InstanceCreationExpression
  constructorName: ConstructorName
    ...
    name: SimpleIdentifier
      token: new
      staticElement: ConstructorMember
        base: package:test/a.dart::<definingUnit>::@class::A::@constructor::new
        substitution: {T: int}
      staticType: null
    staticElement: ConstructorMember
      base: package:test/a.dart::<definingUnit>::@class::A::@constructor::new
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: package:test/a.dart::<definingUnit>::@class::A::@constructor::new::@parameter::a
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticType: A<int>
...
MethodInvocation
  ...
  methodName: SimpleIdentifier
    token: bar
    staticElement: package:test/a.dart::<definingUnit>::@class::A::@method::bar
    staticType: void Function(int)
  argumentList: ArgumentList
    leftParenthesis: (
    arguments
      IntegerLiteral
        literal: 0
        parameter: package:test/a.dart::<definingUnit>::@class::A::@method::bar::@parameter::a
        staticType: int
    rightParenthesis: )
  staticInvokeType: void Function(int)
  staticType: void
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@class::A::@constructor::named::@parameter::a
          substitution: {T: int}
        staticType: int
    rightParenthesis: )
  staticType: A<int>
  ...
  argumentList: ArgumentList
    ...
    arguments
      SimpleIdentifier
        ...
        staticType: A
    rightParenthesis: )
  element: package:test/a.dart::<definingUnit>::@extension::E
  extendedType: A
  staticType: null
  typeArgumentTypes
    int
...
MethodInvocation
  ...
  methodName: SimpleIdentifier
    token: A
    staticElement: package:test/a.dart::<definingUnit>::@function::A
    staticType: void Function<T, U>(int)
  typeArguments: TypeArgumentList
    leftBracket: <
    arguments
  ...
  argumentList: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: package:test/a.dart::<definingUnit>::@function::A::@parameter::a
          substitution: {T: int, U: String}
        staticType: int
    rightParenthesis: )
  staticInvokeType: void Function(int)
