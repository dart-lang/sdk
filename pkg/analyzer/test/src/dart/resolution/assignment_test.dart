...
AssignmentExpression
  ...
  rightHandSide: IntegerLiteral
    literal: 0
    parameter: package:test/a.dart::@fragment::package:test/a.dart::@setter::v::@parameter::_v
    staticType: int
  readElement: <null>
  readType: null
  writeElement: package:test/a.dart::@fragment::package:test/a.dart::@setter::v
  writeType: int
  staticElement: <null>
  staticType: int
''');
