  ...
  parameters: FormalParameterList
    ...
    parameter: SimpleFormalParameter
      type: NamedType
        ...
        type: int
      name: b
      declaredElement: <thisLibrary>::<definingUnit>::@class::B::@constructor::new::@parameter::a::@parameter::b
        type: int
    rightParenthesis: )
  declaredElement: <thisLibrary>::<definingUnit>::@class::B::@constructor::new::@parameter::a
...
SimpleIdentifier
  token: a
  staticElement: <thisLibrary>::<definingUnit>::@class::B::@constructor::new::@parameter::a
  staticType: int
''');
  }
}
