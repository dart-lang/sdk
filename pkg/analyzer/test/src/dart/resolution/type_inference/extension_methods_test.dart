...
PrefixedIdentifier
  ...
  identifier: SimpleIdentifier
    ...
    staticElement: PropertyAccessorMember
      base: <thisLibrary>::<definingUnit>::@extension::E::@getter::foo
      substitution: {T: int}
    staticType: List<int>
  staticElement: PropertyAccessorMember
    base: <thisLibrary>::<definingUnit>::@extension::E::@getter::foo
...
MethodInvocation
  target: SimpleIdentifier
    token: other
    staticElement: <thisLibrary>::<definingUnit>::@extension::E::@method::bar::@parameter::other
    staticType: List<T>
  operator: .
  methodName: SimpleIdentifier
    token: foo
...
AssignmentExpression
  ...
  rightHandSide: IntegerLiteral
    literal: 0
    parameter: ParameterMember
      base: <thisLibrary>::<definingUnit>::@extension::E::@setter::foo::@parameter::value
      substitution: {T: int}
    staticType: int
  readElement: <null>
  readType: null
  writeElement: PropertyAccessorMember
    base: <thisLibrary>::<definingUnit>::@extension::E::@setter::foo
    substitution: {T: int}
  writeType: int
  staticElement: <null>
  staticType: int
...
MethodInvocation
  ...
  methodName: SimpleIdentifier
    token: test
    staticElement: MethodMember
      base: <thisLibrary>::<definingUnit>::@extension::Test::@method::test
      substitution: {T: S}
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: test
    staticElement: PropertyAccessorMember
      base: <thisLibrary>::<definingUnit>::@extension::Test::@getter::test
      substitution: {T: S}
    staticType: S Function(S)
  staticType: S Function(S)
''');
...
AssignmentExpression
  ...
  rightHandSide: MethodInvocation
    ...
    argumentList: ArgumentList
      ...
      rightParenthesis: )
    parameter: ParameterMember
      base: <thisLibrary>::<definingUnit>::@extension::Test::@setter::test::@parameter::_
      substitution: {T: S}
  ...
  readType: null
  writeElement: PropertyAccessorMember
    base: <thisLibrary>::<definingUnit>::@extension::Test::@setter::test
    substitution: {T: S}
  writeType: S
  staticElement: <null>
  staticType: S
