  ...
  parameters: FormalParameterList
    ...
    parameter: SimpleFormalParameter
      type: NamedType
        ...
        type: U
      name: a
      declaredElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::p::@parameter::a
        type: U
    parameter: SimpleFormalParameter
      type: NamedType
        name: V
        ...
        type: V
      name: b
      declaredElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::p::@parameter::b
        type: V
    rightParenthesis: )
  declaredElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::p
