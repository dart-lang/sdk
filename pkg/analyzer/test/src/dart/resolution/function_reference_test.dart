...
FunctionReference
  function: ConstructorReference
    constructorName: ConstructorName
      ...
      name: SimpleIdentifier
        token: delayed
        staticElement: dart:async::<definingUnit>::@class::Future::@constructor::delayed
        staticType: null
      staticElement: dart:async::<definingUnit>::@class::Future::@constructor::delayed
...
FunctionReference
  function: SimpleIdentifier
    token: i
    staticElement: <thisLibrary>::<definingUnit>::@getter::i
    staticType: dynamic
  typeArguments: TypeArgumentList
    leftBracket: <
    arguments
...
FunctionReference
  function: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: E
      staticElement: package:test/a.dart::<definingUnit>::@extension::E
      staticType: InvalidType
    staticElement: package:test/a.dart::<definingUnit>::@extension::E
    staticType: InvalidType
  typeArguments: TypeArgumentList
      ...
      argumentList: ArgumentList
        ...
        arguments
          SimpleIdentifier
            token: a
            parameter: <null>
            staticElement: <thisLibrary>::<definingUnit>::@function::bar::@parameter::a
            staticType: A
        rightParenthesis: )
...
FunctionReference
  function: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: m
      staticElement: <thisLibrary>::<definingUnit>::@extension::0::@method::m
      staticType: null
    staticElement: <thisLibrary>::<definingUnit>::@extension::0::@method::m
    staticType: void Function<T>(T)
  typeArguments: TypeArgumentList
...
ImplicitCallReference
  expression: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: v
      staticElement: <thisLibrary>::<definingUnit>::@class::C::@getter::v
      staticType: null
    staticElement: <thisLibrary>::<definingUnit>::@class::C::@getter::v
    staticType: null
  typeArguments: TypeArgumentList
...
ImplicitCallReference
  expression: SimpleIdentifier
    token: v
    staticElement: <thisLibrary>::<definingUnit>::@getter::v
    staticType: Object?
  typeArguments: TypeArgumentList
    leftBracket: <
    arguments
...
ImplicitCallReference
  expression: SimpleIdentifier
    ...
    staticType: A
  parameter: <thisLibrary>::<definingUnit>::@function::g::@parameter::f
  staticElement: <thisLibrary>::<definingUnit>::@extensionType::A::@method::call
...
ImplicitCallReference
  expression: PropertyAccess
    ...
    propertyName: SimpleIdentifier
      token: v
      staticElement: package:test/a.dart::<definingUnit>::@class::C::@getter::v
      staticType: C
    staticType: C
  typeArguments: TypeArgumentList
    leftBracket: <
    arguments
      NamedType
        ...
        type: int
    rightBracket: >
  staticElement: package:test/a.dart::<definingUnit>::@class::C::@method::call
  staticType: int Function(int)
  typeArgumentTypes
    int
''');
...
ImplicitCallReference
  expression: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: c
      staticElement: package:test/a.dart::<definingUnit>::@getter::c
      staticType: C
    staticElement: package:test/a.dart::<definingUnit>::@getter::c
    staticType: C
  typeArguments: TypeArgumentList
...
FunctionReference
  function: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: f
      staticElement: <thisLibrary>::<definingUnit>::@class::A::@getter::f
      staticType: List<int>
    staticElement: <thisLibrary>::<definingUnit>::@class::A::@getter::f
    staticType: List<int>
  typeArguments: TypeArgumentList
...
FunctionReference
  function: PropertyAccess
    target: PrefixedIdentifier
      prefix: SimpleIdentifier
        token: c
        staticElement: <thisLibrary>::<definingUnit>::@function::bar::@parameter::c
        staticType: C
      period: .
      identifier: SimpleIdentifier
        token: foo
  ...
  function: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      ...
      staticElement: MethodMember
        base: <thisLibrary>::<definingUnit>::@extension::StaticType::@method::expectStaticType
        ...
        typeArguments: TypeArgumentList
          ...
          arguments
            NamedType
              ...
              type: int
          rightBracket: >
        element: <thisLibrary>::<definingUnit>::@typeAlias::Exactly
        type: int Function(int)
          alias: <thisLibrary>::<definingUnit>::@typeAlias::Exactly
            typeArguments
              int
    rightBracket: >
  staticType: void Function()
...
FunctionReference
  function: PropertyAccess
    target: PropertyAccess
      ...
      propertyName: SimpleIdentifier
        token: foo
        staticElement: <thisLibrary>::<definingUnit>::@extension::0::@method::foo
        staticType: void Function<T>(T)
      staticType: void Function<T>(T)
    operator: .
    propertyName: SimpleIdentifier
...
FunctionReference
  function: PropertyAccess
    ...
    propertyName: SimpleIdentifier
      token: foo
      staticElement: package:test/a.dart::<definingUnit>::@class::A::@method::foo
      staticType: void Function<T>(T)
    staticType: void Function<T>(T)
  typeArguments: TypeArgumentList
    leftBracket: <
...
FunctionReference
  function: SimpleIdentifier
    token: foo
    staticElement: <thisLibrary>::<definingUnit>::@function::bar::@parameter::foo
    staticType: void Function<T>(T)
  typeArguments: TypeArgumentList
    leftBracket: <
    arguments
...
FunctionReference
  function: PropertyAccess
    target: PrefixedIdentifier
      ...
      identifier: SimpleIdentifier
        token: TA
        staticElement: package:test/a.dart::<definingUnit>::@typeAlias::TA
        staticType: Type
      staticElement: package:test/a.dart::<definingUnit>::@typeAlias::TA
      staticType: Type
    operator: .
...
FunctionReference
  function: PrefixedIdentifier
    prefix: SimpleIdentifier
      token: TA
      staticElement: <thisLibrary>::<definingUnit>::@typeAlias::TA
      staticType: null
    period: .
    identifier: SimpleIdentifier
      token: foo
...
FunctionReference
  function: PrefixedIdentifier
    prefix: SimpleIdentifier
      token: Cb
      staticElement: <thisLibrary>::<definingUnit>::@typeAlias::Cb
      staticType: Type
    period: .
    identifier: SimpleIdentifier
      token: foo
...
FunctionReference
  function: PrefixedIdentifier
    prefix: SimpleIdentifier
      token: T
      staticElement: <thisLibrary>::<definingUnit>::@typeAlias::T
      staticType: Type
    period: .
    identifier: SimpleIdentifier
      token: foo
...
FunctionReference
  function: AssignmentExpression
    ...
    rightHandSide: SimpleIdentifier
      token: f
      parameter: <thisLibrary>::<definingUnit>::@setter::g::@parameter::_g
      staticElement: <thisLibrary>::<definingUnit>::@function::foo::@parameter::f
      staticType: void Function<T>(T)
    readElement: <null>
    readType: null
    writeElement: <thisLibrary>::<definingUnit>::@setter::g
...
FunctionReference
  function: AssignmentExpression
    ...
    rightHandSide: IntegerLiteral
      literal: 1
      parameter: <thisLibrary>::<definingUnit>::@extension::0::@method::+::@parameter::i
      staticType: int
    readElement: <thisLibrary>::<definingUnit>::@function::foo::@parameter::f
    readType: void Function<T>(T)
    writeElement: <thisLibrary>::<definingUnit>::@function::foo::@parameter::f
    writeType: void Function<T>(T)
...
FunctionReference
  function: PrefixedIdentifier
    ...
    identifier: SimpleIdentifier
      token: f
      staticElement: <thisLibrary>::<definingUnit>::@class::C::@getter::f
      staticType: void Function<T>(T)
    staticElement: <thisLibrary>::<definingUnit>::@class::C::@getter::f
    staticType: void Function<T>(T)
  staticType: void Function(int)
