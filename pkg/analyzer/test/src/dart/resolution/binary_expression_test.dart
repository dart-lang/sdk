...
BinaryExpression
  ...
  rightOperand: IntegerLiteral
    literal: 0
    parameter: <thisLibrary>::<definingUnit>::@extension::0::@method::+::@parameter::other
    staticType: int
  staticElement: <thisLibrary>::<definingUnit>::@extension::0::@method::+
...
BinaryExpression
  ...
  rightOperand: IntegerLiteral
    literal: 3
    parameter: <thisLibrary>::<definingUnit>::@class::A::@method::>>>::@parameter::amount
    staticType: int
  staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::>>>
...
BinaryExpression
  leftOperand: AugmentedExpression
    ...
    element: <thisLibrary>::<definingUnit>::@class::A::@method::+
    staticType: A
  operator: +
  rightOperand: IntegerLiteral
    literal: 0
...
BinaryExpression
  leftOperand: AugmentedExpression
    augmentedKeyword: augmented
    element: <thisLibrary>::<definingUnit>::@class::A::@method::unary-
    staticType: A
  operator: +
  rightOperand: IntegerLiteral
    literal: 0
...
BinaryExpression
  leftOperand: AugmentedExpression
    augmentedKeyword: augmented
    element: <thisLibrary>::<definingUnit>::@class::A::@setter::foo
    staticType: InvalidType
  operator: +
  rightOperand: IntegerLiteral
    literal: 1
...
BinaryExpression
  ...
  rightOperand: SimpleIdentifier
    token: b
    parameter: <thisLibrary>::<definingUnit>::@extensionType::Int::@method::+::@parameter::other
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::b
    staticType: int
  staticElement: <thisLibrary>::<definingUnit>::@extensionType::Int::@method::+
  staticInvokeType: Int Function(int)
  staticType: Int
''');
  }
...
BinaryExpression
  ...
  rightOperand: IntegerLiteral
    literal: 0
    parameter: <thisLibrary>::<definingUnit>::@class::A::@method::+::@parameter::other
    staticType: int
  staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::+
  staticInvokeType: int Function(int)
  staticType: int
...
MethodInvocation
  ...
  argumentList: ArgumentList
    leftParenthesis: (
    rightParenthesis: )
  parameter: <thisLibrary>::<definingUnit>::@extension::E::@method::+::@parameter::x
  staticInvokeType: num Function()
  staticType: num
  typeArgumentTypes
    num
...
BinaryExpression
  ...
  rightOperand: SimpleIdentifier
    token: b
    parameter: <thisLibrary>::<definingUnit>::@extension::E::@method::+::@parameter::other
    staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::b
    staticType: int
...
BinaryExpression
  ...
  staticElement: MethodMember
    base: <thisLibrary>::<definingUnit>::@extension::FooExtension::@method::+
    substitution: {F: F}
...
MethodInvocation
  ...
  argumentList: ArgumentList
    leftParenthesis: (
    rightParenthesis: )
  parameter: <thisLibrary>::<definingUnit>::@class::A::@method::+::@parameter::x
