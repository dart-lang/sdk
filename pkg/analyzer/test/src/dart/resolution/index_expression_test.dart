...
MethodInvocation
  ...
  argumentList: ArgumentList
    leftParenthesis: (
    rightParenthesis: )
  parameter: <thisLibrary>::<definingUnit>::@class::A::@method::[]::@parameter::index
...
IndexExpression
  ...
  index: IntegerLiteral
    ...
    staticType: int
  rightBracket: ]
  staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::[]
  staticType: bool
''');
  }
...
IndexExpression
  ...
  index: IntegerLiteral
    ...
    parameter: ParameterMember
      base: <thisLibrary>::<definingUnit>::@class::A::@method::[]::@parameter::index
      substitution: {T: double}
    staticType: int
  rightBracket: ]
  staticElement: MethodMember
    base: <thisLibrary>::<definingUnit>::@class::A::@method::[]
    substitution: {T: double}
  staticType: double
''');
  }
...
IndexExpression
  ...
  index: SimpleIdentifier
    token: b
    parameter: ParameterMember
      base: dart:core::<definingUnit>::@class::List::@method::[]::@parameter::index
      substitution: {E: int}
    staticElement: <null>
    staticType: InvalidType
  rightBracket: ]
  staticElement: MethodMember
    base: dart:core::<definingUnit>::@class::List::@method::[]
    substitution: {E: int}
  staticType: int
''');
  }
...
AssignmentExpression
  ...
  rightHandSide: DoubleLiteral
    ...
    staticType: double
  readElement: <thisLibrary>::<definingUnit>::@class::A::@method::[]
  readType: num
  writeElement: <thisLibrary>::<definingUnit>::@class::A::@method::[]=
  writeType: num
...
AssignmentExpression
  ...
  rightHandSide: DoubleLiteral
    literal: 1.2
    parameter: dart:core::<definingUnit>::@class::double::@method::+::@parameter::other
    staticType: double
  ...
  writeElement: MethodMember
    ...
    substitution: {T: double}
  writeType: double
  staticElement: dart:core::<definingUnit>::@class::double::@method::+
  staticType: double
''');
  }
...
AssignmentExpression
  ...
  rightHandSide: DoubleLiteral
    literal: 1.2
    parameter: <thisLibrary>::<definingUnit>::@class::A::@method::[]=::@parameter::value
    staticType: double
  readElement: <null>
  readType: null
  writeElement: <thisLibrary>::<definingUnit>::@class::A::@method::[]=
  ...
  cascadeSections
    AssignmentExpression
      ...
      rightHandSide: SimpleIdentifier
        token: a
        parameter: <thisLibrary>::<definingUnit>::@class::A::@method::[]=::@parameter::a
        staticElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::a
        staticType: A
      readElement: <null>
      readType: null
...
AssignmentExpression
  ...
  rightHandSide: DoubleLiteral
    literal: 1.2
    parameter: ParameterMember
      base: <thisLibrary>::<definingUnit>::@class::A::@method::[]=::@parameter::value
      substitution: {T: double}
    staticType: double
  readElement: <null>
  readType: null
