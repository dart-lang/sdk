...
''',
      [error(CompileTimeErrorCode.dotShorthandMissingContext, 50, 14)],
    );
  }
...
''',
      [
        error(CompileTimeErrorCode.dotShorthandMissingContext, 50, 21),
        error(CompileTimeErrorCode.undefinedIdentifier, 63, 7),
      ],
    );
  }
