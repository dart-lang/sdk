...
AugmentedInvocation
  ...
  arguments: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: package:test/a.dart::@fragment::package:test/a.dart::@class::A::@constructor::named::@parameter::a
        staticType: int
    rightParenthesis: )
...
AugmentedInvocation
  ...
  arguments: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: package:test/a.dart::@fragment::package:test/a.dart::@class::A::@method::foo::@parameter::a
        staticType: int
    rightParenthesis: )
  element: package:test/a.dart::@fragment::package:test/a.dart::@class::A::@method::foo
  staticType: void
''');
  }
...
AugmentedInvocation
  ...
  arguments: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: package:test/a.dart::@fragment::package:test/a.dart::@function::foo::@parameter::a
        staticType: int
    rightParenthesis: )
  element: package:test/a.dart::@fragment::package:test/a.dart::@function::foo
  staticType: void
''');
  }
  ...
  arguments: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: package:test/a.dart::@fragment::package:test/a.dart::@function::foo::@parameter::t
      ...
      FunctionExpression
        ...
        parameter: ParameterMember
          base: package:test/a.dart::@fragment::package:test/a.dart::@function::foo::@parameter::f
          substitution: {T: int, U: String}
...
ExpressionStatement
  expression: FunctionExpressionInvocation
    ...
    argumentList: ArgumentList
      leftParenthesis: (
      rightParenthesis: )
    staticElement: package:test/a.dart::@fragment::package:test/a.dart::@class::A::@method::call
...
ExpressionStatement
  expression: FunctionExpressionInvocation
    ...
    argumentList: ArgumentList
      leftParenthesis: (
      rightParenthesis: )
    staticElement: package:test/a.dart::@fragment::package:test/a.dart::@extension::E::@method::call
    staticInvokeType: int Function()
    staticType: int
  semicolon: ;
''');
    ...
    arguments: ArgumentList
      ...
      arguments
        ...
        IntegerLiteral
          ...
          staticType: int
      rightParenthesis: )
    element: package:test/a.dart::@fragment::package:test/a.dart::@setter::foo
    staticType: InvalidType
  semicolon: ;
''');
  }
