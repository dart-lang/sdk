...
AugmentedInvocation
  ...
  arguments: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: <thisLibrary>::<definingUnit>::@class::A::@method::foo::@parameter::a
        staticType: int
    rightParenthesis: )
  ...
  arguments: ArgumentList
    ...
    arguments
      IntegerLiteral
        literal: 0
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@function::foo::@parameter::t
      ...
      FunctionExpression
        ...
        parameter: ParameterMember
          base: <thisLibrary>::<definingUnit>::@function::foo::@parameter::f
          substitution: {T: int, U: String}
    ...
    arguments: ArgumentList
      ...
      arguments
        ...
        IntegerLiteral
          ...
          staticType: int
      rightParenthesis: )
    element: <thisLibrary>::<definingUnit>::@setter::foo
    staticType: InvalidType
  semicolon: ;
''');
  }
