...
AssignmentExpression
  ...
  rightHandSide: IntegerLiteral
    ...
    staticType: int
  readElement: <thisLibrary>::<definingUnit>::@extension::E::@getter::foo
  readType: int
  writeElement: <thisLibrary>::<definingUnit>::@extension::E::@setter::foo
  writeType: num
...
AssignmentExpression
  ...
  rightHandSide: IntegerLiteral
    literal: 1
    parameter: <thisLibrary>::<definingUnit>::@extension::E::@setter::foo::@parameter::_
    staticType: int
  readElement: <null>
  readType: null
  writeElement: <thisLibrary>::<definingUnit>::@extension::E::@setter::foo
...
DefaultFormalParameter
  parameter: SimpleFormalParameter
    name: a
    declaredElement: <thisLibrary>::<definingUnit>::@function::f::@parameter::a
      type: dynamic
  separator: =
...
CascadeExpression
  ...
  cascadeSections
    ...
    PropertyAccess
      ...
      propertyName: SimpleIdentifier
        token: bar
        staticElement: <thisLibrary>::<definingUnit>::@class::A::@getter::bar
        staticType: int
      staticType: int
  staticType: A?
''');
...
CascadeExpression
  ...
  cascadeSections
    PropertyAccess
      ...
      propertyName: SimpleIdentifier
        token: baz
        staticElement: <thisLibrary>::<definingUnit>::@class::A::@getter::baz
        staticType: A?
      staticType: A?
  staticType: A
''');
...
CascadeExpression
  ...
  cascadeSections
    PropertyAccess
      ...
      propertyName: SimpleIdentifier
        token: baq
        staticElement: <thisLibrary>::<definingUnit>::@class::A::@getter::baq
        staticType: A
      staticType: A
  staticType: A?
''');
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: runtimeType
    staticElement: dart:core::<definingUnit>::@class::Object::@getter::runtimeType
    staticType: Type
  staticType: Type
''');
  }
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: foo
    staticElement: <thisLibrary>::<definingUnit>::@mixin::M::@getter::foo
    staticType: int
  staticType: int
''');
  }
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: foo
    staticElement: <thisLibrary>::<definingUnit>::@extension::IntStringRecordExtension::@getter::foo
    staticType: int
  staticType: int
''');
  }
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: foo
    staticElement: PropertyAccessorMember
      base: <thisLibrary>::<definingUnit>::@extension::BiRecordExtension::@getter::foo
...
PropertyAccess
  target: SimpleIdentifier
    token: r
    staticElement: package:test/a.dart::<definingUnit>::@getter::r
    staticType: ({int foo})
  operator: .
  propertyName: SimpleIdentifier
    token: foo
...
PropertyAccess
  ...
  propertyName: SimpleIdentifier
    token: $3
    staticElement: <thisLibrary>::<definingUnit>::@extension::0::@getter::$3
    staticType: bool
  staticType: bool
''');
  }
...
PropertyAccess
  target: ParenthesizedExpression
    ...
    expression: SimpleIdentifier
      token: t
      staticElement: <thisLibrary>::<definingUnit>::@class::A::@method::f::@parameter::t
      staticType: T
    rightParenthesis: )
    staticType: T
  operator: .
...
PropertyAccess
  target: ParenthesizedExpression
    ...
    expression: SimpleIdentifier
      token: t
      staticElement: <thisLibrary>::<definingUnit>::@class::C::@method::f::@parameter::t
      staticType: T
    rightParenthesis: )
    staticType: T
  operator: .
