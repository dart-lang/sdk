...
library
  ...
  classes
    isSimplyBounded class A
      ...
      firstFragment: #F1
      fields
        hasImplicitType hasInitializer isConst isOriginDeclaration isStatic f01
        ...
        hasImplicitType hasInitializer isConst isOriginDeclaration isStatic f02
    ...
    isSimplyBounded class A
      ...
      firstFragment: #F7
      fields
        hasImplicitType hasInitializer isConst isOriginDeclaration isStatic f11
        ...
        hasImplicitType hasInitializer isConst isOriginDeclaration isStatic f12
    ...
    isSimplyBounded class A
      ...
      firstFragment: #F13
      fields
        hasImplicitType hasInitializer isConst isOriginDeclaration isStatic f21
        ...
        hasImplicitType hasInitializer isConst isOriginDeclaration isStatic f22
  ...
  enums
    ...
    isSimplyBounded enum E
      ...
      fields
        ...
        hasImplicitType hasInitializer isConst isEnumConstant isOriginDeclaration isStatic d
        ...
        hasImplicitType hasInitializer isConst isEnumConstant isOriginDeclaration isStatic e
...
library
  ...
  extensions
    ...
    extension E
      ...
      onDeclaration: dart:core::@class::int
      fields
        hasImplicitType hasInitializer isOriginDeclaration isStatic y
...
library
  ...
  fragments
    #F0 <testLibraryFragment>
      ...
      getters
        #F5 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:5)
          element: <testLibrary>::@getter::x::@def::0
        #F6 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:12)
          element: <testLibrary>::@getter::x::@def::1
        #F7 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:21)
          element: <testLibrary>::@getter::x::@def::2
        #F8 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:32)
          element: <testLibrary>::@getter::x::@def::3
      setters
        #F9 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:5)
        ...
        #F11 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:12)
        ...
        #F13 isOriginVariable isStatic x (nameOffset:<null>) (firstTokenOffset:<null>) (offset:32)
  ...
  topLevelVariables
    isOriginDeclaration isStatic shouldUseTypeForInitializerInference x
    ...
    hasImplicitType hasInitializer isOriginDeclaration isStatic x
