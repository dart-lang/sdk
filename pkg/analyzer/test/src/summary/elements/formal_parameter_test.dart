        ...
        #F1 class C (nameOffset:6) (firstTokenOffset:0) (offset:6)
          ...
          constructors
            #F2 isOriginDeclaration positional (nameOffset:14) (firstTokenOffset:12) (offset:14)
              ...
              periodOffset: 13
              formalParameters
                #F3 optionalPositional hasImplicitType isOriginDeclaration x (nameOffset:26) (firstTokenOffset:26) (offset:26)
            ...
            #F4 isOriginDeclaration named (nameOffset:39) (firstTokenOffset:37) (offset:39)
              ...
              periodOffset: 38
              formalParameters
                #F5 optionalNamed hasImplicitType isOriginDeclaration x (nameOffset:46) (firstTokenOffset:46) (offset:46)
    ...
    isSimplyBounded class C
      ...
      constructors
        isOriginImplicitDefault new
          ...
          firstFragment: #F2
      methods
        isOriginDeclaration isStatic positional
          ...
          formalParameters
            #E0 optionalPositional hasDefaultValue hasImplicitType x
              ...
              constantInitializer
                ...
                expression: expression_0
          returnType: void
        isOriginDeclaration isStatic named
