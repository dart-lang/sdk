...
class _SVGRectElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGRectElement {
  _SVGRectElementWrappingImplementation() : super() {}

  static create__SVGRectElementWrappingImplementation() native {
    return new _SVGRectElementWrappingImplementation();
  }
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGRectElement(this); }
  static CSSStyleDeclaration _get_style_SVGRectElement(var _this) native;
  ...
  String get typeName() { return "SVGRectElement"; }
}
