...
class _SVGFEMergeElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGFEMergeElement {
  _SVGFEMergeElementWrappingImplementation() : super() {}

  static create__SVGFEMergeElementWrappingImplementation() native {
    return new _SVGFEMergeElementWrappingImplementation();
  }
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGFEMergeElement(this); }
  static CSSStyleDeclaration _get_style_SVGFEMergeElement(var _this) native;
  ...
  String get typeName() { return "SVGFEMergeElement"; }
}
