...
class _SVGUseElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGUseElement {
  _SVGUseElementWrappingImplementation() : super() {}

  static create__SVGUseElementWrappingImplementation() native {
    return new _SVGUseElementWrappingImplementation();
  }

  SVGElementInstance get animatedInstanceRoot() { return _get_animatedInstanceRoot(this); }
  static SVGElementInstance _get_animatedInstanceRoot(var _this) native;

  SVGAnimatedLength get height() { return _get_height(this); }
  static SVGAnimatedLength _get_height(var _this) native;

  SVGElementInstance get instanceRoot() { return _get_instanceRoot(this); }
  static SVGElementInstance _get_instanceRoot(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGUseElement(this); }
  static CSSStyleDeclaration _get_style_SVGUseElement(var _this) native;
  ...
  String get typeName() { return "SVGUseElement"; }
}
