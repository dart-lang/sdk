...
class _SVGFEDropShadowElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGFEDropShadowElement {
  _SVGFEDropShadowElementWrappingImplementation() : super() {}

  static create__SVGFEDropShadowElementWrappingImplementation() native {
    return new _SVGFEDropShadowElementWrappingImplementation();
  }

  SVGAnimatedNumber get dx() { return _get_dx(this); }
  static SVGAnimatedNumber _get_dx(var _this) native;

  SVGAnimatedNumber get dy() { return _get_dy(this); }
  static SVGAnimatedNumber _get_dy(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGFEDropShadowElement(this); }
  static CSSStyleDeclaration _get_style_SVGFEDropShadowElement(var _this) native;
  ...
  String get typeName() { return "SVGFEDropShadowElement"; }
}
