...
class _SVGFEOffsetElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGFEOffsetElement {
  _SVGFEOffsetElementWrappingImplementation() : super() {}

  static create__SVGFEOffsetElementWrappingImplementation() native {
    return new _SVGFEOffsetElementWrappingImplementation();
  }
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGFEOffsetElement(this); }
  static CSSStyleDeclaration _get_style_SVGFEOffsetElement(var _this) native;
  ...
  String get typeName() { return "SVGFEOffsetElement"; }
}
