...
class _SVGPolygonElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGPolygonElement {
  _SVGPolygonElementWrappingImplementation() : super() {}

  static create__SVGPolygonElementWrappingImplementation() native {
    return new _SVGPolygonElementWrappingImplementation();
  }

  SVGPointList get animatedPoints() { return _get_animatedPoints(this); }
  static SVGPointList _get_animatedPoints(var _this) native;

  SVGPointList get points() { return _get_points(this); }
  static SVGPointList _get_points(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGPolygonElement(this); }
  static CSSStyleDeclaration _get_style_SVGPolygonElement(var _this) native;
  ...
  String get typeName() { return "SVGPolygonElement"; }
}
