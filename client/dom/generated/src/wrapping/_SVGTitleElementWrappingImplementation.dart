...
class _SVGTitleElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGTitleElement {
  _SVGTitleElementWrappingImplementation() : super() {}

  static create__SVGTitleElementWrappingImplementation() native {
    return new _SVGTitleElementWrappingImplementation();
  }
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGTitleElement(this); }
  static CSSStyleDeclaration _get_style_SVGTitleElement(var _this) native;
  ...
  String get typeName() { return "SVGTitleElement"; }
}
