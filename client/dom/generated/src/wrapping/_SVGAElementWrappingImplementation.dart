...
class _SVGAElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGAElement {
  _SVGAElementWrappingImplementation() : super() {}

  static create__SVGAElementWrappingImplementation() native {
    return new _SVGAElementWrappingImplementation();
  }

  SVGAnimatedString get target() { return _get_target(this); }
  static SVGAnimatedString _get_target(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGAElement(this); }
  static CSSStyleDeclaration _get_style_SVGAElement(var _this) native;
  ...
  String get typeName() { return "SVGAElement"; }
}
