...
class _SVGClipPathElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGClipPathElement {
  _SVGClipPathElementWrappingImplementation() : super() {}

  static create__SVGClipPathElementWrappingImplementation() native {
    return new _SVGClipPathElementWrappingImplementation();
  }

  SVGAnimatedEnumeration get clipPathUnits() { return _get_clipPathUnits(this); }
  static SVGAnimatedEnumeration _get_clipPathUnits(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGClipPathElement(this); }
  static CSSStyleDeclaration _get_style_SVGClipPathElement(var _this) native;
  ...
  String get typeName() { return "SVGClipPathElement"; }
}
