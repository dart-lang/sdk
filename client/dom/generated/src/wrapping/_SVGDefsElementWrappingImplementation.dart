...
class _SVGDefsElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGDefsElement {
  _SVGDefsElementWrappingImplementation() : super() {}

  static create__SVGDefsElementWrappingImplementation() native {
    return new _SVGDefsElementWrappingImplementation();
  }
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGDefsElement(this); }
  static CSSStyleDeclaration _get_style_SVGDefsElement(var _this) native;
  ...
  String get typeName() { return "SVGDefsElement"; }
}
