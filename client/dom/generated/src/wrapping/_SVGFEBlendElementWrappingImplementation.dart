...
class _SVGFEBlendElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGFEBlendElement {
  _SVGFEBlendElementWrappingImplementation() : super() {}

  static create__SVGFEBlendElementWrappingImplementation() native {
    return new _SVGFEBlendElementWrappingImplementation();
  }
  ...
  SVGAnimatedEnumeration get mode() { return _get_mode(this); }
  static SVGAnimatedEnumeration _get_mode(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGFEBlendElement(this); }
  static CSSStyleDeclaration _get_style_SVGFEBlendElement(var _this) native;
  ...
  String get typeName() { return "SVGFEBlendElement"; }
}
