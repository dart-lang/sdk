...
class _SVGLineElementWrappingImplementation extends _SVGElementWrappingImplementation implements SVGLineElement {
  _SVGLineElementWrappingImplementation() : super() {}

  static create__SVGLineElementWrappingImplementation() native {
    return new _SVGLineElementWrappingImplementation();
  }

  SVGAnimatedLength get x1() { return _get_x1(this); }
  static SVGAnimatedLength _get_x1(var _this) native;

  SVGAnimatedLength get x2() { return _get_x2(this); }
  static SVGAnimatedLength _get_x2(var _this) native;

  SVGAnimatedLength get y1() { return _get_y1(this); }
  static SVGAnimatedLength _get_y1(var _this) native;

  SVGAnimatedLength get y2() { return _get_y2(this); }
  static SVGAnimatedLength _get_y2(var _this) native;
  ...
  CSSStyleDeclaration get style() { return _get_style_SVGLineElement(this); }
  static CSSStyleDeclaration _get_style_SVGLineElement(var _this) native;
  ...
  String get typeName() { return "SVGLineElement"; }
}
