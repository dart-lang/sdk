...
class _HTMLFrameSetElementWrappingImplementation extends _HTMLElementWrappingImplementation implements HTMLFrameSetElement {
  ...
  EventListener get onblur() { return _get_onblur_HTMLFrameSetElement(this); }
  static EventListener _get_onblur_HTMLFrameSetElement(var _this) native;

  void set onblur(EventListener value) { _set_onblur_HTMLFrameSetElement(this, value); }
  static void _set_onblur_HTMLFrameSetElement(var _this, EventListener value) native;

  EventListener get onerror() { return _get_onerror_HTMLFrameSetElement(this); }
  static EventListener _get_onerror_HTMLFrameSetElement(var _this) native;

  void set onerror(EventListener value) { _set_onerror_HTMLFrameSetElement(this, value); }
  static void _set_onerror_HTMLFrameSetElement(var _this, EventListener value) native;

  EventListener get onfocus() { return _get_onfocus_HTMLFrameSetElement(this); }
  static EventListener _get_onfocus_HTMLFrameSetElement(var _this) native;

  void set onfocus(EventListener value) { _set_onfocus_HTMLFrameSetElement(this, value); }
  static void _set_onfocus_HTMLFrameSetElement(var _this, EventListener value) native;
  ...
  EventListener get onload() { return _get_onload_HTMLFrameSetElement(this); }
  static EventListener _get_onload_HTMLFrameSetElement(var _this) native;

  void set onload(EventListener value) { _set_onload_HTMLFrameSetElement(this, value); }
  static void _set_onload_HTMLFrameSetElement(var _this, EventListener value) native;
