...
library linter.src.rules.use_collection_literals_when_possible;
...
class UseCollectionLiteralsWhenPossible extends LintRule {
  _Visitor _visitor;
  UseCollectionLiteralsWhenPossible()
      : super(
            name: 'use_collection_literals_when_possible',
            description: _desc,
            details: _details,
            group: Group.style) {
