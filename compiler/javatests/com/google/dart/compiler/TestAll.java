...
public class TestAll {
  ...
  private static final String DART_SDK_PROPERTY_NAME = "com.google.dart.sdk";
  private static final String DART_SDK_ENV_VARIABLE = "DART_SDK";
  
  private static void initSdk() {
    String sdkProperty = System.getProperty(DART_SDK_PROPERTY_NAME);
    
    if (sdkProperty == null) {
      sdkProperty = System.getenv(DART_SDK_ENV_VARIABLE);
      
      if (sdkProperty != null) {
        System.setProperty(DART_SDK_PROPERTY_NAME, sdkProperty);
      }
    }
  }
