...
final class _IsolateExperimental {
  external static R runSync<R>(Isolate isolate, R Function() f);
  external static Isolate create({String? debugName});
  external static void shutdownSync(Isolate isolate);
  external static bool pinToCurrentThread();
  external static bool getIsPinnedToCurrentThread(Isolate isolate);
  external static void runEventLoopSync(Isolate isolate);
  external static void setOnEvent(
    Isolate isolate,
    void Function(Isolate) callback,
  );
  external static void handleEvent(Isolate isolate);
}
...
extension IsolateExperimental on Isolate {
  ...
  R runSync<R>(R Function() f) {
    return _IsolateExperimental.runSync(this, f);
  }
  ...
  static Isolate create({String? debugName}) {
    return _IsolateExperimental.create(debugName: debugName);
  }
  ...
  void shutdownSync() {
    return _IsolateExperimental.shutdownSync(this);
  }
  ...
  static bool pinToCurrentThread() {
    return _IsolateExperimental.pinToCurrentThread();
  }
  ...
  bool get isPinnedToCurrentThread {
    return _IsolateExperimental.getIsPinnedToCurrentThread(this);
  }
  ...
  void runEventLoopSync() {
    return _IsolateExperimental.runEventLoopSync(this);
  }
  ...
  void set onEvent(void Function(Isolate) callback) {
    return _IsolateExperimental.setOnEvent(this, callback);
  }
  ...
  void handleEvent() {
    return _IsolateExperimental.handleEvent(this);
  }
}
