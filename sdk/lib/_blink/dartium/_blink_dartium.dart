...
Native_Node_appendChild_Callback(mthis, newChild) native "Node_appendChild_Callback_RESOLVER_STRING";

Native_Node_cloneNode_Callback(mthis, deep) native "Node_cloneNode_Callback_RESOLVER_STRING";
...
Native_Node_insertBefore_Callback(mthis, newChild, refChild) native "Node_insertBefore_Callback_RESOLVER_STRING";

Native_Node_removeChild_Callback(mthis, oldChild) native "Node_removeChild_Callback_RESOLVER_STRING";

Native_Node_replaceChild_Callback(mthis, newChild, oldChild) native "Node_replaceChild_Callback_RESOLVER_STRING";
...
Native_AudioContext_decodeAudioData_Callback(mthis, audioData, successCallback, errorCallback) native "AudioContext_decodeAudioData_Callback_RESOLVER_STRING";
...
Native_AudioParam_setValueCurveAtTime_Callback(mthis, values, time, duration) native "AudioParam_setValueCurveAtTime_Callback_RESOLVER_STRING";
...
Native_Blob_constructorCallback(blobParts, type, endings) native "Blob_constructorCallback_RESOLVER_STRING";
...
Native_CSSStyleDeclaration___setter___Callback(mthis, propertyName, propertyValue) native "CSSStyleDeclaration___setter___Callback_RESOLVER_STRING";
...
Native_Clipboard_setDragImage_Callback(mthis, element, x, y) native "Clipboard_setDragImage_Callback_RESOLVER_STRING";
...
Native_Crypto_getRandomValues_Callback(mthis, array) native "Crypto_getRandomValues_Callback_RESOLVER_STRING";

Native_CustomEvent_detail_Getter(mthis) native "CustomEvent_detail_Getter";

Native_CustomEvent_initCustomEvent_Callback(mthis, typeArg, canBubbleArg, cancelableArg, detailArg) native "CustomEvent_initCustomEvent_Callback_RESOLVER_STRING";
...
Native_WindowTimers_setInterval_Callback(mthis, handler, timeout) native "WindowTimers_setInterval_Callback_RESOLVER_STRING";

Native_WindowTimers_setTimeout_Callback(mthis, handler, timeout) native "WindowTimers_setTimeout_Callback_RESOLVER_STRING";
...
Native_WorkerGlobalScope_setInterval_Callback(mthis, handler, timeout) native "WorkerGlobalScope_setInterval_Callback_RESOLVER_STRING";

Native_WorkerGlobalScope_setTimeout_Callback(mthis, handler, timeout) native "WorkerGlobalScope_setTimeout_Callback_RESOLVER_STRING";

Native_DedicatedWorkerGlobalScope_postMessage_Callback(mthis, message, messagePorts) native "DedicatedWorkerGlobalScope_postMessage_Callback_RESOLVER_STRING";
...
Native_DeviceMotionEvent_initDeviceMotionEvent_Callback(mthis, type, bubbles, cancelable, acceleration, accelerationIncludingGravity, rotationRate, interval) native "DeviceMotionEvent_initDeviceMotionEvent_Callback_RESOLVER_STRING";
...
Native_DeviceOrientationEvent_initDeviceOrientationEvent_Callback(mthis, type, bubbles, cancelable, alpha, beta, gamma, absolute) native "DeviceOrientationEvent_initDeviceOrientationEvent_Callback_RESOLVER_STRING";
...
Native_Document_createElement_Callback(mthis, localName_OR_tagName, typeExtension) native "Document_createElement_Callback_RESOLVER_STRING";

Native_Document_createElementNS_Callback(mthis, namespaceURI, qualifiedName, typeExtension) native "Document_createElementNS_Callback_RESOLVER_STRING";
...
Native_FormData_constructorCallback(form) native "FormData_constructorCallback_RESOLVER_STRING";

Native_FormData_append_Callback(mthis, name, value) native "FormData_append_Callback_RESOLVER_STRING";

Native_FormData_appendBlob_Callback(mthis, name, value, filename) native "FormData_append_Callback_RESOLVER_STRING";
...
Native_Geolocation_getCurrentPosition_Callback(mthis, successCallback, errorCallback, options) native "Geolocation_getCurrentPosition_Callback_RESOLVER_STRING";

Native_Geolocation_watchPosition_Callback(mthis, successCallback, errorCallback, options) native "Geolocation_watchPosition_Callback_RESOLVER_STRING";
...
Native_HTMLAllCollection_item_Callback(mthis, index) native "HTMLAllCollection_item_Callback_RESOLVER_STRING";
...
Native_HTMLCanvasElement_getContext_Callback(mthis, contextId, attrs) native "HTMLCanvasElement_getContext_Callback_RESOLVER_STRING";

Native_HTMLCanvasElement_toDataURL_Callback(mthis, type, quality) native "HTMLCanvasElement_toDataURL_Callback_RESOLVER_STRING";
...
Native_HTMLEmbedElement___getter___Callback(mthis, index_OR_name) native "HTMLEmbedElement___getter___Callback_RESOLVER_STRING";

Native_HTMLEmbedElement___setter___Callback(mthis, index_OR_name, value) native "HTMLEmbedElement___setter___Callback_RESOLVER_STRING";
...
Native_HTMLObjectElement___getter___Callback(mthis, index_OR_name) native "HTMLObjectElement___getter___Callback_RESOLVER_STRING";

Native_HTMLObjectElement___setter___Callback(mthis, index_OR_name, value) native "HTMLObjectElement___setter___Callback_RESOLVER_STRING";
...
Native_History_pushState_Callback(mthis, data, title, url) native "History_pushState_Callback_RESOLVER_STRING";

Native_History_replaceState_Callback(mthis, data, title, url) native "History_replaceState_Callback_RESOLVER_STRING";
...
Native_Location_assign_Callback(mthis, url) native "Location_assign_Callback_RESOLVER_STRING";

Native_Location_reload_Callback(mthis) native "Location_reload_Callback_RESOLVER_STRING";

Native_Location_replace_Callback(mthis, url) native "Location_replace_Callback_RESOLVER_STRING";
...
Native_MessageEvent_initMessageEvent_Callback(mthis, typeArg, canBubbleArg, cancelableArg, dataArg, originArg, lastEventIdArg, sourceArg, messagePorts) native "MessageEvent_initMessageEvent_Callback_RESOLVER_STRING";

Native_MessagePort_close_Callback(mthis) native "MessagePort_close_Callback_RESOLVER_STRING_0_";

Native_MessagePort_postMessage_Callback(mthis, message, messagePorts) native "MessagePort_postMessage_Callback_RESOLVER_STRING";
...
Native_MutationObserver_constructorCallback(callback) native "MutationObserver_constructorCallback_RESOLVER_STRING";
...
Native_SQLResultSetRowList_item_Callback(mthis, index) native "SQLResultSetRowList_item_Callback_RESOLVER_STRING";

Native_SQLTransaction_executeSql_Callback(mthis, sqlStatement, arguments, callback, errorCallback) native "SQLTransaction_executeSql_Callback_RESOLVER_STRING";
...
Native_ScriptProcessorNode__setEventListener_Callback(mthis, eventListener) native "ScriptProcessorNode__setEventListener_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getAttachedShaders_Callback(mthis, program) native "WebGLRenderingContext_getAttachedShaders_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getBufferParameter_Callback(mthis, target, pname) native "WebGLRenderingContext_getBufferParameter_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getExtension_Callback(mthis, name) native "WebGLRenderingContext_getExtension_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_getFramebufferAttachmentParameter_Callback(mthis, target, attachment, pname) native "WebGLRenderingContext_getFramebufferAttachmentParameter_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_getParameter_Callback(mthis, pname) native "WebGLRenderingContext_getParameter_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getProgramParameter_Callback(mthis, program, pname) native "WebGLRenderingContext_getProgramParameter_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_getRenderbufferParameter_Callback(mthis, target, pname) native "WebGLRenderingContext_getRenderbufferParameter_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getShaderParameter_Callback(mthis, shader, pname) native "WebGLRenderingContext_getShaderParameter_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getSupportedExtensions_Callback(mthis) native "WebGLRenderingContext_getSupportedExtensions_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_getTexParameter_Callback(mthis, target, pname) native "WebGLRenderingContext_getTexParameter_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_getUniform_Callback(mthis, program, location) native "WebGLRenderingContext_getUniform_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_getVertexAttrib_Callback(mthis, index, pname) native "WebGLRenderingContext_getVertexAttrib_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform1fv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform1fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform1iv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform1iv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform2fv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform2fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform2iv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform2iv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform3fv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform3fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform3iv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform3iv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform4fv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform4fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_uniform4iv_Callback(mthis, location, v) native "WebGLRenderingContext_uniform4iv_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_uniformMatrix2fv_Callback(mthis, location, transpose, array) native "WebGLRenderingContext_uniformMatrix2fv_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_uniformMatrix3fv_Callback(mthis, location, transpose, array) native "WebGLRenderingContext_uniformMatrix3fv_Callback_RESOLVER_STRING";

Native_WebGLRenderingContext_uniformMatrix4fv_Callback(mthis, location, transpose, array) native "WebGLRenderingContext_uniformMatrix4fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_vertexAttrib1fv_Callback(mthis, indx, values) native "WebGLRenderingContext_vertexAttrib1fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_vertexAttrib2fv_Callback(mthis, indx, values) native "WebGLRenderingContext_vertexAttrib2fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_vertexAttrib3fv_Callback(mthis, indx, values) native "WebGLRenderingContext_vertexAttrib3fv_Callback_RESOLVER_STRING";
...
Native_WebGLRenderingContext_vertexAttrib4fv_Callback(mthis, indx, values) native "WebGLRenderingContext_vertexAttrib4fv_Callback_RESOLVER_STRING";
...
Native_WebKitPoint_constructorCallback(x, y) native "WebKitPoint_constructorCallback_RESOLVER_STRING";
...
Native_WebSocket_send_Callback(mthis, data) native "WebSocket_send_Callback_RESOLVER_STRING";

Native_WebSocket_sendBlob_Callback(mthis, data) native "WebSocket_send_Callback_RESOLVER_STRING";

Native_WebSocket_sendByteBuffer_Callback(mthis, data) native "WebSocket_send_Callback_RESOLVER_STRING";

Native_WebSocket_sendString_Callback(mthis, data) native "WebSocket_send_Callback_RESOLVER_STRING";

Native_WebSocket_sendTypedData_Callback(mthis, data) native "WebSocket_send_Callback_RESOLVER_STRING";
...
Native_Window____getter___2_Callback(mthis, index_OR_name) native "Window___getter___Callback_RESOLVER_STRING";
...
Native_Window_open_Callback(mthis, url, name, options) native "Window_open_Callback_RESOLVER_STRING";
...
Native_Window_postMessage_Callback(mthis, message, targetOrigin, messagePorts) native "Window_postMessage_Callback_RESOLVER_STRING";
...
Native_Window_showModalDialog_Callback(mthis, url, dialogArgs, featureArgs) native "Window_showModalDialog_Callback_RESOLVER_STRING";

Native_Window_stop_Callback(mthis) native "Window_stop_Callback_RESOLVER_STRING_0_";

Native_Window_toString_Callback(mthis) native "Window_toString_Callback_RESOLVER_STRING";
...
Native_Window_setInterval_Callback(mthis, handler, timeout) native "Window_setInterval_Callback_RESOLVER_STRING";

Native_Window_setTimeout_Callback(mthis, handler, timeout) native "Window_setTimeout_Callback_RESOLVER_STRING";
...
Native_Worker_postMessage_Callback(mthis, message, messagePorts) native "Worker_postMessage_Callback_RESOLVER_STRING";

Native_Worker_terminate_Callback(mthis) native "Worker_terminate_Callback_RESOLVER_STRING_0_";

Native_WorkerCrypto_getRandomValues_Callback(mthis, array) native "WorkerCrypto_getRandomValues_Callback_RESOLVER_STRING";

Native_WorkerPerformance_now_Callback(mthis) native "WorkerPerformance_now_Callback_RESOLVER_STRING_0_";

Native_XMLHttpRequest_constructorCallback() native "XMLHttpRequest_constructorCallback_RESOLVER_STRING";
...
Native_XMLHttpRequest_open_Callback(mthis, method, url, async, user, password) native "XMLHttpRequest_open_Callback_RESOLVER_STRING";
...
Native_XMLHttpRequest_send_Callback(mthis, data) native "XMLHttpRequest_send_Callback_RESOLVER_STRING";
...
Native_XSLTProcessor_getParameter_Callback(mthis, namespaceURI, localName) native "XSLTProcessor_getParameter_Callback_RESOLVER_STRING";
...
Native_XSLTProcessor_removeParameter_Callback(mthis, namespaceURI, localName) native "XSLTProcessor_removeParameter_Callback_RESOLVER_STRING";

Native_XSLTProcessor_reset_Callback(mthis) native "XSLTProcessor_reset_Callback_RESOLVER_STRING_0_";

Native_XSLTProcessor_setParameter_Callback(mthis, namespaceURI, localName, value) native "XSLTProcessor_setParameter_Callback_RESOLVER_STRING";
