...
class SsaSimplifyInterceptors extends HBaseVisitor
  ...
  bool visitInterceptor(HInterceptor node) {
    ...
    if (node.usedBy.every((e) => e is HBailoutTarget || e is HTypeGuard)) {
      // The interceptor is not used.
      // TODO(ngeoffray): We should actually remove the instruction
      // from the inputs of the bailout targets;
      node.block.rewrite(node, graph.addConstantNull(constantSystem));
      return true;
    }
