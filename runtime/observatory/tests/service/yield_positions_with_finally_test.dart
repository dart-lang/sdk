...
//
// dart pkg/vm_service/test/update_line_numbers.dart runtime/observatory/tests/service/yield_positions_with_finally_test.dart
//
const LINE_A = 32;
const LINE_B = 46;
const LINE_C = 58;
...
Future<void> Function(Isolate) _expectSecondFrameFromTheTopToBeAt(int line) {
  return (isolate) async {
    ...
    expect(script0.tokenToLine(frames[0].location!.tokenPos), equals(LINE_G));
