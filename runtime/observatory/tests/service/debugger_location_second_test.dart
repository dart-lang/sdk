...
//
// dart pkg/vm_service/test/update_line_numbers.dart runtime/observatory/tests/service/debugger_location_second_test.dart
//
const LINE_A = 30;
// AUTOGENERATED END
  ...
  (Isolate isolate) async {
    ...
    expect(
        ...
        equals('[debugger_location_second_test.dart:${LINE_B + 0} ,'
            ...
            ' debugger_location_second_test.dart:${LINE_B + 4}:,'
            ' debugger_location_second_test.dart:${LINE_B + 7} ,'
            ' debugger_location_second_test.dart:${LINE_B + 7}:,'
  ...
  (Isolate isolate) async {
    ...
    expect(
        ...
        equals('[debugger_location_second_test.dart:$LINE_C:2 ,'
            ...
            ' debugger_location_second_test.dart:$LINE_C:25 ,'
            ' debugger_location_second_test.dart:$LINE_C:26 ,'
            ' debugger_location_second_test.dart:$LINE_C:27 ,'
            ' debugger_location_second_test.dart:$LINE_C:28 ,'
            ' debugger_location_second_test.dart:$LINE_C:29 ]'));
  },
