...
Map<Map<bool, int>, Expando<int>> var1077 = <Map<bool, int>, Expando<int>>{
  <bool, int>{true: -74, false: -65, true: 7}: Expando<int>('cteN2'),
};
...
Map<MapEntry<String, String>, MapEntry<int, bool>> var2077 =
    <MapEntry<String, String>, MapEntry<int, bool>>{
...
MapEntry<Expando<bool>, Map<String, bool>> var2287 =
    MapEntry<Expando<bool>, Map<String, bool>>(
      Expando<bool>('5E\u{1f600}\u2665'),
      <String, bool>{
        'w\u266537L': true,
        'Rfu': false,
        ')JI+q&': true,
...
MapEntry<Map<bool, String>, Expando<bool>>? var2918 =
    MapEntry<Map<bool, String>, Expando<bool>>(<bool, String>{
      true: '3rVO( ',
      true: '+9psp57',
    }, Expando<bool>('d'));
MapEntry<Map<int, bool>, Map<int, String>>? var3006 =
    MapEntry<Map<int, bool>, Map<int, String>>(
      <int, bool>{18: false, -32: true, -32: false, 31: false, -50: false},
      <int, String>{
        -37: '',
        12: 'viG4s',
        4294967297: '\u2665YGL12',
...
MapEntry<MapEntry<bool, int>, Map<String, int>>? var3430 =
    MapEntry<MapEntry<bool, int>, Map<String, int>>(
      MapEntry<bool, int>(true, 29),
      <String, int>{'k': -31, '': 0, '\u{1f600}u3IJ ': 12, '': -89, 'G&5': 39},
    );
...
class X0 {
  Map<MapEntry<String, int>, int>? foo0_1(int par1) {
    ...
    for (int loc0 = 0; loc0 < 49; loc0++) {
      try {
        var3430 = MapEntry<MapEntry<bool, int>, Map<String, int>>(
          MapEntry<bool, int>(true, 11),
          <String, int>{
            'tocS': (true
                ? var73
                : var1911[MapEntry<String, bool>('CZ\u2665G4Ra', true)]!),
            '\u{1f600}UnA#': var531[var1077[const <bool, int>{false: -73}]!]!,
          },
        );
