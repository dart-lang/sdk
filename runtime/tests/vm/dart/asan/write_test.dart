...
// Formatting can break multitests.
// dart format off
...
expectedFunction() {
  ...
  free(p);
  p[0] = 0;  // ASAN: heap-use-after-free
}
...
main(List<String> arguments) {
  ...
  Expect.contains("WRITE of size 1", result.stderr);  //# int8: ok
  Expect.contains("WRITE of size 1", result.stderr);  //# uint8: ok
  Expect.contains("WRITE of size 2", result.stderr);  //# int16: ok
  Expect.contains("WRITE of size 2", result.stderr);  //# uint16: ok
  Expect.contains("WRITE of size 4", result.stderr);  //# int32: ok
  Expect.contains("WRITE of size 4", result.stderr);  //# uint32: ok
  Expect.contains("WRITE of size 8", result.stderr);  //# int64: ok
