  ...
  // Single-line comment.
  {
    ...
    while (--loc0 > 0) {
      ...
      for (int loc1 in var7) {
         ...
         */
        var8 =
            (((false ? var8 : {var1, Float32x4.xwyw}) ??
...
String foo2(Map<int, String> par1, bool par2) {
  try {
  ...
  } catch (exception, stackTrace) {
    {
      ...
      {
        Map<int, String> loc1 = Map.from({
          55: (true ? '' : 'ZoDx\u{1f600}'),
          82: foo0(),
        });
          ...
          case 2310807345:
            {
                  ...
                  foo1(var7[(~(-75))], (!(false))));
              {
                ...
                while (--loc2 > 0) {
                  ...
                  if (true) {
                    par2 = (var8).add(
                      ((var7[var1] + (-(4294967425))) ??
                          var7[((-(-9223372032559775745)) - (--var4))]),
                    );
                    if ((Map.from(par1)).isEmpty) {
                      var9 ??=
                          ((Map.unmodifiable(Map.unmodifiable(par1)) ??
