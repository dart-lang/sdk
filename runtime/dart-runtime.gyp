     ...
     'actions': [
        {
          ...
          'inputs': [
            ...
            '../tools/VERSION',
            '<(version_in_cc_file)',
            '<(PRODUCT_DIR)/<(STATIC_LIB_PREFIX)libdart_lib_withcore<(STATIC_LIB_SUFFIX)',
            '<(PRODUCT_DIR)/<(STATIC_LIB_PREFIX)libdart_lib<(STATIC_LIB_SUFFIX)',
            '<(PRODUCT_DIR)/<(STATIC_LIB_PREFIX)libdart_vm<(STATIC_LIB_SUFFIX)',
            '<(PRODUCT_DIR)/<(STATIC_LIB_PREFIX)libjscre<(STATIC_LIB_SUFFIX)',
            '<(PRODUCT_DIR)/<(STATIC_LIB_PREFIX)libdouble_conversion<(STATIC_LIB_SUFFIX)',
          ],
          'outputs': [
            '<(version_cc_file)',
          ],
