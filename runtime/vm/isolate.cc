...
void IsolateGroup::ForEach(std::function<void(IsolateGroup*)> action) {
  ...
  for (auto isolate_group : IsolateGroup::isolate_groups_) {
...
void IsolateGroup::Init() {
  ASSERT(IsolateGroup::isolate_groups_rwlock_ == nullptr);
  IsolateGroup::isolate_groups_rwlock_ = new RwLock();
...
RwLock* IsolateGroup::isolate_groups_rwlock_;
IntrusiveDList<IsolateGroup> IsolateGroup::isolate_groups_;
