...
#ifndef RUNTIME_VM_STACK_FRAME_LOONG64_H_
#define RUNTIME_VM_STACK_FRAME_LOONG64_H_

#if !defined(RUNTIME_VM_STACK_FRAME_H_)
#error Do not include stack_frame_loong64.h directly; use stack_frame.h instead.
#endif

namespace dart {

/* LoongArch64 Dart Frame Layout
               |                    | <- TOS
Callee frame   | ...                |
               | saved PP           |
               | code object        |
...
// Entry and exit frame layout. This follows the RISC-V style frame linkage,
// adjusted for the LoongArch64 LP64D callee-save register set.
...
#endif  // RUNTIME_VM_STACK_FRAME_LOONG64_H_
