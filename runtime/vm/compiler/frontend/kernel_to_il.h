...
class FlowGraphBuilder : public BaseFlowGraphBuilder {
 ...
 private:
  ...
  // Builds checks for type checking a given argument of the call using
  // parameter information for the function retrieved at runtime from the
  // closure. Loads the parameter index from info.vars->current_param_index.
  //
