...
//
// Note: S must be static_cast-able to an integral type. If S is
...
class BitField<S,
               ...
               typename std::enable_if_t<
                   ...
                   void>> : public BitField<typename S::ContainedType,
                                            T,
                                            position,
                                            size,
                                            sign_extend> {};
...
class BitField<S,
               ...
               false,
               typename std::enable_if_t<
                   position != 0 && !std::is_same_v<T, bool> &&
                       std::is_base_of_v<AtomicBitFieldContainerBase, S>,
                   void>>
...
class BitField<
    ...
    false,
    typename std::enable_if_t<
        size != 1 && std::is_base_of<AtomicBitFieldContainerBase, S>::value,
        void>>
...
class BitField<
    ...
    false,
    typename std::enable_if_t<
        position != 0 && std::is_base_of_v<AtomicBitFieldContainerBase, S>,
        void>>
...
class BitField<
    ...
    1,
    false,
    typename std::enable_if_t<std::is_base_of_v<AtomicBitFieldContainerBase, S>,
                              void>>
